...
extern const u8 gText_ConfirmTossItems2[];
extern const u8 gText_ConfirmTossItems3[];
...
extern const u8 gText_ReleaseThisPokemon2[];
extern const u8 gText_ReleaseThisPokemon3[];
