...
extern const u8 gText_PrefixMega[];
extern const u8 gText_PrefixPrimal[];
extern const u8 gText_PrefixAlolan[];
extern const u8 gText_PrefixGalarian[];
extern const u8 gText_PrefixHisuian[];
extern const u8 gText_PrefixPaldean[];
extern const u8 gText_PrefixPartner[];
extern const u8 gText_PrefixSunnyForm[];
extern const u8 gText_PrefixRainyForm[];
extern const u8 gText_PrefixSnowyForm[];
extern const u8 gText_PrefixAttackForme[];
extern const u8 gText_PrefixDefenseForme[];
extern const u8 gText_PrefixSpeedForme[];
extern const u8 gText_PrefixSandyCloak[];
extern const u8 gText_PrefixTrashCloak[];
extern const u8 gText_PrefixHeat[];
extern const u8 gText_PrefixWash[];
extern const u8 gText_PrefixFrost[];
extern const u8 gText_PrefixFan[];
extern const u8 gText_PrefixMow[];
extern const u8 gText_PrefixOriginForme[];
extern const u8 gText_PrefixSkyForme[];
extern const u8 gText_PrefixBlueStriped[];
extern const u8 gText_PrefixWhiteStriped[];
extern const u8 gText_PrefixTherian[];
extern const u8 gText_PrefixWhite[];
extern const u8 gText_PrefixBlack[];
extern const u8 gText_PrefixPirouette[];
extern const u8 gText_PrefixAsh[];
extern const u8 gText_PrefixEternalFlower[];
extern const u8 gText_Prefix10Percent[];
extern const u8 gText_PrefixComplete[];
extern const u8 gText_PrefixPomPom[];
extern const u8 gText_PrefixPau[];
extern const u8 gText_PrefixSensu[];
extern const u8 gText_PrefixMidnight[];
extern const u8 gText_PrefixDusk[];
extern const u8 gText_PrefixSchool[];
extern const u8 gText_PrefixCore[];
extern const u8 gText_PrefixDuskMane[];
extern const u8 gText_PrefixDawnWings[];
extern const u8 gText_PrefixUltra[];
extern const u8 gText_PrefixCrowned[];
extern const u8 gText_PrefixEternamax[];
extern const u8 gText_PrefixRapidStrike[];
extern const u8 gText_PrefixIceRider[];
extern const u8 gText_PrefixShadowRider[];
extern const u8 gText_PrefixBloodmoon[];
extern const u8 gText_PrefixHero[];
extern const u8 gText_PrefixWellspringMask[];
extern const u8 gText_PrefixHearthflameMask[];
...
extern const u8 gText_SuffixZenMode[];
