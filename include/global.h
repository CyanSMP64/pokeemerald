...
struct Pokedex
{
    ...
    /*0x0C*/ u8 owned[NUM_DEX_FLAG_BYTES];
    /*0xA4*/ u8 seen[NUM_DEX_FLAG_BYTES];
    // total: 0x13C
};
...
struct SaveBlock2
{
    ...
    /*0x15C*/ struct Time lastBerryTreeUpdate;
    /*0x164*/ u32 gcnLinkFlags; // Read by Pokemon Colosseum/XD
    /*0x168*/ u32 encryptionKey;
    /*0x16C*/ struct PlayersApprentice playerApprentice;
    /*0x198*/ struct Apprentice apprentices[APPRENTICE_COUNT];
...
struct SaveBlock1
{
    ...
    /*0xB8C*/ u16 berryBlenderRecords[3];
    /*0xB92*/ u16 trainerRematchStepCounter;
    /*0xB94*/ u8 trainerRematches[MAX_REMATCH_ENTRIES];
    /*0xBF8*/ struct ObjectEvent objectEvents[OBJECT_EVENTS_COUNT];
    /*0xE38*/ struct ObjectEventTemplate objectEventTemplates[OBJECT_EVENT_TEMPLATES_COUNT];
    /*0x1438*/ u8 flags[NUM_FLAG_BYTES];
    /*0x1564*/ u16 vars[VARS_COUNT];
    /*0x1764*/ u32 gameStats[NUM_GAME_STATS];
    /*0x1864*/ struct BerryTree berryTrees[BERRY_TREES_COUNT];
    /*0x1C64*/ struct SecretBase secretBases[SECRET_BASES_COUNT];
    /*0x28E4*/ u8 playerRoomDecorations[DECOR_MAX_PLAYERS_HOUSE];
    /*0x28F0*/ u8 playerRoomDecorationPositions[DECOR_MAX_PLAYERS_HOUSE];
    /*0x28FC*/ u8 decorationDesks[10];
    /*0x2906*/ u8 decorationChairs[10];
    /*0x2910*/ u8 decorationPlants[10];
    /*0x291A*/ u8 decorationOrnaments[30];
    /*0x2938*/ u8 decorationMats[30];
    /*0x2956*/ u8 decorationPosters[10];
    /*0x2960*/ u8 decorationDolls[40];
    /*0x2988*/ u8 decorationCushions[10];
    /*0x2994*/ TVShow tvShows[TV_SHOWS_COUNT];
    /*0x2D18*/ PokeNews pokeNews[POKE_NEWS_COUNT];
    /*0x2D58*/ u16 outbreakPokemonSpecies;
    /*0x2D5A*/ u8 outbreakLocationMapNum;
    /*0x2D5B*/ u8 outbreakLocationMapGroup;
    /*0x2D5C*/ u8 outbreakPokemonLevel;
    /*0x2D5D*/ u8 outbreakUnused1;
    /*0x2D5E*/ u16 outbreakUnused2;
    /*0x2D60*/ u16 outbreakPokemonMoves[MAX_MON_MOVES];
    /*0x2D68*/ u8 outbreakUnused3;
    /*0x2D69*/ u8 outbreakPokemonProbability;
    /*0x2D6A*/ u16 outbreakDaysLeft;
    /*0x2D6C*/ struct GabbyAndTyData gabbyAndTyData;
    /*0x2D78*/ u16 easyChatProfile[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D84*/ u16 easyChatBattleStart[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D90*/ u16 easyChatBattleWon[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2D9C*/ u16 easyChatBattleLost[EASY_CHAT_BATTLE_WORDS_COUNT];
    /*0x2DA8*/ struct Mail mail[MAIL_COUNT];
    /*0x2FE8*/ u8 unlockedTrendySayings[NUM_TRENDY_SAYING_BYTES]; // Bitfield for unlockable Easy Chat words in EC_GROUP_TRENDY_SAYING
    /*0x2FF0*/ OldMan oldMan;
    /*0x302C*/ struct DewfordTrend dewfordTrends[SAVED_TRENDS_COUNT];
    /*0x3058*/ struct ContestWinner contestWinners[NUM_CONTEST_WINNERS]; // see CONTEST_WINNER_*
    /*0x31F8*/ struct DayCare daycare;
    /*0x3318*/ struct LinkBattleRecords linkBattleRecords;
    /*0x3370*/ u8 giftRibbons[GIFT_RIBBONS_COUNT];
    /*0x337B*/ struct ExternalEventData externalEventData;
    /*0x338F*/ struct ExternalEventFlags externalEventFlags;
    /*0x33A4*/ struct Roamer roamer;
    /*0x33C0*/ struct EnigmaBerry enigmaBerry;
    /*0x33F4*/ u32 trainerHillTimes[NUM_TRAINER_HILL_MODES];
    /*0x3404*/ struct RecordMixingGift recordMixingGift;
    /*0x3414*/ u8 seen2[NUM_DEX_FLAG_BYTES];
    /*0x34B0*/ LilycoveLady lilycoveLady;
    /*0x34F0*/ struct TrainerNameRecord trainerNameRecords[20];
    /*0x35E0*/ u8 registeredTexts[UNION_ROOM_KB_ROW_COUNT][21];
    /*0x36B4*/ struct TrainerHillSave trainerHill;
    /*0x36C0*/ struct WaldaPhrase waldaPhrase;
    // sizeof: 0x36E0
};
