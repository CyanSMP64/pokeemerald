...
#define C_V 0x40 // center value for PAN and TUNE
#define C_B 0x80 // center value for BEND
...
#define PCM_DMA_BUF_SIZE 1408 // size of Direct Sound buffer
