...
#define FLAG_SYS_DEBUG_MODE                         (SYSTEM_FLAGS + 0x21) // Unused Flag
#define FLAG_SYS_DEBUG_SAVE                         (SYSTEM_FLAGS + 0x22) // Unused Flag
...
#define FLAG_SUPER_KAIZO                            (SYSTEM_FLAGS + 0x83) // Previously unused
