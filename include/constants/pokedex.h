...
#define NATIONAL_DEX_COUNT  NATIONAL_DEX_CALYREX_SHADOW_RIDER
...
enum {
    ...
    HOENN_DEX_AUDINO_MEGA,
    HOENN_DEX_DIANCIE_MEGA,
    HOENN_DEX_RAYQUAZA_MEGA,
    HOENN_DEX_KYOGRE_PRIMAL,
    HOENN_DEX_GROUDON_PRIMAL,
    HOENN_DEX_RATTATA_ALOLAN,
    HOENN_DEX_RATICATE_ALOLAN,
    HOENN_DEX_RAICHU_ALOLAN,
    HOENN_DEX_SANDSHREW_ALOLAN,
    HOENN_DEX_SANDSLASH_ALOLAN,
    HOENN_DEX_VULPIX_ALOLAN,
    HOENN_DEX_NINETALES_ALOLAN,
    HOENN_DEX_DIGLETT_ALOLAN,
    HOENN_DEX_DUGTRIO_ALOLAN,
    HOENN_DEX_MEOWTH_ALOLAN,
    HOENN_DEX_PERSIAN_ALOLAN,
    HOENN_DEX_GEODUDE_ALOLAN,
    HOENN_DEX_GRAVELER_ALOLAN,
    HOENN_DEX_GOLEM_ALOLAN,
    HOENN_DEX_GRIMER_ALOLAN,
    HOENN_DEX_MUK_ALOLAN,
    HOENN_DEX_EXEGGUTOR_ALOLAN,
    HOENN_DEX_MAROWAK_ALOLAN,
    HOENN_DEX_MEOWTH_GALARIAN,
    HOENN_DEX_PONYTA_GALARIAN,
    HOENN_DEX_RAPIDASH_GALARIAN,
    HOENN_DEX_SLOWPOKE_GALARIAN,
    HOENN_DEX_SLOWBRO_GALARIAN,
    HOENN_DEX_FARFETCHD_GALARIAN,
    HOENN_DEX_WEEZING_GALARIAN,
    HOENN_DEX_MR_MIME_GALARIAN,
    HOENN_DEX_ARTICUNO_GALARIAN,
    HOENN_DEX_ZAPDOS_GALARIAN,
    HOENN_DEX_MOLTRES_GALARIAN,
    HOENN_DEX_SLOWKING_GALARIAN,
    HOENN_DEX_CORSOLA_GALARIAN,
    HOENN_DEX_ZIGZAGOON_GALARIAN,
    HOENN_DEX_LINOONE_GALARIAN,
    HOENN_DEX_DARUMAKA_GALARIAN,
    HOENN_DEX_DARMANITAN_GALARIAN,
    HOENN_DEX_YAMASK_GALARIAN,
    HOENN_DEX_STUNFISK_GALARIAN,
    ...
    HOENN_DEX_LILLIGANT_HISUIAN,
    HOENN_DEX_ZORUA_HISUIAN,
    HOENN_DEX_ZOROARK_HISUIAN,
    HOENN_DEX_BRAVIARY_HISUIAN,
    HOENN_DEX_SLIGGOO_HISUIAN,
    HOENN_DEX_GOODRA_HISUIAN,
    HOENN_DEX_AVALUGG_HISUIAN,
    HOENN_DEX_DECIDUEYE_HISUIAN,
    HOENN_DEX_TAUROS_PALDEAN,
    HOENN_DEX_WOOPER_PALDEAN,
    HOENN_DEX_TAUROS_PALDEAN_BLAZE_BREED,
    HOENN_DEX_TAUROS_PALDEAN_AQUA_BREED,
    HOENN_DEX_CASTFORM_SUNNY,
    HOENN_DEX_CASTFORM_RAINY,
    HOENN_DEX_CASTFORM_SNOWY,
    HOENN_DEX_DEOXYS_ATTACK,
    HOENN_DEX_DEOXYS_DEFENSE,
    HOENN_DEX_DEOXYS_SPEED,
    HOENN_DEX_WORMADAM_SANDY_CLOAK,
    HOENN_DEX_WORMADAM_TRASH_CLOAK,
    HOENN_DEX_ROTOM_HEAT,
    HOENN_DEX_ROTOM_WASH,
    HOENN_DEX_ROTOM_FROST,
    HOENN_DEX_ROTOM_FAN,
    HOENN_DEX_ROTOM_MOW,
    HOENN_DEX_DIALGA_ORIGIN,
    HOENN_DEX_PALKIA_ORIGIN,
    HOENN_DEX_GIRATINA_ORIGIN,
    HOENN_DEX_SHAYMIN_SKY,
    HOENN_DEX_BASCULIN_BLUE_STRIPED,
    HOENN_DEX_BASCULIN_WHITE_STRIPED,
    HOENN_DEX_DARMANITAN_ZEN_MODE,
    HOENN_DEX_DARMANITAN_ZEN_MODE_GALARIAN,
    HOENN_DEX_TORNADUS_THERIAN,
    HOENN_DEX_THUNDURUS_THERIAN,
    HOENN_DEX_LANDORUS_THERIAN,
    HOENN_DEX_ENAMORUS_THERIAN,
    HOENN_DEX_KYUREM_WHITE,
    HOENN_DEX_KYUREM_BLACK,
    HOENN_DEX_MELOETTA_PIROUETTE,
    HOENN_DEX_GRENINJA_ASH,
    HOENN_DEX_FLOETTE_ETERNAL_FLOWER,
    HOENN_DEX_AEGISLASH_BLADE,
    HOENN_DEX_ZYGARDE_10,
    HOENN_DEX_ZYGARDE_COMPLETE,
    HOENN_DEX_HOOPA_UNBOUND,
    HOENN_DEX_ORICORIO_POM_POM,
    HOENN_DEX_ORICORIO_PAU,
    HOENN_DEX_ORICORIO_SENSU,
    HOENN_DEX_LYCANROC_MIDNIGHT,
    HOENN_DEX_LYCANROC_DUSK,
    HOENN_DEX_WISHIWASHI_SCHOOL,
    HOENN_DEX_MINIOR_CORE_RED,
    HOENN_DEX_NECROZMA_DUSK_MANE,
    HOENN_DEX_NECROZMA_DAWN_WINGS,
    HOENN_DEX_NECROZMA_ULTRA,
    HOENN_DEX_EISCUE_NOICE_FACE,
    HOENN_DEX_INDEEDEE_FEMALE,
    HOENN_DEX_ZACIAN_CROWNED_SWORD,
    HOENN_DEX_ZAMAZENTA_CROWNED_SHIELD,
    HOENN_DEX_URSHIFU_RAPID_STRIKE_STYLE,
    HOENN_DEX_CALYREX_ICE_RIDER,
    HOENN_DEX_CALYREX_SHADOW_RIDER,
    HOENN_DEX_PALAFIN_HERO,
