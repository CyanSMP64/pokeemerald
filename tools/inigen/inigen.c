...
const struct TMText gTMTexts[] = {
    { 3, 15,  0,  1,  0xA9, "The TECHNICAL MACHINE I handed you contains [move]."},
    { 4, 14,  0,  1,  0xB8, "TATE: That TM04 contains... LIZA: [move]!\\pTATE: It’s a move that’s perfect... LIZA: For any POKéMON!"},
    ...
    { 8,  3,  3,  1,  0xAC, "That TM08 contains [move]."},
    ...
    {34, 10,  0,  1,  0xBB, "That TM34 there contains [move]. You can count on it!"},
    ...
    {40, 12,  1,  1,  0x97, "TM40 contains [move]."},
