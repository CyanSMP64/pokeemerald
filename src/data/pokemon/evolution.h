const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_NOSEPASS]              = {{EVO_LEVEL, 40, SPECIES_PROBOPASS}},
    ...
    [SPECIES_CHARCADET]             = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARMAROUGE},
