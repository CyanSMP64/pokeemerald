const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_LEVEL, 47, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_BURMY]                 = {{EVO_LEVEL, 20, SPECIES_WORMADAM},
                                       {EVO_LEVEL, 20, SPECIES_WORMADAM_SANDY_CLOAK},
                                       {EVO_LEVEL, 20, SPECIES_WORMADAM_TRASH_CLOAK},
    ...
    [SPECIES_HAPPINY]               = {{EVO_LEVEL, 15, SPECIES_CHANSEY}},
    ...
    [SPECIES_MANTYKE]               = {{EVO_LEVEL, 35, SPECIES_MANTINE}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_LEVEL, 32, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_LEVEL, 32, SPECIES_SLURPUFF}},
    ...
    [SPECIES_CRABRAWLER]            = {{EVO_LEVEL, 25, SPECIES_CRABOMINABLE}},
    ...
    [SPECIES_POIPOLE]               = {{EVO_LEVEL, 50, SPECIES_NAGANADEL}},
    ...
    [SPECIES_APPLIN]                = {{EVO_LEVEL, 35, SPECIES_APPLETUN},
    ...
    [SPECIES_CLOBBOPUS]             = {{EVO_LEVEL, 35, SPECIES_GRAPPLOCT}},
    [SPECIES_SINISTEA]              = {{EVO_LEVEL, 33, SPECIES_POLTEAGEIST}},
    ...
    [SPECIES_KUBFU]                 = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_URSHIFU_RAPID_STRIKE_STYLE},
                                       {EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSHIFU}},
    ...
    [SPECIES_PAWMO]                 = {{EVO_FRIENDSHIP, 0, SPECIES_PAWMOT}},
    ...
    [SPECIES_CHARCADET]             = {{EVO_LEVEL, 30, SPECIES_CERULEDGE},
                                       {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARMAROUGE}},
    ...
    [SPECIES_CETODDLE]              = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CETITAN}},
    [SPECIES_FRIGIBAX]              = {{EVO_LEVEL, 35, SPECIES_ARCTIBAX}},
    [SPECIES_ARCTIBAX]              = {{EVO_LEVEL, 54, SPECIES_BAXCALIBUR}},
    [SPECIES_GIMMIGHOUL]            = {{EVO_LEVEL, 50, SPECIES_GHOLDENGO}},
    [SPECIES_RATTATA_ALOLAN]        = {{EVO_LEVEL, 20, SPECIES_RATICATE_ALOLAN}},
    [SPECIES_SANDSHREW_ALOLAN]      = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_SANDSLASH_ALOLAN}},
    ...
    [SPECIES_DARUMAKA_GALARIAN]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_DARMANITAN_GALARIAN}},
    ...
    [SPECIES_SNEASEL_HISUIAN]       = {{EVO_LEVEL, 40, SPECIES_SNEASLER}},
    [SPECIES_ZORUA_HISUIAN]         = {{EVO_LEVEL, 30, SPECIES_ZOROARK_HISUIAN}},
    [SPECIES_SLIGGOO_HISUIAN]       = {{EVO_LEVEL, 40, SPECIES_GOODRA_HISUIAN}},
    [SPECIES_WOOPER_PALDEAN]        = {{EVO_LEVEL, 20, SPECIES_CLODSIRE}},
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_LEVEL, 35, SPECIES_BASCULEGION}},
};
