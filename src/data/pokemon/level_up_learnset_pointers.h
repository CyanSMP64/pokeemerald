const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_VENUSAUR_MEGA] = sVenusaurMLevelUpLearnset,
    [SPECIES_CHARIZARD_MEGA_X] = sCharizardMXLevelUpLearnset,
    [SPECIES_CHARIZARD_MEGA_Y] = sCharizardMYLevelUpLearnset,
    [SPECIES_BLASTOISE_MEGA] = sBlastoiseMLevelUpLearnset,
    [SPECIES_BEEDRILL_MEGA] = sBeedrillMLevelUpLearnset,
    [SPECIES_PIDGEOT_MEGA] = sPidgeotMLevelUpLearnset,
    [SPECIES_ALAKAZAM_MEGA] = sAlakazamMLevelUpLearnset,
    [SPECIES_SLOWBRO_MEGA] = sSlowbroMLevelUpLearnset,
    [SPECIES_GENGAR_MEGA] = sGengarMLevelUpLearnset,
    [SPECIES_KANGASKHAN_MEGA] = sKangaskhanMLevelUpLearnset,
    [SPECIES_PINSIR_MEGA] = sPinsirMLevelUpLearnset,
    [SPECIES_GYARADOS_MEGA] = sGyaradosMLevelUpLearnset,
    [SPECIES_AERODACTYL_MEGA] = sAerodactylMLevelUpLearnset,
    [SPECIES_MEWTWO_MEGA_X] = sMewtwoMXLevelUpLearnset,
    [SPECIES_MEWTWO_MEGA_Y] = sMewtwoMYLevelUpLearnset,
    [SPECIES_AMPHAROS_MEGA] = sAmpharosMLevelUpLearnset,
    [SPECIES_STEELIX_MEGA] = sSteelixMLevelUpLearnset,
    [SPECIES_SCIZOR_MEGA] = sScizorMLevelUpLearnset,
    [SPECIES_HERACROSS_MEGA] = sHeracrossMLevelUpLearnset,
    [SPECIES_HOUNDOOM_MEGA] = sHoundoomMLevelUpLearnset,
    [SPECIES_TYRANITAR_MEGA] = sTyranitarMLevelUpLearnset,
    [SPECIES_SCEPTILE_MEGA] = sSceptileMLevelUpLearnset,
    [SPECIES_BLAZIKEN_MEGA] = sBlazikenMLevelUpLearnset,
    [SPECIES_SWAMPERT_MEGA] = sSwampertMLevelUpLearnset,
    [SPECIES_GARDEVOIR_MEGA] = sGardevoirMLevelUpLearnset,
    [SPECIES_SABLEYE_MEGA] = sSableyeMLevelUpLearnset,
    [SPECIES_MAWILE_MEGA] = sMawileMLevelUpLearnset,
    [SPECIES_AGGRON_MEGA] = sAggronMLevelUpLearnset,
    [SPECIES_MEDICHAM_MEGA] = sMedichamMLevelUpLearnset,
    [SPECIES_MANECTRIC_MEGA] = sManectricMLevelUpLearnset,
    [SPECIES_SHARPEDO_MEGA] = sSharpedoMLevelUpLearnset,
    [SPECIES_CAMERUPT_MEGA] = sCameruptMLevelUpLearnset,
    [SPECIES_ALTARIA_MEGA] = sAltariaMLevelUpLearnset,
    [SPECIES_BANETTE_MEGA] = sBanetteMLevelUpLearnset,
    [SPECIES_ABSOL_MEGA] = sAbsolMLevelUpLearnset,
    [SPECIES_GLALIE_MEGA] = sGlalieMLevelUpLearnset,
    [SPECIES_SALAMENCE_MEGA] = sSalamenceMLevelUpLearnset,
    [SPECIES_METAGROSS_MEGA] = sMetagrossMLevelUpLearnset,
    [SPECIES_LATIAS_MEGA] = sLatiasMLevelUpLearnset,
    [SPECIES_LATIOS_MEGA] = sLatiosMLevelUpLearnset,
    [SPECIES_LOPUNNY_MEGA] = sLopunnyMLevelUpLearnset,
    [SPECIES_GARCHOMP_MEGA] = sGarchompMLevelUpLearnset,
    [SPECIES_LUCARIO_MEGA] = sLucarioMLevelUpLearnset,
    [SPECIES_ABOMASNOW_MEGA] = sAbomasnowMLevelUpLearnset,
    [SPECIES_GALLADE_MEGA] = sGalladeMLevelUpLearnset,
    [SPECIES_AUDINO_MEGA] = sAudinoMLevelUpLearnset,
    [SPECIES_DIANCIE_MEGA] = sDiancieMLevelUpLearnset,
    [SPECIES_RAYQUAZA_MEGA] = sRayquazaMLevelUpLearnset,
    [SPECIES_KYOGRE_PRIMAL] = sKyogrePLevelUpLearnset,
    [SPECIES_GROUDON_PRIMAL] = sGroudonPLevelUpLearnset,
    ...
    [SPECIES_CASTFORM_SUNNY] = sCastformFLevelUpLearnset,
    [SPECIES_CASTFORM_RAINY] = sCastformWLevelUpLearnset,
    [SPECIES_CASTFORM_SNOWY] = sCastformILevelUpLearnset,
    ...
    [SPECIES_DIALGA_ORIGIN] = sDialgaOLevelUpLearnset,
    [SPECIES_PALKIA_ORIGIN] = sPalkiaOLevelUpLearnset,
    [SPECIES_GIRATINA_ORIGIN] = sGiratinaOLevelUpLearnset,
    [SPECIES_SHAYMIN_SKY] = sShayminSkyLevelUpLearnset,
    [SPECIES_BASCULIN_BLUE_STRIPED] = sBasculinBlueLevelUpLearnset,
    [SPECIES_BASCULIN_WHITE_STRIPED] = sBasculinWhiteLevelUpLearnset,
    [SPECIES_DARMANITAN_ZEN_MODE] = sDarmanitanZLevelUpLearnset,
    [SPECIES_DARMANITAN_ZEN_MODE_GALARIAN] = sDarmanitanGalarianZLevelUpLearnset,
    [SPECIES_TORNADUS_THERIAN] = sTornadusTLevelUpLearnset,
    [SPECIES_THUNDURUS_THERIAN] = sThundurusTLevelUpLearnset,
    [SPECIES_LANDORUS_THERIAN] = sLandorusTLevelUpLearnset,
    [SPECIES_KYUREM_WHITE] = sKyuremWhiteLevelUpLearnset,
    [SPECIES_KYUREM_BLACK] = sKyuremBlackLevelUpLearnset,
    [SPECIES_MELOETTA_PIROUETTE] = sMeloettaPLevelUpLearnset,
    [SPECIES_GRENINJA_ASH] = sGreninjaALevelUpLearnset,
    [SPECIES_FLOETTE_ETERNAL_FLOWER] = sFloetteEternalFlowerLevelUpLearnset,
    [SPECIES_AEGISLASH_BLADE] = sAegislashBLevelUpLearnset,
    [SPECIES_ZYGARDE_10] = sZygarde10LevelUpLearnset,
    [SPECIES_ZYGARDE_COMPLETE] = sZygardeCompleteLevelUpLearnset,
    ...
    [SPECIES_WISHIWASHI_SCHOOL] = sWishiwashiSLevelUpLearnset,
    [SPECIES_MINIOR_CORE_RED] = sMiniorCLevelUpLearnset,
    [SPECIES_NECROZMA_DUSK_MANE] = sNecrozmaDMLevelUpLearnset,
    [SPECIES_NECROZMA_DAWN_WINGS] = sNecrozmaDWLevelUpLearnset,
    [SPECIES_NECROZMA_ULTRA] = sNecrozmaUltraLevelUpLearnset,
    [SPECIES_EISCUE_NOICE_FACE] = sEiscueNLevelUpLearnset,
    [SPECIES_INDEEDEE_FEMALE] = sIndeedeeFemaleLevelUpLearnset,
    [SPECIES_ZACIAN_CROWNED_SWORD] = sZacianCrownedLevelUpLearnset,
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = sZamazentaCrownedLevelUpLearnset,
    ...
    [SPECIES_ENAMORUS_THERIAN] = sEnamorusTLevelUpLearnset,
