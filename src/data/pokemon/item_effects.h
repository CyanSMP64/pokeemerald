...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_SHINY_STONE - ITEM_POTION]   = gItemEffect_LeafStone,
    [ITEM_DUSK_STONE - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_DAWN_STONE - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_ICE_STONE - ITEM_POTION]     = gItemEffect_LeafStone,
    [ITEM_KINGS_ROCK - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_METAL_COAT - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_DEEP_SEA_SCALE - ITEM_POTION] = gItemEffect_LeafStone,
    [ITEM_DEEP_SEA_TOOTH - ITEM_POTION] = gItemEffect_LeafStone,
    [ITEM_DRAGON_SCALE - ITEM_POTION]  = gItemEffect_LeafStone,
    [ITEM_UP_GRADE - ITEM_POTION]      = gItemEffect_LeafStone,
    [ITEM_DUBIOUS_DISC - ITEM_POTION]  = gItemEffect_LeafStone,
    [ITEM_RAZOR_CLAW - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_RAZOR_FANG - ITEM_POTION]    = gItemEffect_LeafStone,
    [ITEM_LINKING_CORD - ITEM_POTION]  = gItemEffect_LeafStone,
