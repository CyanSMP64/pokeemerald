...
{
    NATIONAL_DEX_MANAPHY_EGG,
    NATIONAL_DEX_CHALKBOARD_1,
    NATIONAL_DEX_CHALKBOARD_2,
    NATIONAL_DEX_CHALKBOARD_3,
...
const u16 gPokedexOrder_Weight[] =
{
    ...
    NATIONAL_DEX_FLAREON,
    NATIONAL_DEX_CROCONAW,
    NATIONAL_DEX_HAWLUCHA_MEGA, // Mega
    NATIONAL_DEX_TORRACAT,
    ...
    NATIONAL_DEX_SEAKING,
    NATIONAL_DEX_DELPHOX,
    NATIONAL_DEX_DELPHOX_MEGA, // Mega
    NATIONAL_DEX_GOURGEIST_SUPER,
    NATIONAL_DEX_GRAPPLOCT,
    NATIONAL_DEX_DODUO,
    NATIONAL_DEX_BRELOOM,
    ...
    NATIONAL_DEX_ABSOL_MEGA_Z, // Mega
    NATIONAL_DEX_LUCARIO_MEGA_Z, // Mega
    ...
    NATIONAL_DEX_GARCHOMP_MEGA_Z,
    NATIONAL_DEX_FALINKS_MEGA, // Mega
    NATIONAL_DEX_BERGMITE,
    // 220.5 - 225.5 lbs / 100.0 - 102.3 kg
    NATIONAL_DEX_VENUSAUR,
    NATIONAL_DEX_KANGASKHAN_MEGA, // Mega
    NATIONAL_DEX_TROPIUS,
    NATIONAL_DEX_BARBARACLE_MEGA, // Mega
    NATIONAL_DEX_XURKITREE,
    NATIONAL_DEX_CUFANT,
    NATIONAL_DEX_DRAGALGE_MEGA, // Mega
    NATIONAL_DEX_CHARIZARD_MEGA_Y, // Mega Y
    NATIONAL_DEX_MEGANIUM,
    NATIONAL_DEX_SILVALLY,
    NATIONAL_DEX_FLOETTE_MEGA, // Mega
    ...
    NATIONAL_DEX_SCOLIPEDE_MEGA,
    NATIONAL_DEX_GYARADOS,
    NATIONAL_DEX_DARKRAI_MEGA, // Mega
    NATIONAL_DEX_GARGANACL,
    NATIONAL_DEX_IRON_TREADS,
    NATIONAL_DEX_MIRAIDON,
    NATIONAL_DEX_DRAMPA_MEGA,
    ...
    NATIONAL_DEX_ZYGARDE_MEGA, // Mega
...
const u16 gPokedexOrder_Height[] =
{
    ...
    NATIONAL_DEX_BOLDORE,
    NATIONAL_DEX_SWOOBAT,
    NATIONAL_DEX_EXCADRILL_MEGA, // Mega
    NATIONAL_DEX_MIENFOO,
    NATIONAL_DEX_SKIDDO,
    NATIONAL_DEX_GOURGEIST, // Average Size
    NATIONAL_DEX_LURANTIS,
    ...
    NATIONAL_DEX_WARTORTLE,
    NATIONAL_DEX_BEEDRILL,
    NATIONAL_DEX_RAICHU_MEGA_Y, // Mega
    NATIONAL_DEX_SANDSLASH,
    NATIONAL_DEX_WIGGLYTUFF,
    NATIONAL_DEX_PARASECT,
    NATIONAL_DEX_VENONAT,
    ...
    NATIONAL_DEX_SOLROCK,
    NATIONAL_DEX_BANETTE_MEGA, // Mega
    NATIONAL_DEX_CHIMECHO_MEGA, // Mega
    NATIONAL_DEX_ABSOL,
    NATIONAL_DEX_ABSOL_MEGA, // Mega
    NATIONAL_DEX_ABSOL_MEGA_Z, // Mega
    NATIONAL_DEX_METANG,
    ...
    NATIONAL_DEX_CLAWITZER,
    NATIONAL_DEX_AMAURA,
    NATIONAL_DEX_MAGEARNA_MEGA, // Mega
    NATIONAL_DEX_PALOSSAND,
    NATIONAL_DEX_TAPU_FINI,
    NATIONAL_DEX_DUBWOOL,
    NATIONAL_DEX_BARRASKEWDA,
    ...
    NATIONAL_DEX_CHARIZARD_MEGA_X, // Mega X
    NATIONAL_DEX_CHARIZARD_MEGA_Y, // Mega Y
    NATIONAL_DEX_CLEFABLE_MEGA, // Mega
    NATIONAL_DEX_GOLDUCK,
    NATIONAL_DEX_VICTREEBEL,
    NATIONAL_DEX_GOLEM_ALOLAN, // Alolan Form
    NATIONAL_DEX_RAPIDASH,
    ...
    NATIONAL_DEX_HERACROSS_MEGA, // Mega
    NATIONAL_DEX_SKARMORY,
    NATIONAL_DEX_SKARMORY_MEGA, // Mega
    NATIONAL_DEX_SCEPTILE,
    NATIONAL_DEX_SWALOT,
    NATIONAL_DEX_HUNTAIL,
    NATIONAL_DEX_REGIROCK,
    ...
    NATIONAL_DEX_GARCHOMP_MEGA_Z, // Mega
    NATIONAL_DEX_YANMEGA,
    NATIONAL_DEX_GARBODOR,
    NATIONAL_DEX_SAWSBUCK,
    NATIONAL_DEX_TERRAKION,
    ...
    NATIONAL_DEX_KANGASKHAN_MEGA, // Mega
    NATIONAL_DEX_DRAGONITE,
    NATIONAL_DEX_DRAGONITE_MEGA, // Mega
    NATIONAL_DEX_AGGRON_MEGA, // Mega
    NATIONAL_DEX_TORTERRA,
    NATIONAL_DEX_ABOMASNOW,
    NATIONAL_DEX_DUSKNOIR,
    ...
    NATIONAL_DEX_GREAT_TUSK,
    // 7'07" / 2.3m
    NATIONAL_DEX_STARMIE_MEGA, // Mega
    NATIONAL_DEX_MEWTWO_MEGA_X, // Mega X
    NATIONAL_DEX_FERALIGATR,
    NATIONAL_DEX_FERALIGATR_MEGA, // Mega
    NATIONAL_DEX_HARIYAMA,
    NATIONAL_DEX_LATIOS_MEGA, // Mega
    NATIONAL_DEX_GOLISOPOD_MEGA, // Mega
    NATIONAL_DEX_SILVALLY,
    NATIONAL_DEX_ARCTOZOLT,
    NATIONAL_DEX_DRACOVISH,
    NATIONAL_DEX_GARGANACL,
    ...
    // 7'10" / 2.4m
    NATIONAL_DEX_VENUSAUR_MEGA, // Mega
    NATIONAL_DEX_MEGANIUM_MEGA, // Mega
    NATIONAL_DEX_RHYPERIOR,
    NATIONAL_DEX_BUZZWOLE,
    NATIONAL_DEX_NECROZMA,
    NATIONAL_DEX_CALYREX_ICE_RIDER, // Ice Rider
    ...
    NATIONAL_DEX_MAMOSWINE,
    NATIONAL_DEX_SCOLIPEDE,
    NATIONAL_DEX_CHANDELURE_MEGA, // Mega
    NATIONAL_DEX_TYRANTRUM,
    NATIONAL_DEX_MUDSDALE,
    NATIONAL_DEX_MELMETAL,
    NATIONAL_DEX_STONJOURNER,
    ...
    NATIONAL_DEX_KORAIDON,
    // 8'06" / 2.6m
    NATIONAL_DEX_FROSLASS_MEGA, // Mega
    NATIONAL_DEX_BEARTIC,
    NATIONAL_DEX_CRABOMINABLE_MEGA, // Mega
    // 8'10" / 2.7m
    NATIONAL_DEX_SEVIPER,
    NATIONAL_DEX_ABOMASNOW_MEGA, // Mega
    NATIONAL_DEX_AURORUS,
    ...
    NATIONAL_DEX_WEEZING_GALARIAN, // Galarian Form
    NATIONAL_DEX_DARKRAI_MEGA, // Mega
    NATIONAL_DEX_EELEKTROSS_MEGA, // Mega
    NATIONAL_DEX_THUNDURUS_THERIAN, // Therian Form
    NATIONAL_DEX_KYUREM,
    NATIONAL_DEX_XERNEAS,
    NATIONAL_DEX_DRAMPA,
    NATIONAL_DEX_DRAMPA_MEGA, // Mega
    NATIONAL_DEX_CENTISKORCH,
    NATIONAL_DEX_FALINKS,
    NATIONAL_DEX_COPPERAJAH,
    NATIONAL_DEX_DRAGAPULT,
    ...
    // 10'06" / 3.2m
    NATIONAL_DEX_ARCEUS,
    NATIONAL_DEX_SCOLIPEDE_MEGA, // Mega
    NATIONAL_DEX_RESHIRAM,
    NATIONAL_DEX_FARIGIRAF,
    NATIONAL_DEX_SLITHER_WING,
    // 10'10" / 3.3m
