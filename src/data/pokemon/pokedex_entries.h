const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_FLETCHINDER] =
    {
        ...
        .height = 7,
        .weight = 160,
        .description = gFlechinderPokedexText,
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CRABOMINABLE] =
    {
        ...
        .height = 17,
        .weight = 1800,
        .description = gCrabminblePokedexText,
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 290,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_BLACEPHALON] =
    {
        ...
        .height = 18,
        .weight = 130,
        .description = gBlacphalonPokedexText,
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [NATIONAL_DEX_CORVISQUIRE] =
    {
        ...
        .height = 8,
        .weight = 160,
        .description = gCorvsquirePokedexText,
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CORVIKNIGHT] =
    {
        ...
        .height = 22,
        .weight = 750,
        .description = gCorvknightPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 348,
        .trainerOffset = 6,
    ...
    [NATIONAL_DEX_BARRASKEWDA] =
    {
        ...
        .height = 13,
        .weight = 300,
        .description = gBaraskewdaPokedexText,
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CENTISKORCH] =
    {
        ...
        .height = 30,
        .weight = 1200,
        .description = gCentskorchPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_POLTEAGEIST] =
    {
        ...
        .height = 2,
        .weight = 4,
        .description = gPoltegeistPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_STONJOURNER] =
    {
        ...
        .height = 25,
        .weight = 5200,
        .description = gStonjornerPokedexText,
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [NATIONAL_DEX_BASCULEGION] =
    {
        ...
        .height = 30,
        .weight = 1100,
        .description = gBasclegionPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .description = gMeowscradaPokedexText,
    ...
    {
        .description = gSquawkbilyPokedexText,
    ...
    {
        .description = gKilowattrlPokedexText,
    ...
    {
        .description = gBramblgastPokedexText,
        .categoryName = _("Tumbleweed"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gDudunsprcePokedexText,
        .categoryName = _("Land Snake"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gBruteBonetPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gFluttrManePokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gSlithrWingPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gSandyShockPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gIronJuglisPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gRoarinMoonPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gIronValianPokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gWalkinWakePokedexText,
        .categoryName = _("Paradox"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gPolchgeistPokedexText,
    ...
    {
        .description = gFezandiptiPokedexText,
        .categoryName = _("Retainer"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_VENUSAUR_MEGA] =
    {
        ...
        .height = 24,
        .weight = 1555,
        .description = gVenusaurMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHARIZARD_MEGA_X] =
    {
        ...
        .height = 17,
        .weight = 1105,
        .description = gCharizardXPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BLASTOISE_MEGA] =
    {
        ...
        .height = 16,
        .weight = 1011,
        .description = gBlastoiseMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BEEDRILL_MEGA] =
    {
        ...
        .height = 14,
        .weight = 405,
        .description = gBeedrillMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PIDGEOT_MEGA] =
    {
        ...
        .height = 22,
        .weight = 505,
        .description = gPidgeotMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ALAKAZAM_MEGA] =
    {
        ...
        .height = 12,
        .weight = 480,
        .description = gAlakazamMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SLOWBRO_MEGA] =
    {
        ...
        .height = 20,
        .weight = 1200,
        .description = gSlowbroMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GENGAR_MEGA] =
    {
        ...
        .height = 14,
        .weight = 405,
        .description = gGengarMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KANGASKHAN_MEGA] =
    {
        ...
        .height = 22,
        .weight = 1000,
        .description = gKangaskhaMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PINSIR_MEGA] =
    {
        ...
        .height = 17,
        .weight = 590,
        .description = gPinsirMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GYARADOS_MEGA] =
    {
        ...
        .height = 65,
        .weight = 3050,
        .description = gGyaradosMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_AERODACTYL_MEGA] =
    {
        ...
        .height = 21,
        .weight = 790,
        .description = gAerodactyMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEWTWO_MEGA_X] =
    {
        ...
        .height = 23,
        .weight = 1270,
        .description = gMewtwoXPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEWTWO_MEGA_Y] =
    {
        ...
        .height = 15,
        .weight = 330,
        .description = gMewtwoYPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_STEELIX_MEGA] =
    {
        ...
        .height = 105,
        .weight = 7400,
        .description = gSteelixMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SCIZOR_MEGA] =
    {
        ...
        .height = 20,
        .weight = 1250,
        .description = gScizorMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HERACROSS_MEGA] =
    {
        ...
        .height = 17,
        .weight = 625,
        .description = gHeracrossMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HOUNDOOM_MEGA] =
    {
        ...
        .height = 19,
        .weight = 495,
        .description = gHoundoomMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TYRANITAR_MEGA] =
    {
        ...
        .height = 25,
        .weight = 2550,
        .description = gTyranitarMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SCEPTILE_MEGA] =
    {
        ...
        .height = 19,
        .weight = 552,
        .description = gSceptileMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BLAZIKEN_MEGA] =
    {
        ...
        .height = 19,
        .weight = 520,
        .description = gBlazikenMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SWAMPERT_MEGA] =
    {
        ...
        .height = 19,
        .weight = 1020,
        .description = gSwampertMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GARDEVOIR_MEGA] =
    {
        ...
        .height = 16,
        .weight = 484,
        .description = gGardevoirMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SABLEYE_MEGA] =
    {
        ...
        .height = 5,
        .weight = 1610,
        .description = gSableyeMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAWILE_MEGA] =
    {
        ...
        .height = 10,
        .weight = 235,
        .description = gMawileMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_AGGRON_MEGA] =
    {
        ...
        .height = 22,
        .weight = 3950,
        .description = gAggronMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEDICHAM_MEGA] =
    {
        ...
        .height = 13,
        .weight = 315,
        .description = gMedichamMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MANECTRIC_MEGA] =
    {
        ...
        .height = 18,
        .weight = 440,
        .description = gManectricMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHARPEDO_MEGA] =
    {
        ...
        .height = 25,
        .weight = 1303,
        .description = gSharpedoMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CAMERUPT_MEGA] =
    {
        ...
        .height = 25,
        .weight = 3205,
        .description = gCameruptMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ALTARIA_MEGA] =
    {
        ...
        .height = 15,
        .weight = 206,
        .description = gAltariaMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BANETTE_MEGA] =
    {
        ...
        .height = 12,
        .weight = 130,
        .description = gBanetteMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ABSOL_MEGA] =
    {
        ...
        .height = 12,
        .weight = 490,
        .description = gAbsolMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GLALIE_MEGA] =
    {
        ...
        .height = 21,
        .weight = 3502,
        .description = gGlalieMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SALAMENCE_MEGA] =
    {
        ...
        .height = 18,
        .weight = 1126,
        .description = gSalamenceMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_METAGROSS_MEGA] =
    {
        ...
        .height = 25,
        .weight = 9429,
        .description = gMetagrossMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LATIAS_MEGA] =
    {
        ...
        .height = 18,
        .weight = 520,
        .description = gLatiasMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LATIOS_MEGA] =
    {
        ...
        .height = 23,
        .weight = 700,
        .description = gLatiosMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LOPUNNY_MEGA] =
    {
        ...
        .height = 13,
        .weight = 283,
        .description = gLopunnyMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GARCHOMP_MEGA] =
    {
        ...
        .height = 19,
        .weight = 950,
        .description = gGarchompMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LUCARIO_MEGA] =
    {
        ...
        .height = 13,
        .weight = 575,
        .description = gLucarioMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ABOMASNOW_MEGA] =
    {
        ...
        .height = 27,
        .weight = 1850,
        .description = gAbomasnowMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GALLADE_MEGA] =
    {
        ...
        .height = 16,
        .weight = 564,
        .description = gGalladeMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_AUDINO_MEGA] =
    {
        ...
        .height = 15,
        .weight = 320,
        .description = gAudinoMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DIANCIE_MEGA] =
    {
        ...
        .height = 11,
        .weight = 278,
        .description = gDiancieMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAYQUAZA_MEGA] =
    {
        ...
        .height = 108,
        .weight = 3920,
        .description = gRayquazaMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_KYOGRE_PRIMAL] =
    {
        ...
        .height = 98,
        .weight = 4300,
        .description = gKyogrePPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GROUDON_PRIMAL] =
    {
        ...
        .height = 50,
        .weight = 9997,
        .description = gGroudonPPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RATTATA_ALOLAN] =
    {
        ...
        .height = 3,
        .weight = 38,
        .description = gRattataAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RATICATE_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 255,
        .description = gRaticateAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAICHU_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 210,
        .description = gRaichuAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DIGLETT_ALOLAN] =
    {
        ...
        .height = 2,
        .weight = 10,
        .description = gDiglettAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DUGTRIO_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 666,
        .description = gDugtrioAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWTH_ALOLAN] =
    {
        ...
        .height = 4,
        .weight = 42,
        .description = gMeowthAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PERSIAN_ALOLAN] =
    {
        ...
        .height = 11,
        .weight = 330,
        .description = gPersianAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GEODUDE_ALOLAN] =
    {
        ...
        .height = 4,
        .weight = 203,
        .description = gGeodudeAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRAVELER_ALOLAN] =
    {
        ...
        .height = 10,
        .weight = 1100,
        .description = gGravelerAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GOLEM_ALOLAN] =
    {
        ...
        .height = 17,
        .weight = 3160,
        .description = gGolemAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRIMER_ALOLAN] =
    {
        ...
        .height = 7,
        .weight = 420,
        .description = gGrimerAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EXEGGUTOR_ALOLAN] =
    {
        ...
        .height = 109,
        .weight = 4156,
        .description = gExeggutorAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAROWAK_ALOLAN] =
    {
        ...
        .height = 10,
        .weight = 340,
        .description = gMarowakAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWTH_GALARIAN] =
    {
        ...
        .height = 4,
        .weight = 75,
        .description = gMeowthGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SLOWPOKE_GALARIAN] =
    {
        ...
        .height = 12,
        .weight = 360,
        .description = gSlowpokeGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SLOWBRO_GALARIAN] =
    {
        ...
        .height = 16,
        .weight = 705,
        .description = gSlowbroGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FARFETCHD_GALARIAN] =
    {
        ...
        .height = 8,
        .weight = 420,
        .description = gFarfetchdGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WEEZING_GALARIAN] =
    {
        ...
        .height = 30,
        .weight = 160,
        .description = gWeezingGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MR_MIME_GALARIAN] =
    {
        ...
        .height = 14,
        .weight = 568,
        .description = gMrMimeGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ARTICUNO_GALARIAN] =
    {
        ...
        .height = 17,
        .weight = 509,
        .description = gArticunoGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZAPDOS_GALARIAN] =
    {
        ...
        .height = 16,
        .weight = 582,
        .description = gZapdosGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MOLTRES_GALARIAN] =
    {
        ...
        .height = 20,
        .weight = 660,
        .description = gMoltresGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SLOWKING_GALARIAN] =
    {
        ...
        .height = 18,
        .weight = 795,
        .description = gSlowkingGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CORSOLA_GALARIAN] =
    {
        ...
        .height = 6,
        .weight = 5,
        .description = gCorsolaGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZIGZAGOON_GALARIAN] =
    {
        ...
        .height = 4,
        .weight = 175,
        .description = gZigzagoonGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LINOONE_GALARIAN] =
    {
        ...
        .height = 5,
        .weight = 325,
        .description = gLinooneGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DARUMAKA_GALARIAN] =
    {
        ...
        .height = 7,
        .weight = 400,
        .description = gDarumakaGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DARMANITAN_GALARIAN] =
    {
        ...
        .height = 17,
        .weight = 1200,
        .description = gDarmanitaGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_YAMASK_GALARIAN] =
    {
        ...
        .height = 5,
        .weight = 15,
        .description = gYamaskGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_STUNFISK_GALARIAN] =
    {
        ...
        .height = 7,
        .weight = 205,
        .description = gStunfiskGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GROWLITHE_HISUIAN] =
    {
        ...
        .height = 8,
        .weight = 227,
        .description = gGrowlitheHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ARCANINE_HISUIAN] =
    {
        ...
        .height = 20,
        .weight = 1680,
        .description = gArcanineHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VOLTORB_HISUIAN] =
    {
        ...
        .height = 5,
        .weight = 130,
        .description = gVoltorbHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ELECTRODE_HISUIAN] =
    {
        ...
        .height = 12,
        .weight = 710,
        .description = gElectrodeHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TYPHLOSION_HISUIAN] =
    {
        ...
        .height = 16,
        .weight = 698,
        .description = gTyphlosioHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_QWILFISH_HISUIAN] =
    {
        ...
        .height = 5,
        .weight = 39,
        .description = gQwilfishHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SNEASEL_HISUIAN] =
    {
        ...
        .height = 9,
        .weight = 270,
        .description = gSneaselHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SAMUROTT_HISUIAN] =
    {
        ...
        .height = 15,
        .weight = 582,
        .description = gSamurottHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LILLIGANT_HISUIAN] =
    {
        ...
        .height = 12,
        .weight = 192,
        .description = gLilligantHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZORUA_HISUIAN] =
    {
        ...
        .height = 7,
        .weight = 125,
        .description = gZoruaHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZOROARK_HISUIAN] =
    {
        ...
        .height = 16,
        .weight = 730,
        .description = gZoroarkHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BRAVIARY_HISUIAN] =
    {
        ...
        .height = 17,
        .weight = 434,
        .description = gBraviaryHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SLIGGOO_HISUIAN] =
    {
        ...
        .height = 7,
        .weight = 685,
        .description = gSliggooHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GOODRA_HISUIAN] =
    {
        ...
        .height = 17,
        .weight = 3341,
        .description = gGoodraHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_AVALUGG_HISUIAN] =
    {
        ...
        .height = 14,
        .weight = 2624,
        .description = gAvaluggHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DECIDUEYE_HISUIAN] =
    {
        ...
        .height = 16,
        .weight = 370,
        .description = gDecidueyeHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TAUROS_PALDEAN] =
    {
        ...
        .height = 14,
        .weight = 1150,
        .description = gTaurosPPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WOOPER_PALDEAN] =
    {
        ...
        .height = 4,
        .weight = 110,
        .description = gWooperPPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TAUROS_PALDEAN_BLAZE_BREED] =
    {
        ...
        .height = 14,
        .weight = 850,
        .description = gTaurosPFPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TAUROS_PALDEAN_AQUA_BREED] =
    {
        ...
        .height = 14,
        .weight = 1100,
        .description = gTaurosPWPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CASTFORM_SUNNY] =
    {
        ...
        .height = 3,
        .weight = 8,
        .description = gCastformFPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CASTFORM_RAINY] =
    {
        ...
        .height = 3,
        .weight = 8,
        .description = gCastformWPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CASTFORM_SNOWY] =
    {
        ...
        .height = 3,
        .weight = 8,
        .description = gCastformIPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BURMY_SANDY_CLOAK] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = gBurmySPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BURMY_TRASH_CLOAK] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = gBurmyTPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WORMADAM_SANDY_CLOAK] =
    {
        ...
        .height = 5,
        .weight = 65,
        .description = gWormadamSPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ROTOM_HEAT] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gRotomHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ROTOM_WASH] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gRotomWPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ROTOM_FROST] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gRotomFrPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ROTOM_FAN] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gRotomFaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ROTOM_MOW] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gRotomMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DIALGA_ORIGIN] =
    {
        ...
        .height = 70,
        .weight = 8500,
        .description = gDialgaOPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PALKIA_ORIGIN] =
    {
        ...
        .height = 63,
        .weight = 6600,
        .description = gPalkiaOPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GIRATINA_ORIGIN] =
    {
        ...
        .height = 69,
        .weight = 6500,
        .description = gGiratinaOPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHAYMIN_SKY] =
    {
        ...
        .height = 4,
        .weight = 52,
        .description = gShayminSPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BASCULIN_BLUE_STRIPED] =
    {
        ...
        .height = 10,
        .weight = 180,
        .description = gBasculinBluePokedexText,
        .pokemonScale = 316,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .height = 10,
        .weight = 180,
        .description = gBasculinHPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DARMANITAN_ZEN_MODE] =
    {
        ...
        .height = 13,
        .weight = 929,
        .description = gDarmanitaZPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DARMANITAN_ZEN_MODE_GALARIAN] =
    {
        ...
        .height = 17,
        .weight = 1200,
        .description = gDarmanitZGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TORNADUS_THERIAN] =
    {
        ...
        .height = 140,
        .weight = 630,
        .description = gTornadusTPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LANDORUS_THERIAN] =
    {
        ...
        .height = 130,
        .weight = 680,
        .description = gLandorusTPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRENINJA_ASH] =
    {
        ...
        .height = 15,
        .weight = 400,
        .description = gGreninjaAPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZYGARDE_COMPLETE] =
    {
        ...
        .height = 45,
        .weight = 6100,
        .description = gZygardeCPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HOOPA_UNBOUND] =
    {
        ...
        .height = 65,
        .weight = 4900,
        .description = gHoopaUPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORICORIO_POM_POM] =
    {
        ...
        .height = 6,
        .weight = 34,
        .description = gOricorioEPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORICORIO_PAU] =
    {
        ...
        .height = 6,
        .weight = 34,
        .description = gOricorioPPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ORICORIO_SENSU] =
    {
        ...
        .height = 6,
        .weight = 34,
        .description = gOricorioGPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WISHIWASHI_SCHOOL] =
    {
        ...
        .height = 82,
        .weight = 786,
        .description = gWishiwashSPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MINIOR_CORE_RED] =
    {
        ...
        .height = 3,
        .weight = 3,
        .description = gMiniorCPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NECROZMA_DUSK_MANE] =
    {
        ...
        .height = 38,
        .weight = 4600,
        .description = gNecrozmaDMPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NECROZMA_DAWN_WINGS] =
    {
        ...
        .height = 42,
        .weight = 3500,
        .description = gNecrozmaDWPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_NECROZMA_ULTRA] =
    {
        ...
        .height = 75,
        .weight = 2300,
        .description = gNecrozmaUPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_INDEEDEE_FEMALE] =
    {
        ...
        .height = 9,
        .weight = 280,
        .description = gIndeedeeFPokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZACIAN_CROWNED_SWORD] =
    {
        ...
        .height = 28,
        .weight = 3550,
        .description = gZacianCPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZAMAZENTA_CROWNED_SHIELD] =
    {
        ...
        .height = 29,
        .weight = 7850,
        .description = gZamazentaCPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_URSHIFU_RAPID_STRIKE_STYLE] =
    {
        ...
        .height = 19,
        .weight = 1050,
        .description = gUrshifuRPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CALYREX_ICE_RIDER] =
    {
        ...
        .height = 24,
        .weight = 8091,
        .description = gCalyrexIPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CALYREX_SHADOW_RIDER] =
    {
        ...
        .height = 24,
        .weight = 536,
        .description = gCalyrexSPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .description = gUrsalunaBPokedexText,
        .categoryName = _("Peat"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_BASCULEGION_FEMALE] =
    {
        ...
        .height = 30,
        .weight = 1100,
        .description = gBasculegionFPokedexText,
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ENAMORUS_THERIAN] =
    {
        ...
        .height = 16,
        .weight = 480,
        .description = gEnamorusTPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    {
        .description = gPalafinHPokedexText,
        .categoryName = _("Hero"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gOgerponWPokedexText,
        .categoryName = _("Mask"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gOgerponFPokedexText,
        .categoryName = _("Mask"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gOgerponRPokedexText,
        .categoryName = _("Mask"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gTerapagosTerastalPokedexText,
        .categoryName = _("Tera"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    {
        .description = gTerapagosStellarPokedexText,
        .categoryName = _("Tera"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [NATIONAL_DEX_CLEFABLE_MEGA] = 
    {
        .categoryName = _("Fairy"),
        .height = 17,
        .weight = 423,
        .description = gClefableMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_VICTREEBEL_MEGA] = 
    {
        .categoryName = _("Flycatcher"),
        .height = 45,
        .weight = 1255,
        .description = gVictreebelMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_STARMIE_MEGA] = 
    {
        .categoryName = _("Mysterious"),
        .height = 23,
        .weight = 800,
        .description = gStarmieMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DRAGONITE_MEGA] = 
    {
        ...
        .height = 22,
        .weight = 2900,
        .description = gDragoniteMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEGANIUM_MEGA] = 
    {
        ...
        .height = 24,
        .weight = 2010,
        .description = gMeganiumMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FERALIGATR_MEGA] = 
    {
        ...
        .height = 23,
        .weight = 1088,
        .description = gFeraligatrMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SKARMORY_MEGA] = 
    {
        ...
        .height = 17,
        .weight = 404,
        .description = gSkarmoryMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FROSLASS_MEGA] = 
    {
        ...
        .height = 26,
        .weight = 296,
        .description = gFroslassMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EMBOAR_MEGA] = 
    {
        .categoryName = _("Mega Fire Pig"),
        .height = 18,
        .weight = 1803,
        .description = gEmboarMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EXCADRILL_MEGA] = 
    {
        .categoryName = _("Subterrene"),
        .height = 9,
        .weight = 600,
        .description = gExcadrillMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SCOLIPEDE_MEGA] = 
    {
        ...
        .height = 32,
        .weight = 2305,
        .description = gScolipedeMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SCRAFTY_MEGA] = 
    {
        .categoryName = _("Hoodlum"),
        .height = 11,
        .weight = 310,
        .description = gScraftyMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_EELEKTROSS_MEGA] = 
    {
        .categoryName = _("EleFish"),
        .height = 30,
        .weight = 1800,
        .description = gEelektrossMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHANDELURE_MEGA] = 
    {
        ...
        .height = 25,
        .weight = 696,
        .description = gChandelureMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHESNAUGHT_MEGA] = 
    {
        .categoryName = _("Spiny Armor"),
        .height = 16,
        .weight = 900,
        .description = gChesnaughtMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DELPHOX_MEGA] = 
    {
        .categoryName = _("Fox"),
        .height = 15,
        .weight = 390,
        .description = gDelphoxMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GRENINJA_MEGA] = 
    {
        .categoryName = _("Ninja"),
        .height = 15,
        .weight = 400,
        .description = gGreninjaMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_PYROAR_MEGA] = 
    {
        .categoryName = _("Royal"),
        .height = 15,
        .weight = 933,
        .description = gPyroarMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FLOETTE_MEGA] = 
    {
        .categoryName = _("Single Bloom"),
        .height = 2,
        .weight = 1008,
        .description = gFloetteMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MALAMAR_MEGA] = 
    {
        .categoryName = _("Overturning"),
        .height = 29,
        .weight = 698,
        .description = gMalamarMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BARBARACLE_MEGA] = 
    {
        .categoryName = _("Collective"),
        .height = 22,
        .weight = 1000,
        .description = gBarbaracleMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DRAGALGE_MEGA] = 
    {
        ...
        .height = 21,
        .weight = 1003,
        .description = gDragalgeMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HAWLUCHA_MEGA] = 
    {
        .categoryName = _("Wrestling"),
        .height = 10,
        .weight = 250,
        .description = gHawluchaMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZYGARDE_MEGA] = 
    {
        ...
        .height = 77,
        .weight = 6100,
        .description = gZygardeMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DRAMPA_MEGA] = 
    {
        ...
        .height = 30,
        .weight = 2405,
        .description = gDrampaMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FALINKS_MEGA] = 
    {
        ...
        .height = 16,
        .weight = 990,
        .description = gFalinksMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAICHU_MEGA_X] = 
    {
        .categoryName = _("Mouse"),
        .height = 12,
        .weight = 380,
        .description = gRaichuMegaXPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RAICHU_MEGA_Y] = 
    {
        .categoryName = _("Mouse"),
        .height = 10,
        .weight = 260,
        .description = gRaichuMegaYPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHIMECHO_MEGA] = 
    {
        ...
        .height = 12,
        .weight = 80,
        .description = gChimechoMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ABSOL_MEGA_Z] = 
    {
        ...
        .height = 12,
        .weight = 490,
        .description = gAbsolMegaZPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_STARAPTOR_MEGA] = 
    {
        ...
        .height = 19,
        .weight = 500,
        .description = gStaraptorMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GARCHOMP_MEGA_Z] = 
    {
        .categoryName = _("Mach"),
        .height = 19,
        .weight = 990,
        .description = gGarchompMegaZPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LUCARIO_MEGA_Z] = 
    {
        .categoryName = _("Aura"),
        .height = 13,
        .weight = 494,
        .description = gLucarioMegaZPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HEATRAN_MEGA] = 
    {
        .categoryName = _("Lava Dome"),
        .height = 28,
        .weight = 5700,
        .description = gHeatranMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_DARKRAI_MEGA] = 
    {
        .categoryName = _("Bad Dreams"),
        .height = 30,
        .weight = 2400,
        .description = gDarkraiMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GOLURK_MEGA] = 
    {
        ...
        .height = 40,
        .weight = 3300,
        .description = gGolurkMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWSTIC_MEGA] = 
    {
        .categoryName = _("Second Sight"),
        .height = 8,
        .weight = 101,
        .description = gMeowsticMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CRABOMINABLE_MEGA] = 
    {
        ...
        .height = 26,
        .weight = 2528,
        .description = gCrabominableMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GOLISOPOD_MEGA] = 
    {
        .categoryName = _("Hard Scale"),
        .height = 23,
        .weight = 1480,
        .description = gGolisopodMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MAGEARNA_MEGA] = 
    {
        .categoryName = _("Artificial"),
        .height = 13,
        .weight = 2481,
        .description = gMagearnaMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_ZERAORA_MEGA] = 
    {
        .categoryName = _("Thunderclap"),
        .height = 15,
        .weight = 445,
        .description = gZeraoraMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SCOVILLAIN_MEGA] = 
    {
        .categoryName = _("Spicy Pepper"),
        .height = 12,
        .weight = 220,
        .description = gScovillainMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GLIMMORA_MEGA] = 
    {
        .categoryName = _("Ore"),
        .height = 28,
        .weight = 770,
        .description = gGlimmoraMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TATSUGIRI_MEGA] = 
    {
        .categoryName = _("Mimicry"),
        .height = 6,
        .weight = 240,
        .description = gTatsugiriMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BAXCALIBUR_MEGA] = 
    {
        .categoryName = _("Ice Dragon"),
        .height = 21,
        .weight = 3150,
        .description = gBaxcaliburMegaPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_MEOWSTIC_FEMALE_MEGA] = 
    {
        .categoryName = _("Second Sight"),
        .height = 8,
        .weight = 101,
