const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(CHALKBOARD_1, gMonPalette_Chalkboard),
    SPECIES_PAL(CHALKBOARD_2, gMonPalette_Chalkboard),
    SPECIES_PAL(CHALKBOARD_3, gMonPalette_Chalkboard),
    ...
    SPECIES_PAL(ALCREMIE, gMonPalette_AlcremieStrawberryVanillaCream),
    ...
    SPECIES_PAL(PIKACHU_CAP_2, gMonPalette_PikachuC_M2),
    SPECIES_PAL(PIKACHU_CAP_3, gMonPalette_PikachuC_M3),
    SPECIES_PAL(PIKACHU_CAP_4, gMonPalette_PikachuC_M4),
    SPECIES_PAL(PIKACHU_CAP_5, gMonPalette_PikachuC_M5),
    SPECIES_PAL(PIKACHU_CAP_6, gMonPalette_PikachuC_M6),
    SPECIES_PAL(PIKACHU_CAP_7, gMonPalette_PikachuC_M7),
    SPECIES_PAL(PIKACHU_CAP_8, gMonPalette_PikachuC_M8),
    SPECIES_PAL(PIKACHU_COSPLAY_1, gMonPalette_PikachuC_F1),
    SPECIES_PAL(PIKACHU_COSPLAY_2, gMonPalette_PikachuC_F2),
    SPECIES_PAL(PIKACHU_COSPLAY_3, gMonPalette_PikachuC_F3),
    SPECIES_PAL(PIKACHU_COSPLAY_4, gMonPalette_PikachuC_F4),
    SPECIES_PAL(PIKACHU_COSPLAY_5, gMonPalette_PikachuC_F5),
    SPECIES_PAL(PIKACHU_COSPLAY_6, gMonPalette_PikachuC_F6),
    SPECIES_PAL(KELDEO_RESOLUTE, gMonPalette_KeldeoResolute),
    SPECIES_PAL(FURFROU_TRIM_1, gMonPalette_FurfrouC_1),
    SPECIES_PAL(FURFROU_TRIM_2, gMonPalette_FurfrouC_2),
    SPECIES_PAL(FURFROU_TRIM_3, gMonPalette_FurfrouC_3),
    SPECIES_PAL(FURFROU_TRIM_4, gMonPalette_FurfrouC_4),
    SPECIES_PAL(FURFROU_TRIM_5, gMonPalette_FurfrouC_5),
    SPECIES_PAL(FURFROU_TRIM_6, gMonPalette_FurfrouC_6),
    SPECIES_PAL(FURFROU_TRIM_7, gMonPalette_FurfrouC_7),
    SPECIES_PAL(FURFROU_TRIM_8, gMonPalette_FurfrouC_8),
    SPECIES_PAL(FURFROU_TRIM_9, gMonPalette_FurfrouC_9),
    SPECIES_PAL(MAGEARNA_ORIGINAL_COLOR, gMonPalette_MagearnaOriginal),
    ...
    SPECIES_PAL(PYROAR_MEGA, gMonPalette_PyroarMega),
    SPECIES_PAL(FLOETTE_MEGA, gMonPalette_FloetteMega),
    ...
    SPECIES_PAL(ZYGARDE_MEGA, gMonPalette_ZygardeMega),
    ...
    SPECIES_PAL(ABSOL_MEGA_Z, gMonPalette_AbsolMegaZ),
    SPECIES_PAL(STARAPTOR_MEGA, gMonPalette_StaraptorMega),
    SPECIES_PAL(GARCHOMP_MEGA_Z, gMonPalette_GarchompMegaZ),
    SPECIES_PAL(LUCARIO_MEGA_Z, gMonPalette_LucarioMegaZ),
    SPECIES_PAL(HEATRAN_MEGA, gMonPalette_HeatranMega),
    SPECIES_PAL(DARKRAI_MEGA, gMonPalette_DarkraiMega),
    ...
    SPECIES_PAL(MAGEARNA_MEGA, gMonPalette_MagearnaMega),
    ...
    SPECIES_PAL(HIPPOPOTAS_FEMALE, gMonPalette_Hippopotas),
    SPECIES_PAL(HIPPOWDON_FEMALE, gMonPalette_Hippowdon),
    SPECIES_PAL(UNFEZANT_FEMALE, gMonPalette_UnfezantF),
    SPECIES_PAL(FRILLISH_FEMALE, gMonPalette_FrillishF),
    SPECIES_PAL(JELLICENT_FEMALE, gMonPalette_JellicentF),
    SPECIES_PAL(PYROAR_FEMALE, gMonPalette_Pyroar),
    SPECIES_PAL(COMBEE_FEMALE, gMonPalette_Combee),
    ...
    SPECIES_PAL(VENUSAUR_FEMALE, gMonPalette_Venusaur),
    SPECIES_PAL(BUTTERFREE_FEMALE, gMonPalette_Butterfree),
    SPECIES_PAL(RATTATA_FEMALE, gMonPalette_Rattata),
    SPECIES_PAL(RATICATE_FEMALE, gMonPalette_Raticate),
    SPECIES_PAL(PIKACHU_FEMALE, gMonPalette_Pikachu),
    SPECIES_PAL(RAICHU_FEMALE, gMonPalette_Raichu),
    SPECIES_PAL(ZUBAT_FEMALE, gMonPalette_Zubat),
    SPECIES_PAL(GOLBAT_FEMALE, gMonPalette_Golbat),
    SPECIES_PAL(GLOOM_FEMALE, gMonPalette_Gloom),
    SPECIES_PAL(VILEPLUME_FEMALE, gMonPalette_Vileplume),
    SPECIES_PAL(KADABRA_FEMALE, gMonPalette_Kadabra),
    SPECIES_PAL(ALAKAZAM_FEMALE, gMonPalette_Alakazam),
    SPECIES_PAL(DODUO_FEMALE, gMonPalette_Doduo),
    SPECIES_PAL(DODRIO_FEMALE, gMonPalette_Dodrio),
    SPECIES_PAL(HYPNO_FEMALE, gMonPalette_Hypno),
    SPECIES_PAL(RHYHORN_FEMALE, gMonPalette_Rhyhorn),
    SPECIES_PAL(RHYDON_FEMALE, gMonPalette_Rhydon),
    SPECIES_PAL(GOLDEEN_FEMALE, gMonPalette_Goldeen),
    SPECIES_PAL(SEAKING_FEMALE, gMonPalette_Seaking),
    SPECIES_PAL(SCYTHER_FEMALE, gMonPalette_Scyther),
    SPECIES_PAL(MAGIKARP_FEMALE, gMonPalette_Magikarp),
    SPECIES_PAL(GYARADOS_FEMALE, gMonPalette_Gyarados),
    SPECIES_PAL(EEVEE_FEMALE, gMonPalette_Eevee),
    SPECIES_PAL(MEGANIUM_FEMALE, gMonPalette_Meganium),
    SPECIES_PAL(LEDYBA_FEMALE, gMonPalette_Ledyba),
    SPECIES_PAL(LEDIAN_FEMALE, gMonPalette_Ledian),
    SPECIES_PAL(XATU_FEMALE, gMonPalette_Xatu),
    SPECIES_PAL(SUDOWOODO_FEMALE, gMonPalette_Sudowoodo),
    SPECIES_PAL(POLITOED_FEMALE, gMonPalette_Politoed),
    SPECIES_PAL(AIPOM_FEMALE, gMonPalette_Aipom),
    SPECIES_PAL(WOOPER_FEMALE, gMonPalette_Wooper),
    SPECIES_PAL(QUAGSIRE_FEMALE, gMonPalette_Quagsire),
    SPECIES_PAL(MURKROW_FEMALE, gMonPalette_Murkrow),
    SPECIES_PAL(WOBBUFFET_FEMALE, gMonPalette_Wobbuffet),
    SPECIES_PAL(GIRAFARIG_FEMALE, gMonPalette_Girafarig),
    SPECIES_PAL(GLIGAR_FEMALE, gMonPalette_Gligar),
    SPECIES_PAL(STEELIX_FEMALE, gMonPalette_Steelix),
    SPECIES_PAL(SCIZOR_FEMALE, gMonPalette_Scizor),
    SPECIES_PAL(HERACROSS_FEMALE, gMonPalette_Heracross),
    SPECIES_PAL(SNEASEL_FEMALE, gMonPalette_Sneasel),
    SPECIES_PAL(URSARING_FEMALE, gMonPalette_Ursaring),
    SPECIES_PAL(PILOSWINE_FEMALE, gMonPalette_Piloswine),
    SPECIES_PAL(OCTILLERY_FEMALE, gMonPalette_Octillery),
    SPECIES_PAL(HOUNDOOM_FEMALE, gMonPalette_Houndoom),
    SPECIES_PAL(DONPHAN_FEMALE, gMonPalette_Donphan),
    SPECIES_PAL(TORCHIC_FEMALE, gMonPalette_Torchic),
    SPECIES_PAL(COMBUSKEN_FEMALE, gMonPalette_Combusken),
    SPECIES_PAL(BLAZIKEN_FEMALE, gMonPalette_Blaziken),
    SPECIES_PAL(BEAUTIFLY_FEMALE, gMonPalette_Beautifly),
    SPECIES_PAL(DUSTOX_FEMALE, gMonPalette_Dustox),
    SPECIES_PAL(LUDICOLO_FEMALE, gMonPalette_Ludicolo),
    SPECIES_PAL(NUZLEAF_FEMALE, gMonPalette_Nuzleaf),
    SPECIES_PAL(SHIFTRY_FEMALE, gMonPalette_Shiftry),
    SPECIES_PAL(MEDITITE_FEMALE, gMonPalette_Meditite),
    SPECIES_PAL(MEDICHAM_FEMALE, gMonPalette_Medicham),
    SPECIES_PAL(ROSELIA_FEMALE, gMonPalette_Roselia),
    SPECIES_PAL(GULPIN_FEMALE, gMonPalette_Gulpin),
    SPECIES_PAL(SWALOT_FEMALE, gMonPalette_Swalot),
    SPECIES_PAL(NUMEL_FEMALE, gMonPalette_Numel),
    SPECIES_PAL(CAMERUPT_FEMALE, gMonPalette_Camerupt),
    SPECIES_PAL(CACTURNE_FEMALE, gMonPalette_Cacturne),
    SPECIES_PAL(MILOTIC_FEMALE, gMonPalette_Milotic),
    SPECIES_PAL(RELICANTH_FEMALE, gMonPalette_Relicanth),
    SPECIES_PAL(STARLY_FEMALE, gMonPalette_Starly),
    SPECIES_PAL(STARAVIA_FEMALE, gMonPalette_Staravia),
    SPECIES_PAL(STARAPTOR_FEMALE, gMonPalette_Staraptor),
    SPECIES_PAL(BIDOOF_FEMALE, gMonPalette_Bidoof),
    SPECIES_PAL(BIBAREL_FEMALE, gMonPalette_Bibarel),
    SPECIES_PAL(KRICKETOT_FEMALE, gMonPalette_Kricketot),
    SPECIES_PAL(KRICKETUNE_FEMALE, gMonPalette_Kricketune),
    SPECIES_PAL(SHINX_FEMALE, gMonPalette_Shinx),
    SPECIES_PAL(LUXIO_FEMALE, gMonPalette_Luxio),
    SPECIES_PAL(LUXRAY_FEMALE, gMonPalette_Luxray),
    SPECIES_PAL(ROSERADE_FEMALE, gMonPalette_Roserade),
    SPECIES_PAL(PACHIRISU_FEMALE, gMonPalette_Pachirisu),
    SPECIES_PAL(BUIZEL_FEMALE, gMonPalette_Buizel),
    SPECIES_PAL(FLOATZEL_FEMALE, gMonPalette_Floatzel),
    SPECIES_PAL(AMBIPOM_FEMALE, gMonPalette_Ambipom),
    SPECIES_PAL(GIBLE_FEMALE, gMonPalette_Gible),
    SPECIES_PAL(GABITE_FEMALE, gMonPalette_Gabite),
    SPECIES_PAL(GARCHOMP_FEMALE, gMonPalette_Garchomp),
    SPECIES_PAL(CROAGUNK_FEMALE, gMonPalette_Croagunk),
    SPECIES_PAL(TOXICROAK_FEMALE, gMonPalette_Toxicroak),
    SPECIES_PAL(FINNEON_FEMALE, gMonPalette_Finneon),
    SPECIES_PAL(LUMINEON_FEMALE, gMonPalette_Lumineon),
    SPECIES_PAL(SNOVER_FEMALE, gMonPalette_Snover),
    SPECIES_PAL(ABOMASNOW_FEMALE, gMonPalette_Abomasnow),
    SPECIES_PAL(WEAVILE_FEMALE, gMonPalette_Weavile),
    SPECIES_PAL(RHYPERIOR_FEMALE, gMonPalette_Rhyperior),
    SPECIES_PAL(TANGROWTH_FEMALE, gMonPalette_Tangrowth),
    SPECIES_PAL(MAMOSWINE_FEMALE, gMonPalette_Mamoswine),
    SPECIES_PAL(SNEASEL_HISUIAN_FEMALE, gMonPalette_SneaselHisuian),
    SPECIES_PAL(PIKACHU_PARTNER_FEMALE, gMonPalette_PikachuPartner),
    SPECIES_PAL(EEVEE_PARTNER_FEMALE, gMonPalette_EeveePartner),
    ...
    SPECIES_PAL(GENESECT_SHOCK, gMonPalette_GenesectShock),
    SPECIES_PAL(GENESECT_BURN, gMonPalette_GenesectBurn),
    SPECIES_PAL(GENESECT_CHILL, gMonPalette_GenesectChill),
    SPECIES_PAL(GENESECT_DOUSE, gMonPalette_GenesectDouse),
};
