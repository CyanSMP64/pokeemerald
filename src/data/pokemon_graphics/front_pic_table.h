const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MANAPHY_EGG, gMonStillFrontPic_ManaphyEgg),
    SPECIES_SPRITE(CHALKBOARD_1, gMonStillFrontPic_Chalkboard1),
    SPECIES_SPRITE(CHALKBOARD_2, gMonStillFrontPic_Chalkboard2),
    SPECIES_SPRITE(CHALKBOARD_3, gMonStillFrontPic_Chalkboard3),
    ...
    SPECIES_SPRITE(HIPPOPOTAS_FEMALE, gMonFrontPic_HippopotasF),
    SPECIES_SPRITE(HIPPOWDON_FEMALE, gMonFrontPic_HippowdonF),
    ...
    SPECIES_SPRITE(ALCREMIE, gMonFrontPic_AlcremieStrawberry),
    ...
    SPECIES_SPRITE(PIKACHU_CAP_2, gMonFrontPic_PikachuC_M2),
    SPECIES_SPRITE(PIKACHU_CAP_3, gMonFrontPic_PikachuC_M3),
    SPECIES_SPRITE(PIKACHU_CAP_4, gMonFrontPic_PikachuC_M4),
    SPECIES_SPRITE(PIKACHU_CAP_5, gMonFrontPic_PikachuC_M5),
    SPECIES_SPRITE(PIKACHU_CAP_6, gMonFrontPic_PikachuC_M6),
    SPECIES_SPRITE(PIKACHU_CAP_7, gMonFrontPic_PikachuC_M7),
    SPECIES_SPRITE(PIKACHU_CAP_8, gMonFrontPic_PikachuC_M8),
    SPECIES_SPRITE(PIKACHU_COSPLAY_1, gMonFrontPic_PikachuC_F1),
    SPECIES_SPRITE(PIKACHU_COSPLAY_2, gMonFrontPic_PikachuC_F2),
    SPECIES_SPRITE(PIKACHU_COSPLAY_3, gMonFrontPic_PikachuC_F3),
    SPECIES_SPRITE(PIKACHU_COSPLAY_4, gMonFrontPic_PikachuC_F4),
    SPECIES_SPRITE(PIKACHU_COSPLAY_5, gMonFrontPic_PikachuC_F5),
    SPECIES_SPRITE(PIKACHU_COSPLAY_6, gMonFrontPic_PikachuC_F6),
    SPECIES_SPRITE(KELDEO_RESOLUTE, gMonFrontPic_KeldeoResolute),
    SPECIES_SPRITE(FURFROU_TRIM_1, gMonFrontPic_FurfrouC_1),
    SPECIES_SPRITE(FURFROU_TRIM_2, gMonFrontPic_FurfrouC_2),
    SPECIES_SPRITE(FURFROU_TRIM_3, gMonFrontPic_FurfrouC_3),
    SPECIES_SPRITE(FURFROU_TRIM_4, gMonFrontPic_FurfrouC_4),
    SPECIES_SPRITE(FURFROU_TRIM_5, gMonFrontPic_FurfrouC_5),
    SPECIES_SPRITE(FURFROU_TRIM_6, gMonFrontPic_FurfrouC_6),
    SPECIES_SPRITE(FURFROU_TRIM_7, gMonFrontPic_FurfrouC_7),
    SPECIES_SPRITE(FURFROU_TRIM_8, gMonFrontPic_FurfrouC_8),
    SPECIES_SPRITE(FURFROU_TRIM_9, gMonFrontPic_FurfrouC_9),
    SPECIES_SPRITE(MAGEARNA_ORIGINAL_COLOR, gMonFrontPic_MagearnaOriginal),
    ...
    SPECIES_SPRITE(MEOWSTIC_FEMALE_MEGA, gMonFrontPic_MeowsticMega),
    SPECIES_SPRITE(MAGEARNA_MEGA_ORIGINAL_COLOR, gMonFrontPic_MagearnaMegaOriginal),
    SPECIES_SPRITE(TATSUGIRI_MEGA_DROOPY, gMonFrontPic_TatsugiriMegaDroopy),
    SPECIES_SPRITE(TATSUGIRI_MEGA_STRETCHY, gMonFrontPic_TatsugiriMegaStretchy),
    ...
    SPECIES_SPRITE(UNFEZANT_FEMALE, gMonFrontPic_UnfezantF),
    SPECIES_SPRITE(FRILLISH_FEMALE, gMonFrontPic_FrillishF),
    SPECIES_SPRITE(JELLICENT_FEMALE, gMonFrontPic_JellicentF),
    ...
    SPECIES_SPRITE(VENUSAUR_FEMALE, gMonFrontPic_VenusaurF),
    SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonFrontPic_ButterfreeF),
    SPECIES_SPRITE(RATTATA_FEMALE, gMonFrontPic_RattataF),
    SPECIES_SPRITE(RATICATE_FEMALE, gMonFrontPic_RaticateF),
    SPECIES_SPRITE(PIKACHU_FEMALE, gMonFrontPic_PikachuF),
    SPECIES_SPRITE(RAICHU_FEMALE, gMonFrontPic_RaichuF),
    SPECIES_SPRITE(ZUBAT_FEMALE, gMonFrontPic_ZubatF),
    SPECIES_SPRITE(GOLBAT_FEMALE, gMonFrontPic_GolbatF),
    SPECIES_SPRITE(GLOOM_FEMALE, gMonFrontPic_GloomF),
    SPECIES_SPRITE(VILEPLUME_FEMALE, gMonFrontPic_VileplumeF),
    SPECIES_SPRITE(KADABRA_FEMALE, gMonFrontPic_KadabraF),
    SPECIES_SPRITE(ALAKAZAM_FEMALE, gMonFrontPic_AlakazamF),
    SPECIES_SPRITE(DODUO_FEMALE, gMonFrontPic_DoduoF),
    SPECIES_SPRITE(DODRIO_FEMALE, gMonFrontPic_DodrioF),
    SPECIES_SPRITE(HYPNO_FEMALE, gMonFrontPic_HypnoF),
    SPECIES_SPRITE(RHYHORN_FEMALE, gMonFrontPic_RhyhornF),
    SPECIES_SPRITE(RHYDON_FEMALE, gMonFrontPic_RhydonF),
    SPECIES_SPRITE(GOLDEEN_FEMALE, gMonFrontPic_GoldeenF),
    SPECIES_SPRITE(SEAKING_FEMALE, gMonFrontPic_SeakingF),
    SPECIES_SPRITE(SCYTHER_FEMALE, gMonFrontPic_ScytherF),
    SPECIES_SPRITE(MAGIKARP_FEMALE, gMonFrontPic_MagikarpF),
    SPECIES_SPRITE(GYARADOS_FEMALE, gMonFrontPic_GyaradosF),
    SPECIES_SPRITE(EEVEE_FEMALE, gMonFrontPic_EeveeF),
    SPECIES_SPRITE(MEGANIUM_FEMALE, gMonFrontPic_MeganiumF),
    SPECIES_SPRITE(LEDYBA_FEMALE, gMonFrontPic_LedybaF),
    SPECIES_SPRITE(LEDIAN_FEMALE, gMonFrontPic_LedianF),
    SPECIES_SPRITE(XATU_FEMALE, gMonFrontPic_XatuF),
    SPECIES_SPRITE(SUDOWOODO_FEMALE, gMonFrontPic_SudowoodoF),
    SPECIES_SPRITE(POLITOED_FEMALE, gMonFrontPic_PolitoedF),
    SPECIES_SPRITE(AIPOM_FEMALE, gMonFrontPic_AipomF),
    SPECIES_SPRITE(WOOPER_FEMALE, gMonFrontPic_WooperF),
    SPECIES_SPRITE(QUAGSIRE_FEMALE, gMonFrontPic_QuagsireF),
    SPECIES_SPRITE(MURKROW_FEMALE, gMonFrontPic_MurkrowF),
    SPECIES_SPRITE(WOBBUFFET_FEMALE, gMonFrontPic_WobbuffetF),
    SPECIES_SPRITE(GIRAFARIG_FEMALE, gMonFrontPic_GirafarigF),
    SPECIES_SPRITE(GLIGAR_FEMALE, gMonFrontPic_GligarF),
    SPECIES_SPRITE(STEELIX_FEMALE, gMonFrontPic_SteelixF),
    SPECIES_SPRITE(SCIZOR_FEMALE, gMonFrontPic_ScizorF),
    SPECIES_SPRITE(HERACROSS_FEMALE, gMonFrontPic_HeracrossF),
    SPECIES_SPRITE(SNEASEL_FEMALE, gMonFrontPic_SneaselF),
    SPECIES_SPRITE(URSARING_FEMALE, gMonFrontPic_UrsaringF),
    SPECIES_SPRITE(PILOSWINE_FEMALE, gMonFrontPic_PiloswineF),
    SPECIES_SPRITE(OCTILLERY_FEMALE, gMonFrontPic_OctilleryF),
    SPECIES_SPRITE(HOUNDOOM_FEMALE, gMonFrontPic_HoundoomF),
    SPECIES_SPRITE(DONPHAN_FEMALE, gMonFrontPic_DonphanF),
    SPECIES_SPRITE(TORCHIC_FEMALE, gMonFrontPic_Torchic),
    SPECIES_SPRITE(COMBUSKEN_FEMALE, gMonFrontPic_CombuskenF),
    SPECIES_SPRITE(BLAZIKEN_FEMALE, gMonFrontPic_BlazikenF),
    SPECIES_SPRITE(BEAUTIFLY_FEMALE, gMonFrontPic_BeautiflyF),
    SPECIES_SPRITE(DUSTOX_FEMALE, gMonFrontPic_DustoxF),
    SPECIES_SPRITE(LUDICOLO_FEMALE, gMonFrontPic_LudicoloF),
    SPECIES_SPRITE(NUZLEAF_FEMALE, gMonFrontPic_NuzleafF),
    SPECIES_SPRITE(SHIFTRY_FEMALE, gMonFrontPic_ShiftryF),
    SPECIES_SPRITE(MEDITITE_FEMALE, gMonFrontPic_MedititeF),
    SPECIES_SPRITE(MEDICHAM_FEMALE, gMonFrontPic_MedichamF),
    SPECIES_SPRITE(ROSELIA_FEMALE, gMonFrontPic_RoseliaF),
    SPECIES_SPRITE(GULPIN_FEMALE, gMonFrontPic_GulpinF),
    SPECIES_SPRITE(SWALOT_FEMALE, gMonFrontPic_SwalotF),
    SPECIES_SPRITE(NUMEL_FEMALE, gMonFrontPic_NumelF),
    SPECIES_SPRITE(CAMERUPT_FEMALE, gMonFrontPic_CameruptF),
    SPECIES_SPRITE(CACTURNE_FEMALE, gMonFrontPic_CacturneF),
    SPECIES_SPRITE(MILOTIC_FEMALE, gMonFrontPic_MiloticF),
    SPECIES_SPRITE(RELICANTH_FEMALE, gMonFrontPic_RelicanthF),
    SPECIES_SPRITE(STARLY_FEMALE, gMonFrontPic_StarlyF),
    SPECIES_SPRITE(STARAVIA_FEMALE, gMonFrontPic_StaraviaF),
    SPECIES_SPRITE(STARAPTOR_FEMALE, gMonFrontPic_StaraptorF),
    SPECIES_SPRITE(BIDOOF_FEMALE, gMonFrontPic_BidoofF),
    SPECIES_SPRITE(BIBAREL_FEMALE, gMonFrontPic_BibarelF),
    SPECIES_SPRITE(KRICKETOT_FEMALE, gMonFrontPic_KricketotF),
    SPECIES_SPRITE(KRICKETUNE_FEMALE, gMonFrontPic_KricketuneF),
    SPECIES_SPRITE(SHINX_FEMALE, gMonFrontPic_ShinxF),
    SPECIES_SPRITE(LUXIO_FEMALE, gMonFrontPic_LuxioF),
    SPECIES_SPRITE(LUXRAY_FEMALE, gMonFrontPic_LuxrayF),
    SPECIES_SPRITE(ROSERADE_FEMALE, gMonFrontPic_RoseradeF),
    SPECIES_SPRITE(COMBEE_FEMALE, gMonFrontPic_CombeeF),
    SPECIES_SPRITE(PACHIRISU_FEMALE, gMonFrontPic_PachirisuF),
    SPECIES_SPRITE(BUIZEL_FEMALE, gMonFrontPic_Buizel),
    SPECIES_SPRITE(FLOATZEL_FEMALE, gMonFrontPic_Floatzel),
    SPECIES_SPRITE(AMBIPOM_FEMALE, gMonFrontPic_AmbipomF),
    SPECIES_SPRITE(GIBLE_FEMALE, gMonFrontPic_GibleF),
    SPECIES_SPRITE(GABITE_FEMALE, gMonFrontPic_GabiteF),
    SPECIES_SPRITE(GARCHOMP_FEMALE, gMonFrontPic_GarchompF),
    SPECIES_SPRITE(CROAGUNK_FEMALE, gMonFrontPic_CroagunkF),
    SPECIES_SPRITE(TOXICROAK_FEMALE, gMonFrontPic_ToxicroakF),
    SPECIES_SPRITE(FINNEON_FEMALE, gMonFrontPic_FinneonF),
    SPECIES_SPRITE(LUMINEON_FEMALE, gMonFrontPic_LumineonF),
    SPECIES_SPRITE(SNOVER_FEMALE, gMonFrontPic_SnoverF),
    SPECIES_SPRITE(ABOMASNOW_FEMALE, gMonFrontPic_AbomasnowF),
    SPECIES_SPRITE(WEAVILE_FEMALE, gMonFrontPic_WeavileF),
    SPECIES_SPRITE(RHYPERIOR_FEMALE, gMonFrontPic_RhyperiorF),
    SPECIES_SPRITE(TANGROWTH_FEMALE, gMonFrontPic_TangrowthF),
    SPECIES_SPRITE(MAMOSWINE_FEMALE, gMonFrontPic_MamoswineF),
    SPECIES_SPRITE(SNEASEL_HISUIAN_FEMALE, gMonFrontPic_SneaselHisuianF),
    SPECIES_SPRITE(PIKACHU_PARTNER_FEMALE, gMonFrontPic_PikachuPartnerF),
    SPECIES_SPRITE(EEVEE_PARTNER_FEMALE, gMonFrontPic_EeveePartnerF),
    ...
    SPECIES_SPRITE(GENESECT_SHOCK, gMonFrontPic_Genesect),
    SPECIES_SPRITE(GENESECT_BURN, gMonFrontPic_Genesect),
    SPECIES_SPRITE(GENESECT_CHILL, gMonFrontPic_Genesect),
    SPECIES_SPRITE(GENESECT_DOUSE, gMonFrontPic_Genesect),
};
