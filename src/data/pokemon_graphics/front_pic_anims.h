...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_WISHIWASHI_SCHOOL] = sAnims_Wishiwashi,
    ...
    [SPECIES_HIPPOPOTAS_FEMALE] = sAnims_Hippopotas,
    [SPECIES_HIPPOWDON_FEMALE] = sAnims_Hippowdon,
    [SPECIES_UNFEZANT_FEMALE] = sAnims_Unfezant,
    [SPECIES_FRILLISH_FEMALE] = sAnims_Frillish,
    [SPECIES_JELLICENT_FEMALE] = sAnims_Jellicent,
    [SPECIES_PYROAR_FEMALE] = sAnims_Pyroar,
