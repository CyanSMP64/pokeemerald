const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(CHALKBOARD_1, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CHALKBOARD_2, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(CHALKBOARD_3, gMonBackPic_DoubleQuestionMark),
    ...
    SPECIES_SPRITE(HIPPOPOTAS_FEMALE, gMonBackPic_HippopotasF),
    SPECIES_SPRITE(HIPPOWDON, gMonBackPic_Hippowdon),
    SPECIES_SPRITE(HIPPOWDON_FEMALE, gMonBackPic_HippowdonF),
    ...
    SPECIES_SPRITE(UNFEZANT_FEMALE, gMonBackPic_UnfezantF),
    ...
    SPECIES_SPRITE(FRILLISH_FEMALE, gMonBackPic_FrillishF),
    SPECIES_SPRITE(JELLICENT, gMonBackPic_Jellicent),
    SPECIES_SPRITE(JELLICENT_FEMALE, gMonBackPic_JellicentF),
    ...
    SPECIES_SPRITE(ALCREMIE, gMonBackPic_AlcremieStrawberry),
    ...
    SPECIES_SPRITE(TATSUGIRI_MEGA_DROOPY, gMonBackPic_TatsugiriMegaDroopy),
    SPECIES_SPRITE(TATSUGIRI_MEGA_STRETCHY, gMonBackPic_TatsugiriMegaStretchy),
    ...
    SPECIES_SPRITE(PIKACHU_CAP_2, gMonBackPic_PikachuC_M2),
    SPECIES_SPRITE(PIKACHU_CAP_3, gMonBackPic_PikachuC_M3),
    SPECIES_SPRITE(PIKACHU_CAP_4, gMonBackPic_PikachuC_M4),
    SPECIES_SPRITE(PIKACHU_CAP_5, gMonBackPic_PikachuC_M5),
    SPECIES_SPRITE(PIKACHU_CAP_6, gMonBackPic_PikachuC_M6),
    SPECIES_SPRITE(PIKACHU_CAP_7, gMonBackPic_PikachuC_M7),
    SPECIES_SPRITE(PIKACHU_CAP_8, gMonBackPic_PikachuC_M8),
    SPECIES_SPRITE(PIKACHU_COSPLAY_1, gMonBackPic_PikachuC_F1),
    SPECIES_SPRITE(PIKACHU_COSPLAY_2, gMonBackPic_PikachuC_F2),
    SPECIES_SPRITE(PIKACHU_COSPLAY_3, gMonBackPic_PikachuC_F3),
    SPECIES_SPRITE(PIKACHU_COSPLAY_4, gMonBackPic_PikachuC_F4),
    SPECIES_SPRITE(PIKACHU_COSPLAY_5, gMonBackPic_PikachuC_F5),
    SPECIES_SPRITE(PIKACHU_COSPLAY_6, gMonBackPic_PikachuC_F6),
    SPECIES_SPRITE(KELDEO_RESOLUTE, gMonBackPic_KeldeoResolute),
    SPECIES_SPRITE(FURFROU_TRIM_1, gMonBackPic_FurfrouC_1),
    SPECIES_SPRITE(FURFROU_TRIM_2, gMonBackPic_FurfrouC_2),
    SPECIES_SPRITE(FURFROU_TRIM_3, gMonBackPic_FurfrouC_3),
    SPECIES_SPRITE(FURFROU_TRIM_4, gMonBackPic_FurfrouC_4),
    SPECIES_SPRITE(FURFROU_TRIM_5, gMonBackPic_FurfrouC_5),
    SPECIES_SPRITE(FURFROU_TRIM_6, gMonBackPic_FurfrouC_6),
    SPECIES_SPRITE(FURFROU_TRIM_7, gMonBackPic_FurfrouC_7),
    SPECIES_SPRITE(FURFROU_TRIM_8, gMonBackPic_FurfrouC_8),
    SPECIES_SPRITE(FURFROU_TRIM_9, gMonBackPic_FurfrouC_9),
    SPECIES_SPRITE(MAGEARNA_ORIGINAL_COLOR, gMonBackPic_MagearnaOriginal),
    ...
    SPECIES_SPRITE(VENUSAUR_FEMALE, gMonBackPic_VenusaurF),
    SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonBackPic_ButterfreeF),
    SPECIES_SPRITE(RATTATA_FEMALE, gMonBackPic_RattataF),
    SPECIES_SPRITE(RATICATE_FEMALE, gMonBackPic_RaticateF),
    SPECIES_SPRITE(PIKACHU_FEMALE, gMonBackPic_PikachuF),
    SPECIES_SPRITE(RAICHU_FEMALE, gMonBackPic_Raichu),
    SPECIES_SPRITE(ZUBAT_FEMALE, gMonBackPic_ZubatF),
    SPECIES_SPRITE(GOLBAT_FEMALE, gMonBackPic_GolbatF),
    SPECIES_SPRITE(GLOOM_FEMALE, gMonBackPic_GloomF),
    SPECIES_SPRITE(VILEPLUME_FEMALE, gMonBackPic_VileplumeF),
    SPECIES_SPRITE(KADABRA_FEMALE, gMonBackPic_KadabraF),
    SPECIES_SPRITE(ALAKAZAM_FEMALE, gMonBackPic_AlakazamF),
    SPECIES_SPRITE(DODUO_FEMALE, gMonBackPic_DoduoF),
    SPECIES_SPRITE(DODRIO_FEMALE, gMonBackPic_DodrioF),
    SPECIES_SPRITE(HYPNO_FEMALE, gMonBackPic_HypnoF),
    SPECIES_SPRITE(RHYHORN_FEMALE, gMonBackPic_RhyhornF),
    SPECIES_SPRITE(RHYDON_FEMALE, gMonBackPic_RhydonF),
    SPECIES_SPRITE(GOLDEEN_FEMALE, gMonBackPic_GoldeenF),
    SPECIES_SPRITE(SEAKING_FEMALE, gMonBackPic_SeakingF),
    SPECIES_SPRITE(SCYTHER_FEMALE, gMonBackPic_Scyther),
    SPECIES_SPRITE(MAGIKARP_FEMALE, gMonBackPic_MagikarpF),
    SPECIES_SPRITE(GYARADOS_FEMALE, gMonBackPic_GyaradosF),
    SPECIES_SPRITE(EEVEE_FEMALE, gMonBackPic_EeveeF),
    SPECIES_SPRITE(MEGANIUM_FEMALE, gMonBackPic_MeganiumF),
    SPECIES_SPRITE(LEDYBA_FEMALE, gMonBackPic_LedybaF),
    SPECIES_SPRITE(LEDIAN_FEMALE, gMonBackPic_LedianF),
    SPECIES_SPRITE(XATU_FEMALE, gMonBackPic_Xatu),
    SPECIES_SPRITE(SUDOWOODO_FEMALE, gMonBackPic_SudowoodoF),
    SPECIES_SPRITE(POLITOED_FEMALE, gMonBackPic_PolitoedF),
    SPECIES_SPRITE(AIPOM_FEMALE, gMonBackPic_AipomF),
    SPECIES_SPRITE(WOOPER_FEMALE, gMonBackPic_WooperF),
    SPECIES_SPRITE(QUAGSIRE_FEMALE, gMonBackPic_QuagsireF),
    SPECIES_SPRITE(MURKROW_FEMALE, gMonBackPic_MurkrowF),
    SPECIES_SPRITE(WOBBUFFET_FEMALE, gMonBackPic_WobbuffetF),
    SPECIES_SPRITE(GIRAFARIG_FEMALE, gMonBackPic_GirafarigF),
    SPECIES_SPRITE(GLIGAR_FEMALE, gMonBackPic_GligarF),
    SPECIES_SPRITE(STEELIX_FEMALE, gMonBackPic_SteelixF),
    SPECIES_SPRITE(SCIZOR_FEMALE, gMonBackPic_Scizor),
    SPECIES_SPRITE(HERACROSS_FEMALE, gMonBackPic_HeracrossF),
    SPECIES_SPRITE(SNEASEL_FEMALE, gMonBackPic_SneaselF),
    SPECIES_SPRITE(URSARING_FEMALE, gMonBackPic_UrsaringF),
    SPECIES_SPRITE(PILOSWINE_FEMALE, gMonBackPic_PiloswineF),
    SPECIES_SPRITE(OCTILLERY_FEMALE, gMonBackPic_OctilleryF),
    SPECIES_SPRITE(HOUNDOOM_FEMALE, gMonBackPic_HoundoomF),
    SPECIES_SPRITE(DONPHAN_FEMALE, gMonBackPic_DonphanF),
    SPECIES_SPRITE(TORCHIC_FEMALE, gMonBackPic_TorchicF),
    SPECIES_SPRITE(COMBUSKEN_FEMALE, gMonBackPic_CombuskenF),
    SPECIES_SPRITE(BLAZIKEN_FEMALE, gMonBackPic_BlazikenF),
    SPECIES_SPRITE(BEAUTIFLY_FEMALE, gMonBackPic_BeautiflyF),
    SPECIES_SPRITE(DUSTOX_FEMALE, gMonBackPic_DustoxF),
    SPECIES_SPRITE(LUDICOLO_FEMALE, gMonBackPic_LudicoloF),
    SPECIES_SPRITE(NUZLEAF_FEMALE, gMonBackPic_NuzleafF),
    SPECIES_SPRITE(SHIFTRY_FEMALE, gMonBackPic_ShiftryF),
    SPECIES_SPRITE(MEDITITE_FEMALE, gMonBackPic_MedititeF),
    SPECIES_SPRITE(MEDICHAM_FEMALE, gMonBackPic_MedichamF),
    SPECIES_SPRITE(ROSELIA_FEMALE, gMonBackPic_RoseliaF),
    SPECIES_SPRITE(GULPIN_FEMALE, gMonBackPic_GulpinF),
    SPECIES_SPRITE(SWALOT_FEMALE, gMonBackPic_SwalotF),
    SPECIES_SPRITE(NUMEL_FEMALE, gMonBackPic_NumelF),
    SPECIES_SPRITE(CAMERUPT_FEMALE, gMonBackPic_CameruptF),
    SPECIES_SPRITE(CACTURNE_FEMALE, gMonBackPic_Cacturne),
    SPECIES_SPRITE(MILOTIC_FEMALE, gMonBackPic_MiloticF),
    SPECIES_SPRITE(RELICANTH_FEMALE, gMonBackPic_RelicanthF),
    SPECIES_SPRITE(STARLY_FEMALE, gMonBackPic_StarlyF),
    SPECIES_SPRITE(STARAVIA_FEMALE, gMonBackPic_StaraviaF),
    SPECIES_SPRITE(STARAPTOR_FEMALE, gMonBackPic_Staraptor),
    SPECIES_SPRITE(BIDOOF_FEMALE, gMonBackPic_BidoofF),
    SPECIES_SPRITE(BIBAREL_FEMALE, gMonBackPic_Bibarel),
    SPECIES_SPRITE(KRICKETOT_FEMALE, gMonBackPic_KricketotF),
    SPECIES_SPRITE(KRICKETUNE_FEMALE, gMonBackPic_KricketuneF),
    SPECIES_SPRITE(SHINX_FEMALE, gMonBackPic_ShinxF),
    SPECIES_SPRITE(LUXIO_FEMALE, gMonBackPic_LuxioF),
    SPECIES_SPRITE(LUXRAY_FEMALE, gMonBackPic_LuxrayF),
    SPECIES_SPRITE(ROSERADE_FEMALE, gMonBackPic_RoseradeF),
    SPECIES_SPRITE(COMBEE_FEMALE, gMonBackPic_Combee),
    SPECIES_SPRITE(PACHIRISU_FEMALE, gMonBackPic_Pachirisu),
    SPECIES_SPRITE(BUIZEL_FEMALE, gMonBackPic_BuizelF),
    SPECIES_SPRITE(FLOATZEL_FEMALE, gMonBackPic_FloatzelF),
    SPECIES_SPRITE(AMBIPOM_FEMALE, gMonBackPic_AmbipomF),
    SPECIES_SPRITE(GIBLE_FEMALE, gMonBackPic_GibleF),
    SPECIES_SPRITE(GABITE_FEMALE, gMonBackPic_GabiteF),
    SPECIES_SPRITE(GARCHOMP_FEMALE, gMonBackPic_Garchomp),
    SPECIES_SPRITE(CROAGUNK_FEMALE, gMonBackPic_CroagunkF),
    SPECIES_SPRITE(TOXICROAK_FEMALE, gMonBackPic_ToxicroakF),
    SPECIES_SPRITE(FINNEON_FEMALE, gMonBackPic_FinneonF),
    SPECIES_SPRITE(LUMINEON_FEMALE, gMonBackPic_LumineonF),
    SPECIES_SPRITE(SNOVER_FEMALE, gMonBackPic_SnoverF),
    SPECIES_SPRITE(ABOMASNOW_FEMALE, gMonBackPic_Abomasnow),
    SPECIES_SPRITE(WEAVILE_FEMALE, gMonBackPic_WeavileF),
    SPECIES_SPRITE(RHYPERIOR_FEMALE, gMonBackPic_RhyperiorF),
    SPECIES_SPRITE(TANGROWTH_FEMALE, gMonBackPic_Tangrowth),
    SPECIES_SPRITE(MAMOSWINE_FEMALE, gMonBackPic_Mamoswine),
    SPECIES_SPRITE(SNEASEL_HISUIAN_FEMALE, gMonBackPic_SneaselHisuianF),
    SPECIES_SPRITE(PIKACHU_PARTNER_FEMALE, gMonBackPic_PikachuPartnerF),
    SPECIES_SPRITE(EEVEE_PARTNER_FEMALE, gMonBackPic_EeveePartnerF),
    ...
    SPECIES_SPRITE(GENESECT_SHOCK, gMonBackPic_Genesect),
    SPECIES_SPRITE(GENESECT_BURN, gMonBackPic_Genesect),
    SPECIES_SPRITE(GENESECT_CHILL, gMonBackPic_Genesect),
    SPECIES_SPRITE(GENESECT_DOUSE, gMonBackPic_Genesect),
};
