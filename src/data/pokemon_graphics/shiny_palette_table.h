const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(RABSCA, gMonPalette_Rabsca), // placeholder
    ...
    SPECIES_SHINY_PAL(TINKATUFF, gMonPalette_Tinkatuff), // placeholder
    ...
    SPECIES_SHINY_PAL(HIPPOPOTAS_FEMALE, gMonShinyPalette_HippopotasF),
    SPECIES_SHINY_PAL(HIPPOWDON_FEMALE, gMonShinyPalette_HippowdonF),
