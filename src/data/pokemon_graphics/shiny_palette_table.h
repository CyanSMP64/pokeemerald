const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MANAPHY_EGG, gMonPalette_ManaphyEgg),
    SPECIES_SHINY_PAL(CHALKBOARD_1, gMonShinyPalette_Chalkboard),
    SPECIES_SHINY_PAL(CHALKBOARD_2, gMonShinyPalette_Chalkboard),
    SPECIES_SHINY_PAL(CHALKBOARD_3, gMonShinyPalette_Chalkboard),
    ...
    SPECIES_SHINY_PAL(ALCREMIE, gMonShinyPalette_AlcremieStrawberry),
    ...
    SPECIES_SHINY_PAL(PIKACHU_CAP, gMonShinyPalette_PikachuC_M1),
    ...
    SPECIES_SHINY_PAL(PICHU_SPIKY_EARED, gMonShinyPalette_PichuSpiky),
    ...
    SPECIES_SHINY_PAL(PIKACHU_CAP_2, gMonShinyPalette_PikachuC_M2),
    SPECIES_SHINY_PAL(PIKACHU_CAP_3, gMonShinyPalette_PikachuC_M3),
    SPECIES_SHINY_PAL(PIKACHU_CAP_4, gMonShinyPalette_PikachuC_M4),
    SPECIES_SHINY_PAL(PIKACHU_CAP_5, gMonShinyPalette_PikachuC_M5),
    SPECIES_SHINY_PAL(PIKACHU_CAP_6, gMonShinyPalette_PikachuC_M6),
    SPECIES_SHINY_PAL(PIKACHU_CAP_7, gMonShinyPalette_PikachuC_M7),
    SPECIES_SHINY_PAL(PIKACHU_CAP_8, gMonShinyPalette_PikachuC_M8),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_1, gMonShinyPalette_PikachuC_F1),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_2, gMonShinyPalette_PikachuC_F2),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_3, gMonShinyPalette_PikachuC_F3),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_4, gMonShinyPalette_PikachuC_F4),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_5, gMonShinyPalette_PikachuC_F5),
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY_6, gMonShinyPalette_PikachuC_F6),
    SPECIES_SHINY_PAL(KELDEO_RESOLUTE, gMonShinyPalette_KeldeoResolute),
    SPECIES_SHINY_PAL(FURFROU_TRIM_1, gMonShinyPalette_FurfrouC_1),
    SPECIES_SHINY_PAL(FURFROU_TRIM_2, gMonShinyPalette_FurfrouC_2),
    SPECIES_SHINY_PAL(FURFROU_TRIM_3, gMonShinyPalette_FurfrouC_3),
    SPECIES_SHINY_PAL(FURFROU_TRIM_4, gMonShinyPalette_FurfrouC_4),
    SPECIES_SHINY_PAL(FURFROU_TRIM_5, gMonShinyPalette_FurfrouC_5),
    SPECIES_SHINY_PAL(FURFROU_TRIM_6, gMonShinyPalette_FurfrouC_6),
    SPECIES_SHINY_PAL(FURFROU_TRIM_7, gMonShinyPalette_FurfrouC_7),
    SPECIES_SHINY_PAL(FURFROU_TRIM_8, gMonShinyPalette_FurfrouC_8),
    SPECIES_SHINY_PAL(FURFROU_TRIM_9, gMonShinyPalette_FurfrouC_9),
    SPECIES_SHINY_PAL(MAGEARNA_ORIGINAL_COLOR, gMonShinyPalette_MagearnaOriginal),
    ...
    SPECIES_SHINY_PAL(PYROAR_MEGA, gMonShinyPalette_PyroarMega),
    SPECIES_SHINY_PAL(FLOETTE_MEGA, gMonShinyPalette_FloetteMega),
    ...
    SPECIES_SHINY_PAL(ZYGARDE_MEGA, gMonShinyPalette_ZygardeMega),
    ...
    SPECIES_SHINY_PAL(ABSOL_MEGA_Z, gMonShinyPalette_AbsolMegaZ),
    SPECIES_SHINY_PAL(STARAPTOR_MEGA, gMonShinyPalette_StaraptorMega),
    SPECIES_SHINY_PAL(GARCHOMP_MEGA_Z, gMonShinyPalette_GarchompMegaZ),
    SPECIES_SHINY_PAL(LUCARIO_MEGA_Z, gMonShinyPalette_LucarioMegaZ),
    SPECIES_SHINY_PAL(HEATRAN_MEGA, gMonShinyPalette_HeatranMega),
    SPECIES_SHINY_PAL(DARKRAI_MEGA, gMonShinyPalette_DarkraiMega),
    ...
    SPECIES_SHINY_PAL(MAGEARNA_MEGA, gMonShinyPalette_MagearnaMega),
    ...
    SPECIES_SHINY_PAL(HIPPOPOTAS_FEMALE, gMonShinyPalette_Hippopotas),
    SPECIES_SHINY_PAL(HIPPOWDON_FEMALE, gMonShinyPalette_Hippowdon),
    SPECIES_SHINY_PAL(UNFEZANT_FEMALE, gMonShinyPalette_UnfezantF),
    SPECIES_SHINY_PAL(FRILLISH_FEMALE, gMonShinyPalette_FrillishF),
    SPECIES_SHINY_PAL(JELLICENT_FEMALE, gMonShinyPalette_JellicentF),
    SPECIES_SHINY_PAL(PYROAR_FEMALE, gMonShinyPalette_Pyroar),
    SPECIES_SHINY_PAL(COMBEE_FEMALE, gMonShinyPalette_Combee),
    ...
    SPECIES_SHINY_PAL(VENUSAUR_FEMALE, gMonShinyPalette_Venusaur),
    SPECIES_SHINY_PAL(BUTTERFREE_FEMALE, gMonShinyPalette_Butterfree),
    SPECIES_SHINY_PAL(RATTATA_FEMALE, gMonShinyPalette_Rattata),
    SPECIES_SHINY_PAL(RATICATE_FEMALE, gMonShinyPalette_Raticate),
    SPECIES_SHINY_PAL(PIKACHU_FEMALE, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(RAICHU_FEMALE, gMonShinyPalette_Raichu),
    SPECIES_SHINY_PAL(ZUBAT_FEMALE, gMonShinyPalette_Zubat),
    SPECIES_SHINY_PAL(GOLBAT_FEMALE, gMonShinyPalette_Golbat),
    SPECIES_SHINY_PAL(GLOOM_FEMALE, gMonShinyPalette_Gloom),
    SPECIES_SHINY_PAL(VILEPLUME_FEMALE, gMonShinyPalette_Vileplume),
    SPECIES_SHINY_PAL(KADABRA_FEMALE, gMonShinyPalette_Kadabra),
    SPECIES_SHINY_PAL(ALAKAZAM_FEMALE, gMonShinyPalette_Alakazam),
    SPECIES_SHINY_PAL(DODUO_FEMALE, gMonShinyPalette_Doduo),
    SPECIES_SHINY_PAL(DODRIO_FEMALE, gMonShinyPalette_Dodrio),
    SPECIES_SHINY_PAL(HYPNO_FEMALE, gMonShinyPalette_Hypno),
    SPECIES_SHINY_PAL(RHYHORN_FEMALE, gMonShinyPalette_Rhyhorn),
    SPECIES_SHINY_PAL(RHYDON_FEMALE, gMonShinyPalette_Rhydon),
    SPECIES_SHINY_PAL(GOLDEEN_FEMALE, gMonShinyPalette_Goldeen),
    SPECIES_SHINY_PAL(SEAKING_FEMALE, gMonShinyPalette_Seaking),
    SPECIES_SHINY_PAL(SCYTHER_FEMALE, gMonShinyPalette_Scyther),
    SPECIES_SHINY_PAL(MAGIKARP_FEMALE, gMonShinyPalette_Magikarp),
    SPECIES_SHINY_PAL(GYARADOS_FEMALE, gMonShinyPalette_Gyarados),
    SPECIES_SHINY_PAL(EEVEE_FEMALE, gMonShinyPalette_Eevee),
    SPECIES_SHINY_PAL(MEGANIUM_FEMALE, gMonShinyPalette_Meganium),
    SPECIES_SHINY_PAL(LEDYBA_FEMALE, gMonShinyPalette_Ledyba),
    SPECIES_SHINY_PAL(LEDIAN_FEMALE, gMonShinyPalette_Ledian),
    SPECIES_SHINY_PAL(XATU_FEMALE, gMonShinyPalette_Xatu),
    SPECIES_SHINY_PAL(SUDOWOODO_FEMALE, gMonShinyPalette_Sudowoodo),
    SPECIES_SHINY_PAL(POLITOED_FEMALE, gMonShinyPalette_Politoed),
    SPECIES_SHINY_PAL(AIPOM_FEMALE, gMonShinyPalette_Aipom),
    SPECIES_SHINY_PAL(WOOPER_FEMALE, gMonShinyPalette_Wooper),
    SPECIES_SHINY_PAL(QUAGSIRE_FEMALE, gMonShinyPalette_Quagsire),
    SPECIES_SHINY_PAL(MURKROW_FEMALE, gMonShinyPalette_Murkrow),
    SPECIES_SHINY_PAL(WOBBUFFET_FEMALE, gMonShinyPalette_Wobbuffet),
    SPECIES_SHINY_PAL(GIRAFARIG_FEMALE, gMonShinyPalette_Girafarig),
    SPECIES_SHINY_PAL(GLIGAR_FEMALE, gMonShinyPalette_Gligar),
    SPECIES_SHINY_PAL(STEELIX_FEMALE, gMonShinyPalette_Steelix),
    SPECIES_SHINY_PAL(SCIZOR_FEMALE, gMonShinyPalette_Scizor),
    SPECIES_SHINY_PAL(HERACROSS_FEMALE, gMonShinyPalette_Heracross),
    SPECIES_SHINY_PAL(SNEASEL_FEMALE, gMonShinyPalette_Sneasel),
    SPECIES_SHINY_PAL(URSARING_FEMALE, gMonShinyPalette_Ursaring),
    SPECIES_SHINY_PAL(PILOSWINE_FEMALE, gMonShinyPalette_Piloswine),
    SPECIES_SHINY_PAL(OCTILLERY_FEMALE, gMonShinyPalette_Octillery),
    SPECIES_SHINY_PAL(HOUNDOOM_FEMALE, gMonShinyPalette_Houndoom),
    SPECIES_SHINY_PAL(DONPHAN_FEMALE, gMonShinyPalette_Donphan),
    SPECIES_SHINY_PAL(TORCHIC_FEMALE, gMonShinyPalette_Torchic),
    SPECIES_SHINY_PAL(COMBUSKEN_FEMALE, gMonShinyPalette_Combusken),
    SPECIES_SHINY_PAL(BLAZIKEN_FEMALE, gMonShinyPalette_Blaziken),
    SPECIES_SHINY_PAL(BEAUTIFLY_FEMALE, gMonShinyPalette_Beautifly),
    SPECIES_SHINY_PAL(DUSTOX_FEMALE, gMonShinyPalette_Dustox),
    SPECIES_SHINY_PAL(LUDICOLO_FEMALE, gMonShinyPalette_Ludicolo),
    SPECIES_SHINY_PAL(NUZLEAF_FEMALE, gMonShinyPalette_Nuzleaf),
    SPECIES_SHINY_PAL(SHIFTRY_FEMALE, gMonShinyPalette_Shiftry),
    SPECIES_SHINY_PAL(MEDITITE_FEMALE, gMonShinyPalette_Meditite),
    SPECIES_SHINY_PAL(MEDICHAM_FEMALE, gMonShinyPalette_Medicham),
    SPECIES_SHINY_PAL(ROSELIA_FEMALE, gMonShinyPalette_Roselia),
    SPECIES_SHINY_PAL(GULPIN_FEMALE, gMonShinyPalette_Gulpin),
    SPECIES_SHINY_PAL(SWALOT_FEMALE, gMonShinyPalette_Swalot),
    SPECIES_SHINY_PAL(NUMEL_FEMALE, gMonShinyPalette_Numel),
    SPECIES_SHINY_PAL(CAMERUPT_FEMALE, gMonShinyPalette_Camerupt),
    SPECIES_SHINY_PAL(CACTURNE_FEMALE, gMonShinyPalette_Cacturne),
    SPECIES_SHINY_PAL(MILOTIC_FEMALE, gMonShinyPalette_Milotic),
    SPECIES_SHINY_PAL(RELICANTH_FEMALE, gMonShinyPalette_Relicanth),
    SPECIES_SHINY_PAL(STARLY_FEMALE, gMonShinyPalette_Starly),
    SPECIES_SHINY_PAL(STARAVIA_FEMALE, gMonShinyPalette_Staravia),
    SPECIES_SHINY_PAL(STARAPTOR_FEMALE, gMonShinyPalette_Staraptor),
    SPECIES_SHINY_PAL(BIDOOF_FEMALE, gMonShinyPalette_Bidoof),
    SPECIES_SHINY_PAL(BIBAREL_FEMALE, gMonShinyPalette_Bibarel),
    SPECIES_SHINY_PAL(KRICKETOT_FEMALE, gMonShinyPalette_Kricketot),
    SPECIES_SHINY_PAL(KRICKETUNE_FEMALE, gMonShinyPalette_Kricketune),
    SPECIES_SHINY_PAL(SHINX_FEMALE, gMonShinyPalette_Shinx),
    SPECIES_SHINY_PAL(LUXIO_FEMALE, gMonShinyPalette_Luxio),
    SPECIES_SHINY_PAL(LUXRAY_FEMALE, gMonShinyPalette_Luxray),
    SPECIES_SHINY_PAL(ROSERADE_FEMALE, gMonShinyPalette_Roserade),
    SPECIES_SHINY_PAL(PACHIRISU_FEMALE, gMonShinyPalette_Pachirisu),
    SPECIES_SHINY_PAL(BUIZEL_FEMALE, gMonShinyPalette_Buizel),
    SPECIES_SHINY_PAL(FLOATZEL_FEMALE, gMonShinyPalette_Floatzel),
    SPECIES_SHINY_PAL(AMBIPOM_FEMALE, gMonShinyPalette_Ambipom),
    SPECIES_SHINY_PAL(GIBLE_FEMALE, gMonShinyPalette_Gible),
    SPECIES_SHINY_PAL(GABITE_FEMALE, gMonShinyPalette_Gabite),
    SPECIES_SHINY_PAL(GARCHOMP_FEMALE, gMonShinyPalette_Garchomp),
    SPECIES_SHINY_PAL(CROAGUNK_FEMALE, gMonShinyPalette_Croagunk),
    SPECIES_SHINY_PAL(TOXICROAK_FEMALE, gMonShinyPalette_Toxicroak),
    SPECIES_SHINY_PAL(FINNEON_FEMALE, gMonShinyPalette_Finneon),
    SPECIES_SHINY_PAL(LUMINEON_FEMALE, gMonShinyPalette_Lumineon),
    SPECIES_SHINY_PAL(SNOVER_FEMALE, gMonShinyPalette_Snover),
    SPECIES_SHINY_PAL(ABOMASNOW_FEMALE, gMonShinyPalette_Abomasnow),
    SPECIES_SHINY_PAL(WEAVILE_FEMALE, gMonShinyPalette_Weavile),
    SPECIES_SHINY_PAL(RHYPERIOR_FEMALE, gMonShinyPalette_Rhyperior),
    SPECIES_SHINY_PAL(TANGROWTH_FEMALE, gMonShinyPalette_Tangrowth),
    SPECIES_SHINY_PAL(MAMOSWINE_FEMALE, gMonShinyPalette_Mamoswine),
    SPECIES_SHINY_PAL(SNEASEL_HISUIAN_FEMALE, gMonShinyPalette_SneaselHisuian),
    SPECIES_SHINY_PAL(PIKACHU_PARTNER_FEMALE, gMonShinyPalette_PikachuPartner),
    SPECIES_SHINY_PAL(EEVEE_PARTNER_FEMALE, gMonShinyPalette_EeveePartner),
    ...
    SPECIES_SHINY_PAL(GENESECT_SHOCK, gMonShinyPalette_GenesectShock),
    SPECIES_SHINY_PAL(GENESECT_BURN, gMonShinyPalette_GenesectBurn),
    SPECIES_SHINY_PAL(GENESECT_CHILL, gMonShinyPalette_GenesectChill),
    SPECIES_SHINY_PAL(GENESECT_DOUSE, gMonShinyPalette_GenesectDouse),
};
