...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_LUDICOLO]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_SHELGON]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    ...
    [SPECIES_SPIDOPS]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_TANDEMAUS]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    ...
    [SPECIES_NACLI]                             = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 11 },
    ...
    [SPECIES_TADBULB]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 13 },
    ...
    [SPECIES_RABSCA]                            = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_FLITTLE]                           = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 15 },
    [SPECIES_ESPATHRA]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_TINKATINK]                         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    ...
    [SPECIES_CETODDLE]                          = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_GIMMIGHOUL]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_ROARING_MOON]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_IRON_LEAVES]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    // Megas
