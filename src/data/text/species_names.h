const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CRABOMINABLE] = _("Crabminble"),
    ...
    [SPECIES_BLACEPHALON] = _("Blacphalon"),
    ...
    [SPECIES_POLTEAGEIST] = _("Poltegeist"),
    ...
    [SPECIES_SQUAWKABILLY] = _("Squawkbily"),
    ...
    [SPECIES_BRAMBLEGHAST] = _("Bramblgast"),
    ...
    [SPECIES_CHARIZARD_MEGA_X] = _("CharizardX"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("CharizardY"),
    [SPECIES_BLASTOISE_MEGA] = _("BlastoiseM"),
    [SPECIES_BEEDRILL_MEGA] = _("BeedrillM"),
    [SPECIES_PIDGEOT_MEGA] = _("PidgeotM"),
    [SPECIES_ALAKAZAM_MEGA] = _("AlakazamM"),
    [SPECIES_SLOWBRO_MEGA] = _("SlowbroM"),
    [SPECIES_GENGAR_MEGA] = _("GengarM"),
    [SPECIES_KANGASKHAN_MEGA] = _("KangaskhaM"),
    [SPECIES_PINSIR_MEGA] = _("PinsirM"),
    [SPECIES_GYARADOS_MEGA] = _("GyaradosM"),
    [SPECIES_AERODACTYL_MEGA] = _("AerodactyM"),
    [SPECIES_MEWTWO_MEGA_X] = _("MewtwoX"),
    [SPECIES_MEWTWO_MEGA_Y] = _("MewtwoY"),
    [SPECIES_AMPHAROS_MEGA] = _("AmpharosM"),
    [SPECIES_STEELIX_MEGA] = _("SteelixM"),
    [SPECIES_SCIZOR_MEGA] = _("ScizorM"),
    [SPECIES_HERACROSS_MEGA] = _("HeracrossM"),
    [SPECIES_HOUNDOOM_MEGA] = _("HoundoomM"),
    [SPECIES_TYRANITAR_MEGA] = _("TyranitarM"),
    [SPECIES_SCEPTILE_MEGA] = _("SceptileM"),
    [SPECIES_BLAZIKEN_MEGA] = _("BlazikenM"),
    [SPECIES_SWAMPERT_MEGA] = _("SwampertM"),
    [SPECIES_GARDEVOIR_MEGA] = _("GardevoirM"),
    [SPECIES_SABLEYE_MEGA] = _("SableyeM"),
    [SPECIES_MAWILE_MEGA] = _("MawileM"),
    [SPECIES_AGGRON_MEGA] = _("AggronM"),
    [SPECIES_MEDICHAM_MEGA] = _("MedichamM"),
    [SPECIES_MANECTRIC_MEGA] = _("ManectricM"),
    [SPECIES_SHARPEDO_MEGA] = _("SharpedoM"),
    [SPECIES_CAMERUPT_MEGA] = _("CameruptM"),
    [SPECIES_ALTARIA_MEGA] = _("AltariaM"),
    [SPECIES_BANETTE_MEGA] = _("BanetteM"),
    [SPECIES_ABSOL_MEGA] = _("AbsolM"),
    [SPECIES_GLALIE_MEGA] = _("GlalieM"),
    [SPECIES_SALAMENCE_MEGA] = _("SalamenceM"),
    [SPECIES_METAGROSS_MEGA] = _("MetagrossM"),
    [SPECIES_LATIAS_MEGA] = _("LatiasM"),
    [SPECIES_LATIOS_MEGA] = _("LatiosM"),
    [SPECIES_LOPUNNY_MEGA] = _("LopunnyM"),
    [SPECIES_GARCHOMP_MEGA] = _("GarchompM"),
    [SPECIES_LUCARIO_MEGA] = _("LucarioM"),
    [SPECIES_ABOMASNOW_MEGA] = _("AbomasnowM"),
    [SPECIES_GALLADE_MEGA] = _("GalladeM"),
    [SPECIES_AUDINO_MEGA] = _("AudinoM"),
    [SPECIES_DIANCIE_MEGA] = _("DiancieM"),
    // Special Mega + Primals
    [SPECIES_RAYQUAZA_MEGA] = _("RayquazaM"),
    [SPECIES_KYOGRE_PRIMAL] = _("KyogreP"),
    [SPECIES_GROUDON_PRIMAL] = _("GroudonP"),

    // Alolan Forms
    [SPECIES_RATTATA_ALOLAN] = _("RattataA"),
    [SPECIES_RATICATE_ALOLAN] = _("RaticateA"),
    [SPECIES_RAICHU_ALOLAN] = _("RaichuA"),
    [SPECIES_SANDSHREW_ALOLAN] = _("SandshrewA"),
    [SPECIES_SANDSLASH_ALOLAN] = _("SandslashA"),
    [SPECIES_VULPIX_ALOLAN] = _("VulpixA"),
    [SPECIES_NINETALES_ALOLAN] = _("NinetalesA"),
    [SPECIES_DIGLETT_ALOLAN] = _("DiglettA"),
    [SPECIES_DUGTRIO_ALOLAN] = _("DugtrioA"),
    [SPECIES_MEOWTH_ALOLAN] = _("MeowthA"),
    [SPECIES_PERSIAN_ALOLAN] = _("PersianA"),
    [SPECIES_GEODUDE_ALOLAN] = _("GeodudeA"),
    [SPECIES_GRAVELER_ALOLAN] = _("GravelerA"),
    [SPECIES_GOLEM_ALOLAN] = _("GolemA"),
    [SPECIES_GRIMER_ALOLAN] = _("GrimerA"),
    [SPECIES_MUK_ALOLAN] = _("MukA"),
    [SPECIES_EXEGGUTOR_ALOLAN] = _("ExeggutorA"),
    [SPECIES_MAROWAK_ALOLAN] = _("MarowakA"),

    // Galarian Forms
    [SPECIES_MEOWTH_GALARIAN] = _("MeowthG"),
    [SPECIES_PONYTA_GALARIAN] = _("PonytaG"),
    [SPECIES_RAPIDASH_GALARIAN] = _("RapidashG"),
    [SPECIES_SLOWPOKE_GALARIAN] = _("SlowpokeG"),
    [SPECIES_SLOWBRO_GALARIAN] = _("SlowbroG"),
    [SPECIES_FARFETCHD_GALARIAN] = _("FarfetchdG"),
    [SPECIES_WEEZING_GALARIAN] = _("WeezingG"),
    [SPECIES_MR_MIME_GALARIAN] = _("Mr. MimeG"),
    [SPECIES_ARTICUNO_GALARIAN] = _("ArticunoG"),
    [SPECIES_ZAPDOS_GALARIAN] = _("ZapdosG"),
    [SPECIES_MOLTRES_GALARIAN] = _("MoltresG"),
    [SPECIES_SLOWKING_GALARIAN] = _("SlowkingG"),
    [SPECIES_CORSOLA_GALARIAN] = _("CorsolaG"),
    [SPECIES_ZIGZAGOON_GALARIAN] = _("ZigzagoonG"),
    [SPECIES_LINOONE_GALARIAN] = _("LinooneG"),
    [SPECIES_DARUMAKA_GALARIAN] = _("DarumakaG"),
    [SPECIES_DARMANITAN_GALARIAN] = _("DarmanitaG"),
    [SPECIES_YAMASK_GALARIAN] = _("YamaskG"),
    [SPECIES_STUNFISK_GALARIAN] = _("StunfiskG"),

//Hisuian Forms
    [SPECIES_GROWLITHE_HISUIAN] = _("GrowlitheH"),
    [SPECIES_ARCANINE_HISUIAN] = _("ArcanineH"),
    [SPECIES_VOLTORB_HISUIAN] = _("VoltorbH"),
    [SPECIES_ELECTRODE_HISUIAN] = _("ElectrodeH"),
    [SPECIES_TYPHLOSION_HISUIAN] = _("TyphlosioH"),
    [SPECIES_QWILFISH_HISUIAN] = _("QwilfishH"),
    [SPECIES_SNEASEL_HISUIAN] = _("SneaselH"),
    [SPECIES_SAMUROTT_HISUIAN] = _("SamurottH"),
    [SPECIES_LILLIGANT_HISUIAN] = _("LilligantH"),
    [SPECIES_ZORUA_HISUIAN] = _("ZoruaH"),
    [SPECIES_ZOROARK_HISUIAN] = _("ZoroarkH"),
    [SPECIES_BRAVIARY_HISUIAN] = _("BraviaryH"),
    [SPECIES_SLIGGOO_HISUIAN] = _("SliggooH"),
    ...
    [SPECIES_CASTFORM_SNOWY] = _("CastformI"),
    // Deoxys
    ...
    [SPECIES_GIRATINA_ORIGIN] = _("GiratinaO"),
    // Shaymin
    ...
    // Hoopa
    [SPECIES_HOOPA_UNBOUND] = _("HoopaU"),
    // Oricorio
