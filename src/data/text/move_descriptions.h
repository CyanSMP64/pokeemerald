...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_ROOST - 1] = sPlaceholderDescription,
    [MOVE_GRAVITY - 1] = sPlaceholderDescription,
    [MOVE_MIRACLE_EYE - 1] = sPlaceholderDescription,
    [MOVE_WAKE_UP_SLAP - 1] = sPlaceholderDescription,
    [MOVE_HAMMER_ARM - 1] = sPlaceholderDescription,
    [MOVE_GYRO_BALL - 1] = sPlaceholderDescription,
    [MOVE_HEALING_WISH - 1] = sPlaceholderDescription,
    [MOVE_BRINE - 1] = sPlaceholderDescription,
    [MOVE_NATURAL_GIFT - 1] = sPlaceholderDescription,
    [MOVE_FEINT - 1] = sPlaceholderDescription,
    [MOVE_PLUCK - 1] = sPlaceholderDescription,
    [MOVE_TAILWIND - 1] = sPlaceholderDescription,
    [MOVE_ACUPRESSURE - 1] = sPlaceholderDescription,
    [MOVE_METAL_BURST - 1] = sPlaceholderDescription,
    [MOVE_U_TURN - 1] = sPlaceholderDescription,
    [MOVE_CLOSE_COMBAT - 1] = sPlaceholderDescription,
    [MOVE_PAYBACK - 1] = sPlaceholderDescription,
    [MOVE_ASSURANCE - 1] = sPlaceholderDescription,
    [MOVE_EMBARGO - 1] = sPlaceholderDescription,
    [MOVE_FLING - 1] = sPlaceholderDescription,
    [MOVE_PSYCHO_SHIFT - 1] = sPlaceholderDescription,
    [MOVE_TRUMP_CARD - 1] = sPlaceholderDescription,
    [MOVE_HEAL_BLOCK - 1] = sPlaceholderDescription,
    [MOVE_WRING_OUT - 1] = sPlaceholderDescription,
    [MOVE_POWER_TRICK - 1] = sPlaceholderDescription,
    [MOVE_GASTRO_ACID - 1] = sPlaceholderDescription,
    [MOVE_LUCKY_CHANT - 1] = sPlaceholderDescription,
    [MOVE_ME_FIRST - 1] = sPlaceholderDescription,
    [MOVE_COPYCAT - 1] = sPlaceholderDescription,
    [MOVE_POWER_SWAP - 1] = sPlaceholderDescription,
    [MOVE_GUARD_SWAP - 1] = sPlaceholderDescription,
    [MOVE_PUNISHMENT - 1] = sPlaceholderDescription,
    [MOVE_LAST_RESORT - 1] = sPlaceholderDescription,
    [MOVE_WORRY_SEED - 1] = sPlaceholderDescription,
    [MOVE_SUCKER_PUNCH - 1] = sPlaceholderDescription,
    [MOVE_TOXIC_SPIKES - 1] = sPlaceholderDescription,
    [MOVE_HEART_SWAP - 1] = sPlaceholderDescription,
    [MOVE_AQUA_RING - 1] = sPlaceholderDescription,
    [MOVE_MAGNET_RISE - 1] = sPlaceholderDescription,
    [MOVE_FLARE_BLITZ - 1] = sPlaceholderDescription,
    [MOVE_FORCE_PALM - 1] = sPlaceholderDescription,
    [MOVE_AURA_SPHERE - 1] = sPlaceholderDescription,
    [MOVE_ROCK_POLISH - 1] = sPlaceholderDescription,
    [MOVE_POISON_JAB - 1] = sPlaceholderDescription,
    [MOVE_DARK_PULSE - 1] = sPlaceholderDescription,
    [MOVE_NIGHT_SLASH - 1] = sPlaceholderDescription,
    [MOVE_AQUA_TAIL - 1] = sPlaceholderDescription,
    [MOVE_SEED_BOMB - 1] = sPlaceholderDescription,
    [MOVE_AIR_SLASH - 1] = sAirSlashDescription,
    [MOVE_X_SCISSOR - 1] = sPlaceholderDescription,
    [MOVE_BUG_BUZZ - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_PULSE - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_RUSH - 1] = sPlaceholderDescription,
    [MOVE_POWER_GEM - 1] = sPlaceholderDescription,
    [MOVE_DRAIN_PUNCH - 1] = sPlaceholderDescription,
    [MOVE_VACUUM_WAVE - 1] = sPlaceholderDescription,
    [MOVE_FOCUS_BLAST - 1] = sPlaceholderDescription,
    [MOVE_ENERGY_BALL - 1] = sPlaceholderDescription,
    [MOVE_BRAVE_BIRD - 1] = sPlaceholderDescription,
    [MOVE_EARTH_POWER - 1] = sPlaceholderDescription,
    [MOVE_SWITCHEROO - 1] = sPlaceholderDescription,
    [MOVE_GIGA_IMPACT - 1] = sPlaceholderDescription,
    [MOVE_NASTY_PLOT - 1] = sPlaceholderDescription,
    [MOVE_BULLET_PUNCH - 1] = sPlaceholderDescription,
    [MOVE_AVALANCHE - 1] = sPlaceholderDescription,
    [MOVE_ICE_SHARD - 1] = sPlaceholderDescription,
    [MOVE_SHADOW_CLAW - 1] = sPlaceholderDescription,
    [MOVE_THUNDER_FANG - 1] = sPlaceholderDescription,
    [MOVE_ICE_FANG - 1] = sPlaceholderDescription,
    [MOVE_FIRE_FANG - 1] = sPlaceholderDescription,
    [MOVE_SHADOW_SNEAK - 1] = sShadowSneakDescription,
    [MOVE_MUD_BOMB - 1] = sPlaceholderDescription,
    [MOVE_PSYCHO_CUT - 1] = sPlaceholderDescription,
    [MOVE_ZEN_HEADBUTT - 1] = sPlaceholderDescription,
    [MOVE_MIRROR_SHOT - 1] = sPlaceholderDescription,
    [MOVE_FLASH_CANNON - 1] = sPlaceholderDescription,
    [MOVE_ROCK_CLIMB - 1] = sPlaceholderDescription,
    [MOVE_DEFOG - 1] = sPlaceholderDescription,
    [MOVE_TRICK_ROOM - 1] = sPlaceholderDescription,
    [MOVE_DRACO_METEOR - 1] = sPlaceholderDescription,
    [MOVE_DISCHARGE - 1] = sPlaceholderDescription,
    [MOVE_LAVA_PLUME - 1] = sPlaceholderDescription,
    [MOVE_LEAF_STORM - 1] = sLeafStormDescription,
    [MOVE_POWER_WHIP - 1] = sPlaceholderDescription,
    [MOVE_ROCK_WRECKER - 1] = sPlaceholderDescription,
    [MOVE_CROSS_POISON - 1] = sPlaceholderDescription,
    [MOVE_GUNK_SHOT - 1] = sPlaceholderDescription,
    [MOVE_IRON_HEAD - 1] = sPlaceholderDescription,
    [MOVE_MAGNET_BOMB - 1] = sPlaceholderDescription,
    [MOVE_STONE_EDGE - 1] = sPlaceholderDescription,
    [MOVE_CAPTIVATE - 1] = sPlaceholderDescription,
    [MOVE_STEALTH_ROCK - 1] = sPlaceholderDescription,
    [MOVE_GRASS_KNOT - 1] = sPlaceholderDescription,
    [MOVE_CHATTER - 1] = sPlaceholderDescription,
    [MOVE_JUDGMENT - 1] = sPlaceholderDescription,
    [MOVE_BUG_BITE - 1] = sPlaceholderDescription,
    [MOVE_CHARGE_BEAM - 1] = sPlaceholderDescription,
    [MOVE_WOOD_HAMMER - 1] = sPlaceholderDescription,
    [MOVE_AQUA_JET - 1] = sPlaceholderDescription,
    [MOVE_ATTACK_ORDER - 1] = sPlaceholderDescription,
    [MOVE_DEFEND_ORDER - 1] = sPlaceholderDescription,
    [MOVE_HEAL_ORDER - 1] = sPlaceholderDescription,
    [MOVE_HEAD_SMASH - 1] = sPlaceholderDescription,
    [MOVE_DOUBLE_HIT - 1] = sPlaceholderDescription,
    [MOVE_ROAR_OF_TIME - 1] = sPlaceholderDescription,
    [MOVE_SPACIAL_REND - 1] = sPlaceholderDescription,
    [MOVE_LUNAR_DANCE - 1] = sPlaceholderDescription,
    [MOVE_CRUSH_GRIP - 1] = sPlaceholderDescription,
    [MOVE_MAGMA_STORM - 1] = sPlaceholderDescription,
    [MOVE_DARK_VOID - 1] = sPlaceholderDescription,
    [MOVE_SEED_FLARE - 1] = sPlaceholderDescription,
    [MOVE_OMINOUS_WIND - 1] = sPlaceholderDescription,
    [MOVE_SHADOW_FORCE - 1] = sPlaceholderDescription,
    [MOVE_HONE_CLAWS - 1] = sPlaceholderDescription,
    [MOVE_WIDE_GUARD - 1] = sPlaceholderDescription,
    [MOVE_GUARD_SPLIT - 1] = sPlaceholderDescription,
    [MOVE_POWER_SPLIT - 1] = sPlaceholderDescription,
    [MOVE_WONDER_ROOM - 1] = sPlaceholderDescription,
    [MOVE_PSYSHOCK - 1] = sPlaceholderDescription,
    [MOVE_VENOSHOCK - 1] = sPlaceholderDescription,
    [MOVE_AUTOTOMIZE - 1] = sPlaceholderDescription,
    [MOVE_RAGE_POWDER - 1] = sPlaceholderDescription,
    [MOVE_TELEKINESIS - 1] = sPlaceholderDescription,
    [MOVE_MAGIC_ROOM - 1] = sPlaceholderDescription,
    [MOVE_SMACK_DOWN - 1] = sPlaceholderDescription,
    [MOVE_STORM_THROW - 1] = sPlaceholderDescription,
    [MOVE_FLAME_BURST - 1] = sPlaceholderDescription,
    [MOVE_SLUDGE_WAVE - 1] = sPlaceholderDescription,
    [MOVE_QUIVER_DANCE - 1] = sPlaceholderDescription,
    [MOVE_HEAVY_SLAM - 1] = sPlaceholderDescription,
    [MOVE_SYNCHRONOISE - 1] = sPlaceholderDescription,
    [MOVE_ELECTRO_BALL - 1] = sPlaceholderDescription,
    [MOVE_SOAK - 1] = sPlaceholderDescription,
    [MOVE_FLAME_CHARGE - 1] = sPlaceholderDescription,
    [MOVE_COIL - 1] = sPlaceholderDescription,
    [MOVE_LOW_SWEEP - 1] = sPlaceholderDescription,
    [MOVE_ACID_SPRAY - 1] = sPlaceholderDescription,
    [MOVE_FOUL_PLAY - 1] = sPlaceholderDescription,
    [MOVE_SIMPLE_BEAM - 1] = sPlaceholderDescription,
    [MOVE_ENTRAINMENT - 1] = sPlaceholderDescription,
    [MOVE_AFTER_YOU - 1] = sPlaceholderDescription,
    [MOVE_ROUND - 1] = sPlaceholderDescription,
    [MOVE_ECHOED_VOICE - 1] = sPlaceholderDescription,
    [MOVE_CHIP_AWAY - 1] = sPlaceholderDescription,
    [MOVE_CLEAR_SMOG - 1] = sPlaceholderDescription,
    [MOVE_STORED_POWER - 1] = sPlaceholderDescription,
    [MOVE_QUICK_GUARD - 1] = sPlaceholderDescription,
    [MOVE_ALLY_SWITCH - 1] = sPlaceholderDescription,
    [MOVE_SCALD - 1] = sPlaceholderDescription,
    [MOVE_SHELL_SMASH - 1] = sPlaceholderDescription,
    [MOVE_HEAL_PULSE - 1] = sPlaceholderDescription,
    [MOVE_HEX - 1] = sPlaceholderDescription,
    [MOVE_SKY_DROP - 1] = sPlaceholderDescription,
    [MOVE_SHIFT_GEAR - 1] = sPlaceholderDescription,
    [MOVE_CIRCLE_THROW - 1] = sPlaceholderDescription,
    [MOVE_INCINERATE - 1] = sPlaceholderDescription,
    [MOVE_QUASH - 1] = sPlaceholderDescription,
    [MOVE_ACROBATICS - 1] = sPlaceholderDescription,
    [MOVE_REFLECT_TYPE - 1] = sPlaceholderDescription,
    [MOVE_RETALIATE - 1] = sPlaceholderDescription,
    [MOVE_FINAL_GAMBIT - 1] = sPlaceholderDescription,
    [MOVE_BESTOW - 1] = sPlaceholderDescription,
    [MOVE_INFERNO - 1] = sPlaceholderDescription,
    [MOVE_WATER_PLEDGE - 1] = sPlaceholderDescription,
    [MOVE_FIRE_PLEDGE - 1] = sPlaceholderDescription,
    [MOVE_GRASS_PLEDGE - 1] = sPlaceholderDescription,
    [MOVE_VOLT_SWITCH - 1] = sPlaceholderDescription,
    [MOVE_STRUGGLE_BUG - 1] = sStruggleBugDescription,
    [MOVE_BULLDOZE - 1] = sPlaceholderDescription,
    [MOVE_FROST_BREATH - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_TAIL - 1] = sPlaceholderDescription,
    [MOVE_WORK_UP - 1] = sPlaceholderDescription,
    [MOVE_ELECTROWEB - 1] = sPlaceholderDescription,
    [MOVE_WILD_CHARGE - 1] = sPlaceholderDescription,
    [MOVE_DRILL_RUN - 1] = sPlaceholderDescription,
    [MOVE_DUAL_CHOP - 1] = sPlaceholderDescription,
    [MOVE_HEART_STAMP - 1] = sPlaceholderDescription,
    [MOVE_HORN_LEECH - 1] = sPlaceholderDescription,
    [MOVE_SACRED_SWORD - 1] = sPlaceholderDescription,
    [MOVE_RAZOR_SHELL - 1] = sPlaceholderDescription,
    [MOVE_HEAT_CRASH - 1] = sPlaceholderDescription,
    [MOVE_LEAF_TORNADO - 1] = sPlaceholderDescription,
    [MOVE_STEAMROLLER - 1] = sPlaceholderDescription,
    [MOVE_COTTON_GUARD - 1] = sPlaceholderDescription,
    [MOVE_NIGHT_DAZE - 1] = sPlaceholderDescription,
    [MOVE_PSYSTRIKE - 1] = sPlaceholderDescription,
    [MOVE_TAIL_SLAP - 1] = sPlaceholderDescription,
    [MOVE_HURRICANE - 1] = sPlaceholderDescription,
    [MOVE_HEAD_CHARGE - 1] = sPlaceholderDescription,
    [MOVE_GEAR_GRIND - 1] = sPlaceholderDescription,
    [MOVE_SEARING_SHOT - 1] = sPlaceholderDescription,
    [MOVE_TECHNO_BLAST - 1] = sPlaceholderDescription,
    [MOVE_RELIC_SONG - 1] = sPlaceholderDescription,
    [MOVE_SECRET_SWORD - 1] = sPlaceholderDescription,
    [MOVE_GLACIATE - 1] = sPlaceholderDescription,
    [MOVE_BOLT_STRIKE - 1] = sPlaceholderDescription,
    [MOVE_BLUE_FLARE - 1] = sPlaceholderDescription,
    [MOVE_FIERY_DANCE - 1] = sPlaceholderDescription,
    [MOVE_FREEZE_SHOCK - 1] = sPlaceholderDescription,
    [MOVE_ICE_BURN - 1] = sPlaceholderDescription,
    [MOVE_SNARL - 1] = sPlaceholderDescription,
    [MOVE_ICICLE_CRASH - 1] = sPlaceholderDescription,
    [MOVE_V_CREATE - 1] = sPlaceholderDescription,
    [MOVE_FUSION_FLARE - 1] = sPlaceholderDescription,
    [MOVE_FUSION_BOLT - 1] = sPlaceholderDescription,
    [MOVE_FLYING_PRESS - 1] = sPlaceholderDescription,
    [MOVE_MAT_BLOCK - 1] = sPlaceholderDescription,
    [MOVE_BELCH - 1] = sPlaceholderDescription,
    [MOVE_ROTOTILLER - 1] = sPlaceholderDescription,
    [MOVE_STICKY_WEB - 1] = sPlaceholderDescription,
    [MOVE_FELL_STINGER - 1] = sPlaceholderDescription,
    [MOVE_PHANTOM_FORCE - 1] = sPlaceholderDescription,
    [MOVE_TRICK_OR_TREAT - 1] = sPlaceholderDescription,
    [MOVE_NOBLE_ROAR - 1] = sPlaceholderDescription,
    [MOVE_ION_DELUGE - 1] = sPlaceholderDescription,
    [MOVE_PARABOLIC_CHARGE - 1] = sPlaceholderDescription,
    [MOVE_FORESTS_CURSE - 1] = sPlaceholderDescription,
    [MOVE_PETAL_BLIZZARD - 1] = sPlaceholderDescription,
    [MOVE_FREEZE_DRY - 1] = sPlaceholderDescription,
    [MOVE_DISARMING_VOICE - 1] = sDisarmingVoiceDescription,
    [MOVE_PARTING_SHOT - 1] = sPlaceholderDescription,
    [MOVE_TOPSY_TURVY - 1] = sPlaceholderDescription,
    [MOVE_DRAINING_KISS - 1] = sDrainingKissDescription,
    [MOVE_CRAFTY_SHIELD - 1] = sPlaceholderDescription,
    [MOVE_FLOWER_SHIELD - 1] = sPlaceholderDescription,
    [MOVE_GRASSY_TERRAIN - 1] = sPlaceholderDescription,
    [MOVE_MISTY_TERRAIN - 1] = sPlaceholderDescription,
    [MOVE_ELECTRIFY - 1] = sPlaceholderDescription,
    [MOVE_PLAY_ROUGH - 1] = sPlayRoughDescription,
    [MOVE_FAIRY_WIND - 1] = sFairyWindDescription,
    [MOVE_MOONBLAST - 1] = sMoonblastDescription,
    [MOVE_BOOMBURST - 1] = sPlaceholderDescription,
    [MOVE_FAIRY_LOCK - 1] = sPlaceholderDescription,
    [MOVE_KINGS_SHIELD - 1] = sPlaceholderDescription,
    [MOVE_PLAY_NICE - 1] = sPlayNiceDescription,
    [MOVE_CONFIDE - 1] = sPlaceholderDescription,
    [MOVE_DIAMOND_STORM - 1] = sPlaceholderDescription,
    [MOVE_STEAM_ERUPTION - 1] = sPlaceholderDescription,
    [MOVE_HYPERSPACE_HOLE - 1] = sPlaceholderDescription,
    [MOVE_WATER_SHURIKEN - 1] = sPlaceholderDescription,
    [MOVE_MYSTICAL_FIRE - 1] = sPlaceholderDescription,
    [MOVE_SPIKY_SHIELD - 1] = sPlaceholderDescription,
    [MOVE_AROMATIC_MIST - 1] = sPlaceholderDescription,
    [MOVE_EERIE_IMPULSE - 1] = sPlaceholderDescription,
    [MOVE_VENOM_DRENCH - 1] = sPlaceholderDescription,
    [MOVE_POWDER - 1] = sPlaceholderDescription,
    [MOVE_GEOMANCY - 1] = sPlaceholderDescription,
    [MOVE_MAGNETIC_FLUX - 1] = sPlaceholderDescription,
    [MOVE_HAPPY_HOUR - 1] = sPlaceholderDescription,
    [MOVE_ELECTRIC_TERRAIN - 1] = sPlaceholderDescription,
    [MOVE_DAZZLING_GLEAM - 1] = sDazzlingGleamDescription,
    [MOVE_CELEBRATE - 1] = sPlaceholderDescription,
    [MOVE_HOLD_HANDS - 1] = sPlaceholderDescription,
    [MOVE_BABY_DOLL_EYES - 1] = sPlaceholderDescription,
    [MOVE_NUZZLE - 1] = sPlaceholderDescription,
    [MOVE_HOLD_BACK - 1] = sPlaceholderDescription,
    [MOVE_INFESTATION - 1] = sPlaceholderDescription,
    [MOVE_POWER_UP_PUNCH - 1] = sPlaceholderDescription,
    [MOVE_OBLIVION_WING - 1] = sPlaceholderDescription,
    [MOVE_THOUSAND_ARROWS - 1] = sPlaceholderDescription,
    [MOVE_THOUSAND_WAVES - 1] = sPlaceholderDescription,
    [MOVE_LANDS_WRATH - 1] = sPlaceholderDescription,
    [MOVE_LIGHT_OF_RUIN - 1] = sPlaceholderDescription,
    [MOVE_ORIGIN_PULSE - 1] = sPlaceholderDescription,
    [MOVE_PRECIPICE_BLADES - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_ASCENT - 1] = sPlaceholderDescription,
    [MOVE_HYPERSPACE_FURY - 1] = sPlaceholderDescription,
    [MOVE_SHORE_UP - 1] = sPlaceholderDescription,
    [MOVE_FIRST_IMPRESSION - 1] = sPlaceholderDescription,
    [MOVE_BANEFUL_BUNKER - 1] = sPlaceholderDescription,
    [MOVE_SPIRIT_SHACKLE - 1] = sPlaceholderDescription,
    [MOVE_DARKEST_LARIAT - 1] = sPlaceholderDescription,
    [MOVE_SPARKLING_ARIA - 1] = sPlaceholderDescription,
    [MOVE_ICE_HAMMER - 1] = sPlaceholderDescription,
    [MOVE_FLORAL_HEALING - 1] = sPlaceholderDescription,
    [MOVE_HIGH_HORSEPOWER - 1] = sPlaceholderDescription,
    [MOVE_STRENGTH_SAP - 1] = sPlaceholderDescription,
    [MOVE_SOLAR_BLADE - 1] = sPlaceholderDescription,
    [MOVE_LEAFAGE - 1] = sPlaceholderDescription,
    [MOVE_SPOTLIGHT - 1] = sPlaceholderDescription,
    [MOVE_TOXIC_THREAD - 1] = sPlaceholderDescription,
    [MOVE_LASER_FOCUS - 1] = sPlaceholderDescription,
    [MOVE_GEAR_UP - 1] = sPlaceholderDescription,
    [MOVE_THROAT_CHOP - 1] = sPlaceholderDescription,
    [MOVE_POLLEN_PUFF - 1] = sPlaceholderDescription,
    [MOVE_ANCHOR_SHOT - 1] = sPlaceholderDescription,
    [MOVE_PSYCHIC_TERRAIN - 1] = sPlaceholderDescription,
    [MOVE_LUNGE - 1] = sPlaceholderDescription,
    [MOVE_FIRE_LASH - 1] = sPlaceholderDescription,
    [MOVE_POWER_TRIP - 1] = sPlaceholderDescription,
    [MOVE_BURN_UP - 1] = sPlaceholderDescription,
    [MOVE_SPEED_SWAP - 1] = sPlaceholderDescription,
    [MOVE_SMART_STRIKE - 1] = sPlaceholderDescription,
    [MOVE_PURIFY - 1] = sPlaceholderDescription,
    [MOVE_REVELATION_DANCE - 1] = sPlaceholderDescription,
    [MOVE_CORE_ENFORCER - 1] = sPlaceholderDescription,
    [MOVE_TROP_KICK - 1] = sPlaceholderDescription,
    [MOVE_INSTRUCT - 1] = sPlaceholderDescription,
    [MOVE_BEAK_BLAST - 1] = sPlaceholderDescription,
    [MOVE_CLANGING_SCALES - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_HAMMER - 1] = sPlaceholderDescription,
    [MOVE_BRUTAL_SWING - 1] = sPlaceholderDescription,
    [MOVE_AURORA_VEIL - 1] = sPlaceholderDescription,
    [MOVE_SHELL_TRAP - 1] = sPlaceholderDescription,
    [MOVE_FLEUR_CANNON - 1] = sPlaceholderDescription,
    [MOVE_PSYCHIC_FANGS - 1] = sPlaceholderDescription,
    [MOVE_STOMPING_TANTRUM - 1] = sPlaceholderDescription,
    [MOVE_SHADOW_BONE - 1] = sPlaceholderDescription,
    [MOVE_ACCELEROCK - 1] = sPlaceholderDescription,
    [MOVE_LIQUIDATION - 1] = sPlaceholderDescription,
    [MOVE_PRISMATIC_LASER - 1] = sPlaceholderDescription,
    [MOVE_SPECTRAL_THIEF - 1] = sPlaceholderDescription,
    [MOVE_SUNSTEEL_STRIKE - 1] = sPlaceholderDescription,
    [MOVE_MOONGEIST_BEAM - 1] = sPlaceholderDescription,
    [MOVE_TEARFUL_LOOK - 1] = sPlaceholderDescription,
    [MOVE_ZING_ZAP - 1] = sPlaceholderDescription,
    [MOVE_NATURES_MADNESS - 1] = sPlaceholderDescription,
    [MOVE_MULTI_ATTACK - 1] = sPlaceholderDescription,
    [MOVE_MIND_BLOWN - 1] = sPlaceholderDescription,
    [MOVE_PLASMA_FISTS - 1] = sPlaceholderDescription,
    [MOVE_PHOTON_GEYSER - 1] = sPlaceholderDescription,
    [MOVE_ZIPPY_ZAP - 1] = sPlaceholderDescription,
    [MOVE_SPLISHY_SPLASH - 1] = sPlaceholderDescription,
    [MOVE_FLOATY_FALL - 1] = sPlaceholderDescription,
    [MOVE_PIKA_PAPOW - 1] = sPlaceholderDescription,
    [MOVE_BOUNCY_BUBBLE - 1] = sPlaceholderDescription,
    [MOVE_BUZZY_BUZZ - 1] = sPlaceholderDescription,
    [MOVE_SIZZLY_SLIDE - 1] = sPlaceholderDescription,
    [MOVE_GLITZY_GLOW - 1] = sPlaceholderDescription,
    [MOVE_BADDY_BAD - 1] = sPlaceholderDescription,
    [MOVE_SAPPY_SEED - 1] = sPlaceholderDescription,
    [MOVE_FREEZY_FROST - 1] = sPlaceholderDescription,
    [MOVE_SPARKLY_SWIRL - 1] = sPlaceholderDescription,
    [MOVE_VEEVEE_VOLLEY - 1] = sPlaceholderDescription,
    [MOVE_DOUBLE_IRON_BASH - 1] = sPlaceholderDescription,
    [MOVE_DYNAMAX_CANNON - 1] = sPlaceholderDescription,
    [MOVE_SNIPE_SHOT - 1] = sPlaceholderDescription,
    [MOVE_JAW_LOCK - 1] = sPlaceholderDescription,
    [MOVE_STUFF_CHEEKS - 1] = sPlaceholderDescription,
    [MOVE_NO_RETREAT - 1] = sPlaceholderDescription,
    [MOVE_TAR_SHOT - 1] = sPlaceholderDescription,
    [MOVE_MAGIC_POWDER - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_DARTS - 1] = sPlaceholderDescription,
    [MOVE_TEATIME - 1] = sPlaceholderDescription,
    [MOVE_OCTOLOCK - 1] = sPlaceholderDescription,
    [MOVE_BOLT_BEAK - 1] = sPlaceholderDescription,
    [MOVE_FISHIOUS_REND - 1] = sPlaceholderDescription,
    [MOVE_COURT_CHANGE - 1] = sPlaceholderDescription,
    [MOVE_CLANGOROUS_SOUL - 1] = sPlaceholderDescription,
    [MOVE_BODY_PRESS - 1] = sPlaceholderDescription,
    [MOVE_DECORATE - 1] = sPlaceholderDescription,
    [MOVE_DRUM_BEATING - 1] = sPlaceholderDescription,
    [MOVE_SNAP_TRAP - 1] = sPlaceholderDescription,
    [MOVE_PYRO_BALL - 1] = sPlaceholderDescription,
    [MOVE_BEHEMOTH_BLADE - 1] = sPlaceholderDescription,
    [MOVE_BEHEMOTH_BASH - 1] = sPlaceholderDescription,
    [MOVE_AURA_WHEEL - 1] = sPlaceholderDescription,
    [MOVE_BREAKING_SWIPE - 1] = sPlaceholderDescription,
    [MOVE_BRANCH_POKE - 1] = sPlaceholderDescription,
    [MOVE_OVERDRIVE - 1] = sPlaceholderDescription,
    [MOVE_APPLE_ACID - 1] = sPlaceholderDescription,
    [MOVE_GRAV_APPLE - 1] = sPlaceholderDescription,
    [MOVE_SPIRIT_BREAK - 1] = sPlaceholderDescription,
    [MOVE_STRANGE_STEAM - 1] = sPlaceholderDescription,
    [MOVE_LIFE_DEW - 1] = sPlaceholderDescription,
    [MOVE_OBSTRUCT - 1] = sPlaceholderDescription,
    [MOVE_FALSE_SURRENDER - 1] = sPlaceholderDescription,
    [MOVE_METEOR_ASSAULT - 1] = sPlaceholderDescription,
    [MOVE_ETERNABEAM - 1] = sPlaceholderDescription,
    [MOVE_STEEL_BEAM - 1] = sPlaceholderDescription,
    [MOVE_EXPANDING_FORCE - 1] = sPlaceholderDescription,
    [MOVE_STEEL_ROLLER - 1] = sPlaceholderDescription,
    [MOVE_SCALE_SHOT - 1] = sPlaceholderDescription,
    [MOVE_METEOR_BEAM - 1] = sPlaceholderDescription,
    [MOVE_SHELL_SIDE_ARM - 1] = sPlaceholderDescription,
    [MOVE_MISTY_EXPLOSION - 1] = sPlaceholderDescription,
    [MOVE_GRASSY_GLIDE - 1] = sPlaceholderDescription,
    [MOVE_RISING_VOLTAGE - 1] = sPlaceholderDescription,
    [MOVE_TERRAIN_PULSE - 1] = sPlaceholderDescription,
    [MOVE_SKITTER_SMACK - 1] = sPlaceholderDescription,
    [MOVE_BURNING_JEALOUSY - 1] = sPlaceholderDescription,
    [MOVE_LASH_OUT - 1] = sPlaceholderDescription,
    [MOVE_POLTERGEIST - 1] = sPlaceholderDescription,
    [MOVE_CORROSIVE_GAS - 1] = sPlaceholderDescription,
    [MOVE_COACHING - 1] = sPlaceholderDescription,
    [MOVE_FLIP_TURN - 1] = sPlaceholderDescription,
    [MOVE_TRIPLE_AXEL - 1] = sPlaceholderDescription,
    [MOVE_DUAL_WINGBEAT - 1] = sPlaceholderDescription,
    [MOVE_SCORCHING_SANDS - 1] = sPlaceholderDescription,
    [MOVE_JUNGLE_HEALING - 1] = sPlaceholderDescription,
    [MOVE_WICKED_BLOW - 1] = sPlaceholderDescription,
    [MOVE_SURGING_STRIKES - 1] = sPlaceholderDescription,
    [MOVE_THUNDER_CAGE - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_ENERGY - 1] = sPlaceholderDescription,
    [MOVE_FREEZING_GLARE - 1] = sPlaceholderDescription,
    [MOVE_FIERY_WRATH - 1] = sPlaceholderDescription,
    [MOVE_THUNDEROUS_KICK - 1] = sPlaceholderDescription,
    [MOVE_GLACIAL_LANCE - 1] = sPlaceholderDescription,
    [MOVE_ASTRAL_BARRAGE - 1] = sPlaceholderDescription,
    [MOVE_EERIE_SPELL - 1] = sPlaceholderDescription,
    [MOVE_DIRE_CLAW - 1] = sPlaceholderDescription,
    [MOVE_PSYSHIELD_BASH - 1] = sPlaceholderDescription,
    [MOVE_POWER_SHIFT - 1] = sPlaceholderDescription,
    [MOVE_STONE_AXE - 1] = sPlaceholderDescription,
    [MOVE_SPRINGTIDE_STORM - 1] = sPlaceholderDescription,
    [MOVE_MYSTICAL_POWER - 1] = sPlaceholderDescription,
    [MOVE_RAGING_FURY - 1] = sPlaceholderDescription,
    [MOVE_WAVE_CRASH - 1] = sPlaceholderDescription,
    [MOVE_CHLOROBLAST - 1] = sPlaceholderDescription,
    [MOVE_MOUNTAIN_GALE - 1] = sPlaceholderDescription,
    [MOVE_VICTORY_DANCE - 1] = sPlaceholderDescription,
    [MOVE_HEADLONG_RUSH - 1] = sPlaceholderDescription,
    [MOVE_BARB_BARRAGE - 1] = sPlaceholderDescription,
    [MOVE_ESPER_WING - 1] = sPlaceholderDescription,
    [MOVE_BITTER_MALICE - 1] = sPlaceholderDescription,
    [MOVE_SHELTER - 1] = sPlaceholderDescription,
    [MOVE_TRIPLE_ARROWS - 1] = sPlaceholderDescription,
    [MOVE_INFERNAL_PARADE - 1] = sPlaceholderDescription,
    [MOVE_CEASELESS_EDGE - 1] = sPlaceholderDescription,
    [MOVE_BLEAKWIND_STORM - 1] = sPlaceholderDescription,
    [MOVE_WILDBOLT_STORM - 1] = sPlaceholderDescription,
    [MOVE_SANDSEAR_STORM - 1] = sPlaceholderDescription,
    [MOVE_LUNAR_BLESSING - 1] = sPlaceholderDescription,
    [MOVE_TAKE_HEART - 1] = sPlaceholderDescription,
    [MOVE_TERA_BLAST - 1] = sPlaceholderDescription,
    [MOVE_SILK_TRAP - 1] = sPlaceholderDescription,
    [MOVE_AXE_KICK - 1] = sPlaceholderDescription,
    [MOVE_LAST_RESPECTS - 1] = sPlaceholderDescription,
    [MOVE_LUMINA_CRASH - 1] = sPlaceholderDescription,
    [MOVE_ORDER_UP - 1] = sPlaceholderDescription,
    [MOVE_JET_PUNCH - 1] = sPlaceholderDescription,
    [MOVE_SPICY_EXTRACT - 1] = sPlaceholderDescription,
    [MOVE_SPIN_OUT - 1] = sPlaceholderDescription,
    [MOVE_POPULATION_BOMB - 1] = sPlaceholderDescription,
    [MOVE_ICE_SPINNER - 1] = sPlaceholderDescription,
    [MOVE_GLAIVE_RUSH - 1] = sPlaceholderDescription,
    [MOVE_REVIVAL_BLESSING - 1] = sPlaceholderDescription,
    [MOVE_SALT_CURE - 1] = sPlaceholderDescription,
    [MOVE_TRIPLE_DIVE - 1] = sPlaceholderDescription,
    [MOVE_MORTAL_SPIN - 1] = sPlaceholderDescription,
    [MOVE_DOODLE - 1] = sPlaceholderDescription,
    [MOVE_FILLET_AWAY - 1] = sPlaceholderDescription,
    [MOVE_KOWTOW_CLEAVE - 1] = sPlaceholderDescription,
    [MOVE_FLOWER_TRICK - 1] = sPlaceholderDescription,
    [MOVE_TORCH_SONG - 1] = sPlaceholderDescription,
    [MOVE_AQUA_STEP - 1] = sPlaceholderDescription,
    [MOVE_RAGING_BULL - 1] = sPlaceholderDescription,
    [MOVE_MAKE_IT_RAIN - 1] = sPlaceholderDescription,
    [MOVE_RUINATION - 1] = sPlaceholderDescription,
    [MOVE_COLLISION_COURSE - 1] = sPlaceholderDescription,
    [MOVE_ELECTRO_DRIFT - 1] = sPlaceholderDescription,
    [MOVE_SHED_TAIL - 1] = sPlaceholderDescription,
    [MOVE_CHILLY_RECEPTION - 1] = sPlaceholderDescription,
    [MOVE_TIDY_UP - 1] = sPlaceholderDescription,
    [MOVE_SNOWSCAPE - 1] = sPlaceholderDescription,
    [MOVE_POUNCE - 1] = sPlaceholderDescription,
    [MOVE_TRAILBLAZE - 1] = sPlaceholderDescription,
    [MOVE_CHILLING_WATER - 1] = sPlaceholderDescription,
    [MOVE_HYPER_DRILL - 1] = sPlaceholderDescription,
    [MOVE_TWIN_BEAM - 1] = sPlaceholderDescription,
    [MOVE_RAGE_FIST - 1] = sPlaceholderDescription,
    [MOVE_ARMOR_CANNON - 1] = sPlaceholderDescription,
    [MOVE_BITTER_BLADE - 1] = sPlaceholderDescription,
    [MOVE_DOUBLE_SHOCK - 1] = sPlaceholderDescription,
    [MOVE_GIGATON_HAMMER - 1] = sPlaceholderDescription,
    [MOVE_COMEUPPANCE - 1] = sPlaceholderDescription,
    [MOVE_AQUA_CUTTER - 1] = sPlaceholderDescription,
    [MOVE_BLAZING_TORQUE - 1] = sPlaceholderDescription,
    [MOVE_WICKED_TORQUE - 1] = sPlaceholderDescription,
    [MOVE_NOXIOUS_TORQUE - 1] = sPlaceholderDescription,
    [MOVE_COMBAT_TORQUE - 1] = sPlaceholderDescription,
    [MOVE_MAGICAL_TORQUE - 1] = sPlaceholderDescription,
    [MOVE_PSYBLADE - 1] = sPlaceholderDescription,
    [MOVE_HYDRO_STEAM - 1] = sPlaceholderDescription,
    [MOVE_BLOOD_MOON - 1] = sPlaceholderDescription,
    [MOVE_MATCHA_GOTCHA - 1] = sPlaceholderDescription,
    [MOVE_SYRUP_BOMB - 1] = sPlaceholderDescription,
    [MOVE_IVY_CUDGEL - 1] = sPlaceholderDescription,
    [MOVE_ELECTRO_SHOT - 1] = sPlaceholderDescription,
    [MOVE_TERA_STARSTORM - 1] = sPlaceholderDescription,
    [MOVE_FICKLE_BEAM - 1] = sPlaceholderDescription,
    [MOVE_BURNING_BULWARK - 1] = sPlaceholderDescription,
    [MOVE_THUNDERCLAP - 1] = sPlaceholderDescription,
    [MOVE_MIGHTY_CLEAVE - 1] = sPlaceholderDescription,
    [MOVE_TACHYON_CUTTER - 1] = sPlaceholderDescription,
    [MOVE_HARD_PRESS - 1] = sPlaceholderDescription,
    [MOVE_DRAGON_CHEER - 1] = sPlaceholderDescription,
    [MOVE_ALLURING_VOICE - 1] = sPlaceholderDescription,
    [MOVE_TEMPER_FLARE - 1] = sPlaceholderDescription,
    [MOVE_SUPERCELL_SLAM - 1] = sPlaceholderDescription,
    [MOVE_PSYCHIC_NOISE - 1] = sPlaceholderDescription,
    [MOVE_UPPER_HAND - 1] = sPlaceholderDescription,
    [MOVE_MALIGNANT_CHAIN - 1] = sPlaceholderDescription,
};
