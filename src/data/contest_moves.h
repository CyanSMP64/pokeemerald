const struct ContestMove gContestMoves[MOVES_COUNT] =
{
    ...
    [MOVE_SPICY_EXTRACT] = {0},

    [MOVE_SPIN_OUT] = {0},

    [MOVE_POPULATION_BOMB] = {0},

    [MOVE_ICE_SPINNER] = {0},

    [MOVE_GLAIVE_RUSH] = {0},

    [MOVE_REVIVAL_BLESSING] = {0},
    ...
    [MOVE_COLLISION_COURSE] = {0},

    [MOVE_ELECTRO_DRIFT] = {0},

    [MOVE_SHED_TAIL] = {0},

    [MOVE_CHILLY_RECEPTION] = {0},
    ...
    [MOVE_GIGATON_HAMMER] = {0},

    [MOVE_COMEUPPANCE] = {0},

    [MOVE_AQUA_CUTTER] = {0},

    [MOVE_BLAZING_TORQUE] = {0},

    [MOVE_WICKED_TORQUE] = {0},

    [MOVE_NOXIOUS_TORQUE] = {0},

    [MOVE_COMBAT_TORQUE] = {0},

    [MOVE_MAGICAL_TORQUE] = {0},
    ...
    [MOVE_TERA_STARSTORM] = {0},

    [MOVE_FICKLE_BEAM] = {0},

    [MOVE_BURNING_BULWARK] = {0},

    [MOVE_THUNDERCLAP] = {0},

    [MOVE_MIGHTY_CLEAVE] = {0},

    [MOVE_TACHYON_CUTTER] = {0},

    [MOVE_HARD_PRESS] = {0},

    [MOVE_DRAGON_CHEER] = {0},

    [MOVE_ALLURING_VOICE] = {0},

    [MOVE_TEMPER_FLARE] = {0},

    [MOVE_SUPERCELL_SLAM] = {0},

    [MOVE_PSYCHIC_NOISE] = {0},

    [MOVE_UPPER_HAND] = {0},

    [MOVE_MALIGNANT_CHAIN] = {0},
};
