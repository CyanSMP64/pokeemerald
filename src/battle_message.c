...
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_CLASS}{ENG} {B_TRAINER1_NAME}{ENG} sent out {B_OPPONENT_MON1_NAME}!\p{B_TRAINER2_CLASS}{ENG} {B_TRAINER2_NAME}{ENG} sent out {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_CLASS}{ENG} {B_TRAINER2_NAME}{ENG} sent out {B_BUFF1}!");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_CLASS}{ENG} {B_TRAINER1_NAME}{ENG} and {B_TRAINER2_CLASS}{ENG} {B_TRAINER2_NAME}{ENG} want to battle!\p");
...
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_CLASS}{ENG} {B_TRAINER1_NAME}{ENG} and {B_TRAINER2_CLASS}{ENG} {B_TRAINER2_NAME}{ENG} were defeated!\p");
