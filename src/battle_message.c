...
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_PREFIX2} team became shrouded\nin mist!");
...
static const u8 sText_PkmnsXMadeYUseless[] = _(""); // dummied
...
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _(""); // dummied
