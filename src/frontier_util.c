...
const u16 gFrontierBannedSpecies[] =
{
    ...
    SPECIES_DIALGA, SPECIES_PALKIA, SPECIES_GIRATINA, SPECIES_DIALGA_ORIGIN, SPECIES_PALKIA_ORIGIN,
    SPECIES_GIRATINA_ORIGIN, SPECIES_KYOGRE_PRIMAL, SPECIES_GROUDON_PRIMAL,
    SPECIES_DEOXYS_ATTACK, SPECIES_DEOXYS_DEFENSE, SPECIES_DEOXYS_SPEED,
    SPECIES_PHIONE, SPECIES_MANAPHY, SPECIES_DARKRAI, SPECIES_SHAYMIN,
    SPECIES_SHAYMIN_SKY, SPECIES_ARCEUS, SPECIES_RESHIRAM, SPECIES_ZEKROM, SPECIES_KYUREM,
    SPECIES_KYUREM_WHITE, SPECIES_KYUREM_BLACK, SPECIES_KELDEO, SPECIES_MELOETTA, SPECIES_MELOETTA_PIROUETTE,
    SPECIES_GENESECT, SPECIES_GRENINJA_BATTLE_BOND, SPECIES_GRENINJA_ASH, SPECIES_XERNEAS, SPECIES_YVELTAL,
    SPECIES_ZYGARDE, SPECIES_ZYGARDE_10, SPECIES_ZYGARDE_COMPLETE, SPECIES_DIANCIE,
    SPECIES_HOOPA, SPECIES_HOOPA_UNBOUND, SPECIES_VOLCANION, SPECIES_COSMOG,
    SPECIES_COSMOEM, SPECIES_SOLGALEO, SPECIES_LUNALA, SPECIES_NECROZMA, SPECIES_NECROZMA_DAWN_WINGS, SPECIES_NECROZMA_DUSK_MANE,
    SPECIES_NECROZMA_ULTRA, SPECIES_MAGEARNA, SPECIES_MARSHADOW, SPECIES_ZERAORA,
    SPECIES_MELTAN, SPECIES_MELMETAL, SPECIES_ZACIAN, SPECIES_ZACIAN_CROWNED_SWORD, SPECIES_ZAMAZENTA,
    SPECIES_ZAMAZENTA_CROWNED_SHIELD, SPECIES_ETERNATUS, SPECIES_ETERNATUS_ETERNAMAX, SPECIES_ZARUDE, SPECIES_CALYREX,
    SPECIES_CALYREX_ICE_RIDER, SPECIES_CALYREX_SHADOW_RIDER, SPECIES_KORAIDON, SPECIES_MIRAIDON, SPECIES_TERAPAGOS,
    SPECIES_TERAPAGOS_TERASTAL, SPECIES_TERAPAGOS_STELLAR, SPECIES_PECHARUNT,
    SPECIES_VENUSAUR_MEGA, SPECIES_CHARIZARD_MEGA_X, SPECIES_CHARIZARD_MEGA_Y, SPECIES_BLASTOISE_MEGA,
    SPECIES_BEEDRILL_MEGA, SPECIES_PIDGEOT_MEGA, SPECIES_ALAKAZAM_MEGA, SPECIES_SLOWBRO_MEGA, SPECIES_GENGAR_MEGA,
    SPECIES_KANGASKHAN_MEGA, SPECIES_PINSIR_MEGA, SPECIES_GYARADOS_MEGA, SPECIES_AERODACTYL_MEGA, SPECIES_MEWTWO_MEGA_X,
    SPECIES_MEWTWO_MEGA_Y, SPECIES_AMPHAROS_MEGA, SPECIES_STEELIX_MEGA, SPECIES_SCIZOR_MEGA, SPECIES_HERACROSS_MEGA,
    SPECIES_HOUNDOOM_MEGA, SPECIES_TYRANITAR_MEGA, SPECIES_SCEPTILE_MEGA, SPECIES_BLAZIKEN_MEGA, SPECIES_SWAMPERT_MEGA,
    SPECIES_GARDEVOIR_MEGA, SPECIES_SABLEYE_MEGA, SPECIES_MAWILE_MEGA, SPECIES_AGGRON_MEGA, SPECIES_MEDICHAM_MEGA,
    SPECIES_MANECTRIC_MEGA, SPECIES_SHARPEDO_MEGA, SPECIES_CAMERUPT_MEGA, SPECIES_ALTARIA_MEGA, SPECIES_BANETTE_MEGA,
    SPECIES_ABSOL_MEGA, SPECIES_GLALIE_MEGA, SPECIES_SALAMENCE_MEGA, SPECIES_METAGROSS_MEGA, SPECIES_LATIAS_MEGA,
    SPECIES_LATIOS_MEGA, SPECIES_LOPUNNY_MEGA, SPECIES_GARCHOMP_MEGA, SPECIES_LUCARIO_MEGA, SPECIES_ABOMASNOW_MEGA,
    SPECIES_GALLADE_MEGA, SPECIES_AUDINO_MEGA, SPECIES_DIANCIE_MEGA, SPECIES_RAYQUAZA_MEGA,
    SPECIES_CLEFABLE_MEGA, SPECIES_VICTREEBEL_MEGA, SPECIES_STARMIE_MEGA, SPECIES_DRAGONITE_MEGA, SPECIES_MEGANIUM_MEGA,
    SPECIES_FERALIGATR_MEGA, SPECIES_SKARMORY_MEGA, SPECIES_FROSLASS_MEGA, SPECIES_EMBOAR_MEGA, SPECIES_EXCADRILL_MEGA,
    SPECIES_SCOLIPEDE_MEGA, SPECIES_SCRAFTY_MEGA, SPECIES_EELEKTROSS_MEGA, SPECIES_CHANDELURE_MEGA, SPECIES_CHESNAUGHT_MEGA,
    SPECIES_DELPHOX_MEGA, SPECIES_GRENINJA_MEGA, SPECIES_PYROAR_MEGA, SPECIES_FLOETTE_MEGA, SPECIES_MALAMAR_MEGA,
    SPECIES_BARBARACLE_MEGA, SPECIES_DRAGALGE_MEGA, SPECIES_HAWLUCHA_MEGA, SPECIES_ZYGARDE_MEGA, SPECIES_DRAMPA_MEGA,
    SPECIES_FALINKS_MEGA, SPECIES_RAICHU_MEGA_X, SPECIES_RAICHU_MEGA_Y, SPECIES_CHIMECHO_MEGA, SPECIES_ABSOL_MEGA_Z,
    SPECIES_STARAPTOR_MEGA, SPECIES_GARCHOMP_MEGA_Z, SPECIES_LUCARIO_MEGA_Z, SPECIES_HEATRAN_MEGA, SPECIES_DARKRAI_MEGA,
    SPECIES_GOLURK_MEGA, SPECIES_MEOWSTIC_MEGA, SPECIES_CRABOMINABLE_MEGA, SPECIES_GOLISOPOD_MEGA, SPECIES_MAGEARNA_MEGA,
    SPECIES_ZERAORA_MEGA, SPECIES_SCOVILLAIN_MEGA, SPECIES_GLIMMORA_MEGA, SPECIES_TATSUGIRI_MEGA, SPECIES_BAXCALIBUR_MEGA,
    SPECIES_MEOWSTIC_FEMALE_MEGA, SPECIES_CASTFORM_SUNNY, SPECIES_CASTFORM_RAINY, SPECIES_CASTFORM_SNOWY, SPECIES_CHERRIM_SUNSHINE,
    SPECIES_DARMANITAN_ZEN_MODE, SPECIES_DARMANITAN_ZEN_MODE_GALARIAN, SPECIES_AEGISLASH_BLADE, SPECIES_WISHIWASHI_SCHOOL,
    SPECIES_MINIOR_CORE_RED, SPECIES_EISCUE_NOICE_FACE, SPECIES_MORPEKO_HANGRY, SPECIES_PALAFIN_HERO,
    SPECIES_OGERPON_WELLSPRING, SPECIES_OGERPON_HEARTHFLAME, SPECIES_OGERPON_CORNERSTONE, 0xFFFF
};
