...
static bool8 Task_ProcessSoundCheckMenuInput(u8 taskId) // sub_080E8688
{
    ...
    else if (JOY_REPEAT(DPAD_LEFT))
    {
        ...
        else
        {
            if (gTasks[taskId].tBgmIndex > 0)
                ...
                gTasks[taskId].tBgmIndex = (B2_SEQ_BGM_THEEND - (MUS_LITTLEROOT_TEST - 1));
        }
        return TRUE;
    }
    else if (JOY_REPEAT(DPAD_RIGHT))
    {
        ...
        {
            if (gTasks[taskId].tBgmIndex < (B2_SEQ_BGM_THEEND - (MUS_LITTLEROOT_TEST - 1)))
                gTasks[taskId].tBgmIndex++;
            else
                gTasks[taskId].tBgmIndex = 0;
        }
...
#define SOUND_LIST_BGM \
    ...
    X(B2_SEQ_BGM_TITLE01           , "B2-SEQ-BGM-TITLE01") \
    X(B2_SEQ_BGM_SW_DEMO_OPENING   , "B2-SEQ-BGM-SW-DEMO-OPENING") \
    X(B2_SEQ_BGM_SW_C_12           , "B2-SEQ-BGM-SW-C-12") \
    X(B2_SEQ_BGM_E_BERU            , "B2-SEQ-BGM-E-BERU") \
    X(B2_SEQ_BGM_SW_R_19_SP        , "B2-SEQ-BGM-SW-R-19-SP") \
    X(B2_SEQ_BGM_SW_R_19_SU        , "B2-SEQ-BGM-SW-R-19-SU") \
    X(B2_SEQ_BGM_SW_R_19_AU        , "B2-SEQ-BGM-SW-R-19-AU") \
    X(B2_SEQ_BGM_SW_R_19_WI        , "B2-SEQ-BGM-SW-R-19-WI") \
    X(B2_SEQ_BGM_VS_NORAPOKE       , "B2-SEQ-BGM-VS-NORAPOKE") \
    X(B2_SEQ_BGM_SW_T_06           , "B2-SEQ-BGM-SW-T-06") \
    X(B2_SEQ_BGM_SW_D_22           , "B2-SEQ-BGM-SW-D-22") \
    X(B2_SEQ_BGM_E_HUE             , "B2-SEQ-BGM-E-HUE") \
    X(B2_SEQ_BGM_VS_HUE            , "B2-SEQ-BGM-VS-HUE") \
    X(B2_SEQ_BGM_SW_C_13           , "B2-SEQ-BGM-SW-C-13") \
    X(B2_SEQ_BGM_POISONE_GYM_01    , "B2-SEQ-BGM-POISONE-GYM-01") \
    X(B2_SEQ_BGM_POISONE_GYM_01_JP , "B2-SEQ-BGM-POISONE-GYM-01-JP") \
    ...
    X(B2_SEQ_ME_POKEWOOD           , "B2-SEQ-ME-POKEWOOD") \
    X(B2_SEQ_BGM_SW_D_23           , "B2-SEQ-BGM-SW-D-23") \
    X(B2_SEQ_BGM_INSECT_GYM_01     , "B2-SEQ-BGM-INSECT-GYM-01") \
    X(B2_SEQ_BGM_EYE_CLOWN         , "B2-SEQ-BGM-EYE-CLOWN") \
    X(B2_SEQ_BGM_FES               , "B2-SEQ-BGM-FES") \
    X(B2_SEQ_BGM_E_ACHROMA         , "B2-SEQ-BGM-E-ACHROMA") \
    X(B2_SEQ_BGM_VS_TRAINER        , "B2-SEQ-BGM-VS-TRAINER") \
    X(B2_SEQ_BGM_REZO_RIZO         , "B2-SEQ-BGM-REZO-RIZO") \
    X(B2_SEQ_ME_AVENUE_01          , "B2-SEQ-ME-AVENUE-01") \
    X(B2_SEQ_ME_AVENUE_02          , "B2-SEQ-ME-AVENUE-02") \
    X(B2_SEQ_BGM_JAPARADE          , "B2-SEQ-BGM-JAPARADE") \
    X(B2_SEQ_BGM_ERECTRIC_GYM_01   , "B2-SEQ-BGM-ERECTRIC-GYM-01") \
    X(B2_SEQ_BGM_EYE_DANCER        , "B2-SEQ-BGM-EYE-DANCER") \
    X(B2_SEQ_BGM_ERECTRIC_GYM_02   , "B2-SEQ-BGM-ERECTRIC-GYM-02") \
    X(B2_SEQ_BGM_VS_GYMLEADER      , "B2-SEQ-BGM-VS-GYMLEADER") \
    X(B2_SEQ_BGM_BATTLESUPERIOR    , "B2-SEQ-BGM-BATTLESUPERIOR") \
    X(B2_SEQ_BGM_GROUND_GYM_01     , "B2-SEQ-BGM-GROUND-GYM-01") \
    X(B2_SEQ_BGM_WBT_LOBBY         , "B2-SEQ-BGM-WBT-LOBBY") \
    X(B2_SEQ_BGM_WBT_GROUND        , "B2-SEQ-BGM-WBT-GROUND") \
    X(B2_SEQ_BGM_VS_RG_LEADER      , "B2-SEQ-BGM-VS-RG-LEADER") \
    X(B2_SEQ_BGM_VS_RG_CHAMP       , "B2-SEQ-BGM-VS-RG-CHAMP") \
    X(B2_SEQ_BGM_VS_GS_LEADER      , "B2-SEQ-BGM-VS-GS-LEADER") \
    X(B2_SEQ_BGM_VS_GS_CHAMP       , "B2-SEQ-BGM-VS-GS-CHAMP") \
    X(B2_SEQ_BGM_VS_RS_LEADER      , "B2-SEQ-BGM-VS-RS-LEADER") \
    X(B2_SEQ_BGM_VS_RS_CHAMP       , "B2-SEQ-BGM-VS-RS-CHAMP") \
    X(B2_SEQ_BGM_VS_DP_LEADER      , "B2-SEQ-BGM-VS-DP-LEADER") \
    X(B2_SEQ_BGM_VS_DP_CHAMP       , "B2-SEQ-BGM-VS-DP-CHAMP") \
    X(B2_SEQ_BGM_VS_WBT            , "B2-SEQ-BGM-VS-WBT") \
    X(B2_SEQ_BGM_WIN_WBT           , "B2-SEQ-BGM-WIN-WBT") \
    X(B2_SEQ_BGM_WBT_FANFARE       , "B2-SEQ-BGM-WBT-FANFARE") \
    X(B2_SEQ_BGM_SW_D_REGI         , "B2-SEQ-BGM-SW-D-REGI") \
    X(B2_SEQ_BGM_VS_REGI           , "B2-SEQ-BGM-VS-REGI") \
    X(B2_SEQ_BGM_SW_D_27_F_AJITO   , "B2-SEQ-BGM-SW-D-27-F-AJITO") \
    X(B2_SEQ_BGM_E_7_SAGE          , "B2-SEQ-BGM-E-7-SAGE") \
    X(B2_SEQ_BGM_E_CHEREN          , "B2-SEQ-BGM-E-CHEREN") \
    X(B2_SEQ_BGM_KEMONOMICHI       , "B2-SEQ-BGM-KEMONOMICHI") \
    X(B2_SEQ_BGM_FLIGHT_GYM_01     , "B2-SEQ-BGM-FLIGHT-GYM-01") \
    X(B2_SEQ_ME_MD_FAN03           , "B2-SEQ-ME-MD-FAN03") \
    X(B2_SEQ_ME_MD_FAN01           , "B2-SEQ-ME-MD-FAN01") \
    X(B2_SEQ_BGM_SW_T_07           , "B2-SEQ-BGM-SW-T-07") \
    X(B2_SEQ_BGM_SW_KAZAN          , "B2-SEQ-BGM-SW-KAZAN") \
    X(B2_SEQ_BGM_SW_D_24_B         , "B2-SEQ-BGM-SW-D-24-B") \
    X(B2_SEQ_BGM_SW_D_24_W         , "B2-SEQ-BGM-SW-D-24-W") \
    X(B2_SEQ_BGM_SW_D_25           , "B2-SEQ-BGM-SW-D-25") \
    X(B2_SEQ_BGM_VS_DPLEGEND       , "B2-SEQ-BGM-VS-DPLEGEND") \
    X(B2_SEQ_BGM_DRAGON_GYM_01     , "B2-SEQ-BGM-DRAGON-GYM-01") \
    X(B2_SEQ_BGM_SW_DEMO_AJITO_SHIP, "B2-SEQ-BGM-SW-DEMO-AJITO-SHIP") \
    X(B2_SEQ_BGM_E_C08_ICE         , "B2-SEQ-BGM-E-C08-ICE") \
    X(B2_SEQ_BGM_EYE_NEO_PLASMA    , "B2-SEQ-BGM-EYE-NEO-PLASMA") \
    X(B2_SEQ_BGM_VS_NEO_PLASMA     , "B2-SEQ-BGM-VS-NEO-PLASMA") \
    X(B2_SEQ_BGM_DARK_TRINITY      , "B2-SEQ-BGM-DARK-TRINITY") \
    X(B2_SEQ_BGM_SW_H_06           , "B2-SEQ-BGM-SW-H-06") \
    X(B2_SEQ_BGM_SW_C_14           , "B2-SEQ-BGM-SW-C-14") \
    X(B2_SEQ_BGM_WATER_GYM_01      , "B2-SEQ-BGM-WATER-GYM-01") \
    X(B2_SEQ_BGM_SW_R_22_SP        , "B2-SEQ-BGM-SW-R-22-SP") \
    X(B2_SEQ_BGM_SW_R_22_SU        , "B2-SEQ-BGM-SW-R-22-SU") \
    X(B2_SEQ_BGM_SW_R_22_AU        , "B2-SEQ-BGM-SW-R-22-AU") \
    X(B2_SEQ_BGM_SW_R_22_WI        , "B2-SEQ-BGM-SW-R-22-WI") \
    X(B2_SEQ_BGM_SW_DEMO_FRIGATE   , "B2-SEQ-BGM-SW-DEMO-FRIGATE") \
    X(B2_SEQ_BGM_SW_D_27_L_AJITO   , "B2-SEQ-BGM-SW-D-27-L-AJITO") \
    X(B2_SEQ_BGM_VS_ACHROMA        , "B2-SEQ-BGM-VS-ACHROMA") \
    X(B2_SEQ_BGM_SW_DEMO_UNION_00  , "B2-SEQ-BGM-SW-DEMO-UNION-00") \
    X(B2_SEQ_BGM_SW_DEMO_UNION_01  , "B2-SEQ-BGM-SW-DEMO-UNION-01") \
    X(B2_SEQ_BGM_SW_DEMO_UNION_02  , "B2-SEQ-BGM-SW-DEMO-UNION-02") \
    X(B2_SEQ_BGM_SW_DEMO_UNION_03  , "B2-SEQ-BGM-SW-DEMO-UNION-03") \
    X(B2_SEQ_BGM_VS_KYURAMU        , "B2-SEQ-BGM-VS-KYURAMU") \
    X(B2_SEQ_BGM_VS_NEW_G_CIS      , "B2-SEQ-BGM-VS-NEW-G-CIS") \
    X(B2_SEQ_BGM_SW_R_23           , "B2-SEQ-BGM-SW-R-23") \
    X(B2_SEQ_BGM_SW_D_N_CASTLE     , "B2-SEQ-BGM-SW-D-N-CASTLE") \
    X(B2_SEQ_BGM_SW_D_N_ROOM       , "B2-SEQ-BGM-SW-D-N-ROOM") \
    X(B2_SEQ_BGM_E_N_SWAN          , "B2-SEQ-BGM-E-N-SWAN") \
    ...
    X(B2_SEQ_BGM_VS_IRIS           , "B2-SEQ-BGM-VS-IRIS") \
    X(B2_SEQ_BGM_ENDING            , "B2-SEQ-BGM-ENDING") \
    X(B2_SEQ_BGM_THEEND            , "B2-SEQ-BGM-THEEND") \
