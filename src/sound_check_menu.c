...
#define SOUND_LIST_BGM \
    ...
    X(MUS_BW_TITLE                 , "MUS-BW-INTRO-1") \
    X(MUS_BW_TITLE01               , "MUS-BW-INTRO-2") \
    X(MUS_BW_POKEMON_THEME         , "MUS-BW-TITLE") \
    X(MUS_BW_STARTING              , "MUS-BW-NEW-GAME-1") \
    X(MUS_BW_STARTING2             , "MUS-BW-NEW-GAME-2") \
    X(MUS_BW_SHINKA                , "MUS-BW-EVOLUTION-INTRO") \
    X(MUS_BW_KOUKAN                , "MUS-BW-EVOLUTION") \
    X(MUS_BW_BICYCLE               , "MUS-BW-CYCLING") \
    X(MUS_BW_NAMINORI              , "MUS-BW-SURF") \
    X(MUS_BW_DIVING                , "MUS-BW-UNDERWATER") \
    X(MUS_BW_E_DENDOUIRI           , "MUS-BW-HALL-OF-FAME") \
    X(MUS_BW_ENDING                , "MUS-BW-CREDITS") \
    X(MUS_BW_T_01                  , "MUS-BW-NUVEMA") \
    X(MUS_BW_T_02                  , "MUS-BW-ACCUMULA") \
    X(MUS_BW_T_03                  , "MUS-BW-ANVILLE") \
    X(MUS_BW_T_04                  , "MUS-BW-LACUNOSA") \
    X(MUS_BW_T_05_SP               , "MUS-BW-UNDELLA-WINTER") \
    X(MUS_BW_T_05_SU               , "MUS-BW-UNDELLA-SUMMER") \
    X(MUS_BW_C_01                  , "MUS-BW-STRIATON") \
    X(MUS_BW_C_02                  , "MUS-BW-NACRENE") \
    X(MUS_BW_C_03                  , "MUS-BW-CASTELIA") \
    X(MUS_BW_C_04                  , "MUS-BW-NIMBASA") \
    X(MUS_BW_C_05                  , "MUS-BW-DRIFTVEIL") \
    X(MUS_BW_C_06                  , "MUS-BW-MISTRALTON") \
    X(MUS_BW_C_07                  , "MUS-BW-ICIRRUS") \
    X(MUS_BW_C_08_B                , "MUS-BW-OPELUCID-BLACK") \
    X(MUS_BW_C_08_W                , "MUS-BW-OPELUCID-WHITE") \
    X(MUS_BW_C_10_B                , "MUS-BW-BLACK-CITY") \
    X(MUS_BW_C_10_W                , "MUS-BW-WHITE-FOREST") \
    X(MUS_BW_R_A                   , "MUS-BW-ROUTE1") \
    X(MUS_BW_R_B_SP                , "MUS-BW-ROUTE2-SPRING") \
    X(MUS_BW_R_B_SU                , "MUS-BW-ROUTE2-SUMMER") \
    X(MUS_BW_R_B_AU                , "MUS-BW-ROUTE2-AUTUMN") \
    X(MUS_BW_R_B_WI                , "MUS-BW-ROUTE2-WINTER") \
    X(MUS_BW_R_C_SP                , "MUS-BW-ROUTE4-SPRING") \
    X(MUS_BW_R_C_SU                , "MUS-BW-ROUTE4-SUMMER") \
    X(MUS_BW_R_C_AU                , "MUS-BW-ROUTE4-AUTUMN") \
    X(MUS_BW_R_C_WI                , "MUS-BW-ROUTE4-WINTER") \
    X(MUS_BW_R_D_SP                , "MUS-BW-ROUTE6-SPRING") \
    X(MUS_BW_R_D_SU                , "MUS-BW-ROUTE6-SUMMER") \
    X(MUS_BW_R_D_AU                , "MUS-BW-ROUTE6-AUTUMN") \
    X(MUS_BW_R_D_WI                , "MUS-BW-ROUTE6-WINTER") \
    X(MUS_BW_R_E_SP                , "MUS-BW-ROUTE12-SPRING") \
    X(MUS_BW_R_E_SU                , "MUS-BW-ROUTE12-SUMMER") \
    X(MUS_BW_R_E_AU                , "MUS-BW-ROUTE12-AUTUMN") \
    X(MUS_BW_R_E_WI                , "MUS-BW-ROUTE12-WINTER") \
    X(MUS_BW_R_F                   , "MUS-BW-ROUTE10") \
    X(MUS_BW_H_01                  , "MUS-BW-SKYARROW-BRIDGE") \
    X(MUS_BW_H_02                  , "MUS-BW-DRIFTVEIL-DRAWBRIDGE") \
    X(MUS_BW_H_03                  , "MUS-BW-TUBELINE-BRIDGE") \
    X(MUS_BW_H_04                  , "MUS-BW-VILLAGE-BRIDGE") \
    X(MUS_BW_H_05                  , "MUS-BW-MARVELOUS-BRIDGE") \
    X(MUS_BW_POKECEN               , "MUS-BW-POKE-CENTER") \
    X(MUS_BW_FS                    , "MUS-BW-SHOPPING-MALL-NINE") \
    X(MUS_BW_GYM                   , "MUS-BW-GYM") \
    X(MUS_BW_LABO                  , "MUS-BW-JUNIPER-LAB") \
    X(MUS_BW_GATE                  , "MUS-BW-GATE") \
    X(MUS_BW_GEAR_STATION          , "MUS-BW-GEAR-STATION") \
    X(MUS_BW_BATTLE_SUBWAY         , "MUS-BW-BATTLE-SUBWAY") \
    X(MUS_BW_PALPARK               , "MUS-BW-POKE-TRANSFER-LAB") \
    X(MUS_BW_PLEASURE_BOAT         , "MUS-BW-ROYAL-UNOVA") \
    X(MUS_BW_PALACE                , "MUS-BW-ENTRALINK") \
    X(MUS_BW_PALACE2               , "MUS-BW-SOMEONES-ENTRALINK") \
    X(MUS_BW_UNITED_NATIONS        , "MUS-BW-UNITY-TOWER") \
    ...
    X(MUS_BW_D_01                  , "MUS-BW-DREAMYARD") \
    X(MUS_BW_D_01_B1F              , "MUS-BW-DREAMYARD-B1F") \
    X(MUS_BW_D_02                  , "MUS-BW-CHARGESTONE-CAVE") \
    X(MUS_BW_D_02_B1F              , "MUS-BW-CHARGESTONE-CAVE-B1F") \
    X(MUS_BW_D_02_B2F              , "MUS-BW-CHARGESTONE-CAVE-B2F") \
    X(MUS_BW_D_03                  , "MUS-BW-COLD-STORAGE") \
    X(MUS_BW_D_04                  , "MUS-BW-RELIC-CASTLE") \
    X(MUS_BW_D_05                  , "MUS-BW-DRAGONSPIRAL-TOWER") \
    X(MUS_BW_D_06                  , "MUS-BW-LOSTLORN-FOREST") \
    X(MUS_BW_D_07                  , "MUS-BW-DRAGONSPIRAL-TOWER-TOP") \
    X(MUS_BW_D_CHAMPROAD           , "MUS-BW-VICTORY-ROAD") \
    X(MUS_BW_E_TSURETEKE1          , "MUS-BW-FOLLOW-ME-1") \
    X(MUS_BW_E_TSURETEKE2          , "MUS-BW-FOLLOW-ME-2") \
    X(MUS_BW_E_RIVAL               , "MUS-BW-CHEREN") \
    X(MUS_BW_E_SUPPORT             , "MUS-BW-BIANCA") \
    X(MUS_BW_E_DOCTOR              , "MUS-BW-JUNIPER") \
    X(MUS_BW_E_DOCTOR2             , "MUS-BW-CEDRIC-JUNIPER") \
    X(MUS_BW_E_PLASMA              , "MUS-BW-PLASMA") \
    X(MUS_BW_E_N                   , "MUS-BW-N") \
    X(MUS_BW_E_SAGE                , "MUS-BW-PLASMA-PLOTS") \
    X(MUS_BW_E_G_CIS               , "MUS-BW-GHETSIS") \
    X(MUS_BW_E_INISHIE             , "MUS-BW-RELIC-SONG") \
    X(MUS_BW_E_EMOTION             , "MUS-BW-EMOTION") \
    X(MUS_BW_E_TROUBLE             , "MUS-BW-TROUBLE") \
    X(MUS_BW_E_LAST                , "MUS-BW-FAREWELL") \
    X(MUS_BW_E_HANDSOME            , "MUS-BW-LOOKER") \
    X(MUS_BW_E_CHAMPION            , "MUS-BW-ALDER") \
    X(MUS_BW_E_OPENING             , "MUS-BW-OPENING") \
    X(MUS_BW_E_KANRANSYA           , "MUS-BW-FERRIS-WHEEL") \
    X(MUS_BW_E_N_CASTLE            , "MUS-BW-N-CASTLE-APPEARS") \
    X(MUS_BW_E_LEGEND_BORN         , "MUS-BW-LEGEND-AWAKENS") \
    X(MUS_BW_MSL_FIELD             , "MUS-BW-MUSICAL-THEATER") \
    X(MUS_BW_MSL_DRESSUP           , "MUS-BW-MUSICAL-DRESS-UP") \
    X(MUS_BW_MSL_BEFORE            , "MUS-BW-MUSICAL-BEFORE") \
    X(MUS_BW_MSL_01                , "MUS-BW-MUSICAL-1") \
    X(MUS_BW_MSL_02                , "MUS-BW-MUSICAL-2") \
    X(MUS_BW_MSL_03                , "MUS-BW-MUSICAL-3") \
    X(MUS_BW_MSL_04                , "MUS-BW-MUSICAL-4") \
    X(MUS_BW_EYE_01                , "MUS-BW-ENCOUNTER-BOY") \
    X(MUS_BW_EYE_02                , "MUS-BW-ENCOUNTER-GIRL") \
    X(MUS_BW_EYE_03                , "MUS-BW-ENCOUNTER-TWINS") \
    X(MUS_BW_EYE_04                , "MUS-BW-ENCOUNTER-ACE-TRAINER") \
    X(MUS_BW_EYE_05                , "MUS-BW-ENCOUNTER-ROUGHNECK") \
    X(MUS_BW_EYE_06                , "MUS-BW-ENCOUNTER-LADY") \
    X(MUS_BW_EYE_07                , "MUS-BW-ENCOUNTER-CYCLIST") \
    X(MUS_BW_EYE_08                , "MUS-BW-ENCOUNTER-PSYCHIC") \
    X(MUS_BW_EYE_09                , "MUS-BW-ENCOUNTER-SUSPICIOUS") \
    X(MUS_BW_EYE_10                , "MUS-BW-ENCOUNTER-POKEFAN") \
    X(MUS_BW_EYE_11                , "MUS-BW-ENCOUNTER-HIKER") \
    X(MUS_BW_EYE_12                , "MUS-BW-ENCOUNTER-CLERK") \
    X(MUS_BW_EYE_13                , "MUS-BW-ENCOUNTER-RICH") \
    X(MUS_BW_EYE_PLASMA            , "MUS-BW-ENCOUNTER-PLASMA") \
    X(MUS_BW_VS_NORAPOKE           , "MUS-BW-VS-WILD") \
    X(MUS_BW_VS_TSUYOPOKE          , "MUS-BW-VS-WILD-STRONG") \
    X(MUS_BW_VS_TRAINER            , "MUS-BW-VS-TRAINER") \
    X(MUS_BW_VS_SUBWAY_TRAINER     , "MUS-BW-VS-SUBWAY-TRAINER") \
    X(MUS_BW_VS_GYMLEADER          , "MUS-BW-VS-GYM-LEADER") \
    X(MUS_BW_VS_RIVAL              , "MUS-BW-VS-RIVAL") \
    X(MUS_BW_VS_PLASMA             , "MUS-BW-VS-PLASMA") \
    X(MUS_BW_VS_SHITENNO           , "MUS-BW-VS-ELITE-FOUR") \
    X(MUS_BW_VS_CHAMP              , "MUS-BW-VS-CHAMPION") \
    X(MUS_BW_VS_N                  , "MUS-BW-VS-N") \
    X(MUS_BW_VS_N_2                , "MUS-BW-VS-N-FINAL") \
    X(MUS_BW_VS_G_CIS              , "MUS-BW-VS-GHETSIS") \
    X(MUS_BW_VS_SHIN               , "MUS-BW-VS-RESHIRAM-ZEKROM") \
    X(MUS_BW_VS_RAI                , "MUS-BW-VS-KYUREM") \
    X(MUS_BW_VS_MOVEPOKE           , "MUS-BW-VS-LEGEND") \
    X(MUS_BW_VS_SHIRONA            , "MUS-BW-VS-CYNTHIA") \
    X(MUS_BW_BATTLEPINCH           , "MUS-BW-LOW-HEALTH") \
    X(MUS_BW_BATTLESUPERIOR        , "MUS-BW-GYM-LEADER-LAST-MON") \
    X(MUS_BW_WIN1                  , "MUS-BW-VICTORY-WILD") \
    X(MUS_BW_WIN2                  , "MUS-BW-VICTORY-TRAINER") \
    X(MUS_BW_WIN3                  , "MUS-BW-VICTORY-GYM-LEADER") \
    X(MUS_BW_WIN4                  , "MUS-BW-VICTORY-GHETSIS") \
    X(MUS_BW_WIN5                  , "MUS-BW-VICTORY-CHAMPION") \
    X(MUS_BW_WIFI_ACCESS           , "MUS-BW-WFC") \
    X(MUS_BW_WIFI_PRESENT          , "MUS-BW-MYSTERY-GIFT") \
    X(MUS_BW_GAME_SYNC             , "MUS-BW-GAME-SYNC") \
    X(MUS_BW_GLTERMINAL            , "MUS-BW-GLOBAL-TERMINAL") \
    X(MUS_BW_GURUGURU              , "MUS-BW-SPIN-TRADE") \
    X(MUS_BW_GTS                   , "MUS-BW-GTS") \
    X(MUS_BW_WCS                   , "MUS-BW-WIFI-BATTLE-LOBBY") \
    X(MUS_BW_E_SHIRONA             , "MUS-BW-ENCOUNTER-CYNTHIA") \
    X(MUS_BW_E_FRIEND              , "MUS-BW-CHEREN-BIANCA") \
    X(MUS_BW_E_SOUND_DESIGNER      , "MUS-BW-ROCKET") \
    X(MUS_BW_VS_WCS                , "MUS-BW-VS-WORLD-CHAMPIONSHIPS") \
    X(MUS_BW_E_LEGEND_COME         , "MUS-BW-N-LEGEND-APPEARS") \
    X(MUS_BW_WIN6                  , "MUS-BW-VICTORY-PLASMA") \
    X(MUS_BW_N_ROOM                , "MUS-BW-N-ROOM") \
    X(MUS_BW_GF_LOGO               , "MUS-BW-GAME-FREAK") \
    X(MUS_BW_MSL_DL_MUNNA          , "MUS-BW-MUSICAL-DLC-1") \
    X(MUS_BW_MSL_DL_SMASH          , "MUS-BW-MUSICAL-DLC-2") \
    X(MUS_BW_MSL_DL_FESTA          , "MUS-BW-MUSICAL-DLC-3") \
    X(MUS_BW_MSL_DL_RELIC          , "MUS-BW-MUSICAL-DLC-4") \
    X(MUS_BW_MSL_DL_RUNPA          , "MUS-BW-MUSICAL-DLC-5") \
    X(MUS_BW_ME_ASA                , "MUS-BW-HEAL") \
    X(MUS_BW_ME_LVUP               , "MUS-BW-LEVEL-UP") \
    X(MUS_BW_ME_ITEM               , "MUS-BW-OBTAIN-ITEM") \
    X(MUS_BW_ME_KEYITEM            , "MUS-BW-OBTAIN-KEY-ITEM") \
    X(MUS_BW_ME_SHINKAOME          , "MUS-BW-EVOLVED") \
    X(MUS_BW_ME_BADGE              , "MUS-BW-OBTAIN-BADGE") \
    X(MUS_BW_ME_WAZA               , "MUS-BW-OBTAIN-TMHM") \
    X(MUS_BW_ME_ACCE               , "MUS-BW-OBTAIN-ACCESSORY") \
    X(MUS_BW_ME_WASURE             , "MUS-BW-MOVE-DELETED") \
    X(MUS_BW_ME_KINOMI             , "MUS-BW-OBTAIN-BERRY") \
    X(MUS_BW_ME_HYOUKA1            , "MUS-BW-DEX-RATING-1") \
    X(MUS_BW_ME_HYOUKA2            , "MUS-BW-DEX-RATING-2") \
    X(MUS_BW_ME_HYOUKA3            , "MUS-BW-DEX-RATING-3") \
    X(MUS_BW_ME_HYOUKA4            , "MUS-BW-DEX-RATING-4") \
    X(MUS_BW_ME_HYOUKA5            , "MUS-BW-DEX-RATING-5") \
    X(MUS_BW_ME_HYOUKA6            , "MUS-BW-DEX-RATING-6") \
    X(MUS_BW_ME_TAMAGO_GET         , "MUS-BW-OBTAIN-EGG") \
    X(MUS_BW_ME_BPGET              , "MUS-BW-OBTAIN-B-POINTS") \
    X(MUS_BW_ME_AISHOU_H           , "MUS-BW-FEELING-CHECK-1") \
    X(MUS_BW_ME_AISHOU_M           , "MUS-BW-FEELING-CHECK-2") \
    X(MUS_BW_ME_AISHOU_L           , "MUS-BW-FEELING-CHECK-3") \
    X(MUS_BW_ME_AISHOU_KIDOU       , "MUS-BW-FEELING-CHECK") \
    X(MUS_BW_ME_MISSION_START      , "MUS-BW-MISSION-START") \
    X(MUS_BW_ME_MISSION_CLEAR      , "MUS-BW-MISSION-CLEAR") \
    X(MUS_BW_ME_MISSION_FAILED     , "MUS-BW-MISSION-FAILED") \
    X(MUS_BW_ME_ITEM_MYSTERY       , "MUS-BW-OBTAIN-LIGHT-DARK-STONE") \
    X(MUS_BW_ME_CALL               , "MUS-BW-XTRANSCEIVER-CALL") \
    X(MUS_BW_ME_QUIZ               , "MUS-BW-ME-QUIZ") \
    X(MUS_BW_ME_DEL_POWER          , "MUS-BW-ME-DEL-POWER") \
    X(MUS_BW_PALPARK_BOX           , "MUS-BW-POKE-TRANSFER-BOX") \
    X(MUS_BW_PALPARK_GAME          , "MUS-BW-POKE-TRANSFER-GAME") \
    X(MUS_B2_TITLE01               , "MUS-B2-INTRO") \
    X(MUS_B2_ENDING                , "MUS-B2-CREDITS") \
    X(MUS_B2_GROUND_GYM_01         , "MUS-B2-DRIFTVEIL-GYM") \
    X(MUS_B2_D_N_CASTLE            , "MUS-B2-N-CASTLE") \
    X(MUS_B2_MUGEN_LOBBY_B         , "MUS-B2-BLACK-TOWER-LOBBY") \
    X(MUS_B2_MUGEN_LOBBY_W         , "MUS-B2-WHITE-TREEHOLLOW-LOBBY") \
    X(MUS_B2_MUGEN_D_B             , "MUS-B2-BLACK-TOWER") \
    X(MUS_B2_MUGEN_D_W             , "MUS-B2-WHITE-TREEHOLLOW") \
    X(MUS_B2_E_CHEREN              , "MUS-B2-CHEREN") \
    X(MUS_B2_E_BERU                , "MUS-B2-BIANCA") \
    X(MUS_B2_E_N_SWAN              , "MUS-B2-N") \
    X(MUS_B2_ERECTRIC_GYM_01       , "MUS-B2-NIMBASA-GYM-1") \
    X(MUS_B2_ERECTRIC_GYM_02       , "MUS-B2-NIMBASA-GYM-2") \
    X(MUS_B2_INSECT_GYM_01         , "MUS-B2-CASTELIA-GYM") \
    X(MUS_B2_POISONE_GYM_01        , "MUS-B2-VIRBANK-GYM") \
    X(MUS_B2_POISONE_GYM_01_JP     , "MUS-B2-VIRBANK-GYM-JP") \
    X(MUS_B2_DEMO_OPENING          , "MUS-B2-OPENING") \
    X(MUS_B2_C_12                  , "MUS-B2-ASPERTIA") \
    X(MUS_B2_C_13                  , "MUS-B2-VIRBANK") \
    X(MUS_B2_C_14                  , "MUS-B2-HUMILAU") \
    X(MUS_B2_EYE_NEO_PLASMA        , "MUS-B2-ENCOUNTER-NEO-PLASMA") \
    X(MUS_B2_VS_NORAPOKE           , "MUS-B2-VS-WILD") \
    X(MUS_B2_VS_TRAINER            , "MUS-B2-VS-TRAINER") \
    X(MUS_B2_VS_GYMLEADER          , "MUS-B2-VS-GYM-LEADER") \
    X(MUS_B2_VS_DPLEGEND           , "MUS-B2-VS-SINNOH-LEGEND") \
    X(MUS_B2_VS_SWAN_N             , "MUS-B2-VS-N") \
    X(MUS_B2_VS_UMA                , "MUS-B2-VS-AZELF-MESPRIT-UXIE") \
    X(MUS_B2_VS_REGI               , "MUS-B2-VS-REGI") \
    X(MUS_B2_BATTLESUPERIOR        , "MUS-B2-GYM-LEADER-LAST-MON") \
    X(MUS_B2_D_N_ROOM              , "MUS-B2-N-ROOM") \
    X(MUS_B2_R_19_SP               , "MUS-B2-ROUTE19-SPRING") \
    X(MUS_B2_R_19_SU               , "MUS-B2-ROUTE19-SUMMER") \
    X(MUS_B2_R_19_AU               , "MUS-B2-ROUTE19-AUTUMN") \
    X(MUS_B2_R_19_WI               , "MUS-B2-ROUTE19-WINTER") \
    X(MUS_B2_R_22_SP               , "MUS-B2-ROUTE22-SPRING") \
    X(MUS_B2_R_22_SU               , "MUS-B2-ROUTE22-SUMMER") \
    X(MUS_B2_R_22_AU               , "MUS-B2-ROUTE22-AUTUMN") \
    X(MUS_B2_R_22_WI               , "MUS-B2-ROUTE22-WINTER") \
    X(MUS_B2_R_23                  , "MUS-B2-ROUTE23") \
    X(MUS_B2_KAZAN                 , "MUS-B2-ROAD-TO-REVERSAL-MOUNTAIN") \
    X(MUS_B2_T_06                  , "MUS-B2-FLOCCESY") \
    X(MUS_B2_T_07                  , "MUS-B2-LENTIMAS") \
    X(MUS_B2_D_22                  , "MUS-B2-FLOCCESY-RANCH") \
    X(MUS_B2_D_23                  , "MUS-B2-CASTELIA-SEWERS") \
    X(MUS_B2_D_24_W                , "MUS-B2-REVERSAL-MOUNTAIN-WHITE") \
    X(MUS_B2_D_24_B                , "MUS-B2-REVERSAL-MOUNTAIN-BLACK") \
    X(MUS_B2_D_25                  , "MUS-B2-STRANGE-HOUSE") \
    X(MUS_B2_D_27_F_AJITO          , "MUS-B2-PLASMA-FRIGATE-1") \
    X(MUS_B2_D_27_L_AJITO          , "MUS-B2-PLASMA-FRIGATE-2") \
    X(MUS_B2_D_27_G_AJITO          , "MUS-B2-PLASMA-FRIGATE-3") \
    X(MUS_B2_D_REGI                , "MUS-B2-SEALED-CHAMBER") \
    X(MUS_B2_D_UMA                 , "MUS-B2-CAVE-OF-BEING") \
    X(MUS_B2_H_06                  , "MUS-B2-MARINE-TUBE") \
    X(MUS_B2_WBT_LOBBY             , "MUS-B2-PWT-LOBBY") \
    X(MUS_B2_WBT_GROUND            , "MUS-B2-PWT") \
    X(MUS_B2_WBT_FANFARE           , "MUS-B2-PWT-WINNER") \
    X(MUS_B2_PW_LAND               , "MUS-B2-POKESTAR-STUDIOS") \
    X(MUS_B2_PW_FILMING            , "MUS-B2-POKESTAR-STUDIOS-FILMING") \
    X(MUS_B2_PW_SCENARIO_01_F      , "MUS-B2-POKESTAR-STUDIOS-BATTLE") \
    X(MUS_B2_PW_SCENARIO_01_L      , "MUS-B2-POKESTAR-STUDIOS-GLORY") \
    X(MUS_B2_PW_SCENARIO_02_F      , "MUS-B2-POKESTAR-STUDIOS-DEFEAT") \
    X(MUS_B2_PW_SCENARIO_02_L      , "MUS-B2-POKESTAR-STUDIOS-INVASION") \
    X(MUS_B2_PW_SCENARIO_03_F      , "MUS-B2-POKESTAR-STUDIOS-SUCCESS") \
    X(MUS_B2_PW_SCENARIO_03_L      , "MUS-B2-POKESTAR-STUDIOS-RETREAT") \
    X(MUS_B2_PW_SCENARIO_04_F      , "MUS-B2-POKESTAR-STUDIOS-WEIRD") \
    X(MUS_B2_PW_SCENARIO_04_L      , "MUS-B2-POKESTAR-STUDIOS-LOVE") \
    X(MUS_B2_PW_SCENARIO_05_F      , "MUS-B2-POKESTAR-STUDIOS-SORROW") \
    X(MUS_B2_PW_SCENARIO_05_L      , "MUS-B2-POKESTAR-STUDIOS-HORROR") \
    X(MUS_B2_PW_SCENARIO_06_F      , "MUS-B2-POKESTAR-STUDIOS-PURIFIED") \
    X(MUS_B2_PW_SCENARIO_06_L      , "MUS-B2-POKESTAR-STUDIOS-FEAR") \
    X(MUS_B2_PW_SCENARIO_07_F      , "MUS-B2-POKESTAR-STUDIOS-HUMOR") \
    X(MUS_B2_PW_SCENARIO_07_L      , "MUS-B2-POKESTAR-STUDIOS-DESPAIR") \
    X(MUS_B2_PW_SCENARIO_08_F      , "MUS-B2-POKESTAR-STUDIOS-SHOCK") \
    X(MUS_B2_FLIGHT_GYM_01         , "MUS-B2-MISTRALTON-GYM") \
    X(MUS_B2_WATER_GYM_01          , "MUS-B2-HUMILAU-GYM") \
    X(MUS_B2_DRAGON_GYM_01         , "MUS-B2-OPELUCID-GYM") \
    X(MUS_B2_LCG_01                , "MUS-B2-XTRANSCEIVER-MINIGAMES") \
    X(MUS_B2_DATA_CONV             , "MUS-B2-UNOVA-LINK") \
    X(MUS_B2_REZO_RIZO             , "MUS-B2-JOIN-AVENUE") \
    X(MUS_B2_FES                   , "MUS-B2-FUNFEST-MISSION") \
    X(MUS_B2_DEMO_UNION_00         , "MUS-B2-KYUREM-SCENE-1") \
    X(MUS_B2_DEMO_UNION_01         , "MUS-B2-KYUREM-SCENE-2") \
    X(MUS_B2_DEMO_UNION_02         , "MUS-B2-KYUREM-SCENE-3") \
    X(MUS_B2_DEMO_UNION_03         , "MUS-B2-KYUREM-SCENE-4") \
    X(MUS_B2_DEMO_AJITO_SHIP       , "MUS-B2-OPELUCID-ATTACKED") \
    X(MUS_B2_DEMO_FRIGATE          , "MUS-B2-PLASMA-FRIGATE-SCENE") \
    X(MUS_B2_E_HUE                 , "MUS-B2-RIVAL") \
    X(MUS_B2_E_ACHROMA             , "MUS-B2-COLRESS") \
    X(MUS_B2_DARK_TRINITY          , "MUS-B2-SHADOW-TRIAD") \
    X(MUS_B2_E_7_SAGE              , "MUS-B2-ZINZOLIN") \
    X(MUS_B2_E_C08_ICE             , "MUS-B2-OPELUCID-FROZEN") \
    X(MUS_B2_EYE_DANCER            , "MUS-B2-ENCOUNTER-BEAUTY") \
    X(MUS_B2_EYE_CLOWN             , "MUS-B2-ENCOUNTER-CLOWN") \
    X(MUS_B2_VS_RG_LEADER          , "MUS-B2-VS-LEADER-KANTO") \
    X(MUS_B2_VS_RG_CHAMP           , "MUS-B2-VS-CHAMPION-KANTO") \
    X(MUS_B2_VS_GS_LEADER          , "MUS-B2-VS-LEADER-JOHTO") \
    X(MUS_B2_VS_GS_CHAMP           , "MUS-B2-VS-CHAMPION-JOHTO") \
    X(MUS_B2_VS_RS_LEADER          , "MUS-B2-VS-LEADER-HOENN") \
    X(MUS_B2_VS_RS_CHAMP           , "MUS-B2-VS-CHAMPION-HOENN") \
    X(MUS_B2_VS_DP_LEADER          , "MUS-B2-VS-LEADER-SINNOH") \
    X(MUS_B2_VS_DP_CHAMP           , "MUS-B2-VS-CHAMPION-SINNOH") \
    X(MUS_B2_VS_WBT                , "MUS-B2-VS-PWT-FINALS") \
    X(MUS_B2_VS_KYURAMU            , "MUS-B2-VS-BLACK-WHITE-KYUREM") \
    X(MUS_B2_VS_NEO_PLASMA         , "MUS-B2-VS-NEO-PLASMA") \
    X(MUS_B2_VS_ACHROMA            , "MUS-B2-VS-COLRESS") \
    X(MUS_B2_VS_NEW_G_CIS          , "MUS-B2-VS-GHETSIS") \
    X(MUS_B2_VS_IRIS               , "MUS-B2-VS-IRIS") \
    X(MUS_B2_VS_HUE                , "MUS-B2-VS-RIVAL") \
    X(MUS_B2_WIN_WBT               , "MUS-B2-VICTORY-PWT") \
    X(MUS_B2_KEMONOMICHI           , "MUS-B2-HIDDEN-GROTTO") \
    X(MUS_B2_JAPARADE              , "MUS-B2-JOIN-AVENUE-GREETING") \
    X(MUS_B2_E_PLASMA              , "MUS-B2-NEO-PLASMA") \
    X(MUS_B2_THEEND                , "MUS-B2-END") \
    X(MUS_B2_ME_LCG_01             , "MUS-B2-XTRANSCEIVER-GAME-START") \
    X(MUS_B2_ME_LCG_02             , "MUS-B2-XTRANSCEIVER-GAME-WIN") \
    X(MUS_B2_ME_LCG_03             , "MUS-B2-XTRANSCEIVER-03") \
    X(MUS_B2_ME_LCG_04             , "MUS-B2-XTRANSCEIVER-04") \
    X(MUS_B2_ME_MD_FAN01           , "MUS-B2-MEDAL-BOX-UPGRADED") \
    X(MUS_B2_ME_MD_FAN03           , "MUS-B2-PARTICIPATION-MEDAL") \
    X(MUS_B2_ME_MD_FAN04           , "MUS-B2-METAL-RALLY-COMPLETE") \
    X(MUS_B2_ME_OTAMARO            , "MUS-B2-TYMPOLE-CHOIR") \
    X(MUS_B2_ME_AVENUE_01          , "MUS-B2-JOIN-AVENUE-RANK-UP-1") \
    X(MUS_B2_ME_AVENUE_02          , "MUS-B2-JOIN-AVENUE-RANK-UP-2") \
    X(MUS_B2_ME_AVENUE_03          , "MUS-B2-JOIN-AVENUE-RAFFLE") \
    X(MUS_B2_ME_CALL_LONG          , "MUS-B2-XTRANSCEIVER-CALL-LONG") \
    X(MUS_B2_ME_ZUKAN_01           , "MUS-B2-HABITAT-LIST-1") \
    X(MUS_B2_ME_ZUKAN_02           , "MUS-B2-HABITAT-LIST-2") \
    X(MUS_B2_ME_POKEWOOD           , "MUS-B2-POKESTAR-FANFARE") \
    X(MUS_WHAT   , "MUS-WHAT") \
