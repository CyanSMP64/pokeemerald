...
#define SOUND_LIST_BGM \
    ...
    X(MUS_DP_ROAD_D_D              , "MUS-DP-ROUTE206-DAY") \
    X(MUS_DP_ROAD_E_D              , "MUS-DP-ROUTE209-DAY") \
    X(MUS_DP_ROAD_F_D              , "MUS-DP-ROUTE210-DAY") \
    X(MUS_DP_ROAD_SNOW_D           , "MUS-DP-ROUTE216-DAY") \
    X(MUS_DP_ROAD_BZA_D            , "MUS-DP-ROUTE228-DAY") \
    X(MUS_DP_OPENING               , "MUS-DP-ROWAN") \
    X(MUS_DP_TV_HOUSOU             , "MUS-DP-TV-BROADCAST") \
    X(MUS_DP_TOWN01_N              , "MUS-DP-TWINLEAF-NIGHT") \
    X(MUS_DP_TOWN02_N              , "MUS-DP-SANDGEM-NIGHT") \
    X(MUS_DP_TOWN03_N              , "MUS-DP-FLOAROMA-NIGHT") \
    X(MUS_DP_TOWN04_N              , "MUS-DP-SOLACEON-NIGHT") \
    X(MUS_DP_TOWN06_N              , "MUS-DP-ROUTE225-NIGHT") \
    X(MUS_DP_TOWN07_N              , "MUS-DP-VALOR-LAKEFRONT-NIGHT") \
    X(MUS_DP_CITY01_N              , "MUS-DP-JUBILIFE-NIGHT") \
    X(MUS_DP_CITY02_N              , "MUS-DP-CANALAVE-NIGHT") \
    X(MUS_DP_CITY03_N              , "MUS-DP-OREBURGH-NIGHT") \
    X(MUS_DP_CITY04_N              , "MUS-DP-ETERNA-NIGHT") \
    X(MUS_DP_CITY05_N              , "MUS-DP-HEARTHOME-NIGHT") \
    X(MUS_DP_CITY07_N              , "MUS-DP-VEILSTONE-NIGHT") \
    X(MUS_DP_CITY08_N              , "MUS-DP-SUNYSHORE-NIGHT") \
    X(MUS_DP_CITY09_N              , "MUS-DP-SNOWPOINT-NIGHT") \
    X(MUS_DP_CITY10_N              , "MUS-DP-POKEMON-LEAGUE-NIGHT") \
    X(MUS_DP_CITY11_N              , "MUS-DP-FIGHT-AREA-NIGHT") \
    X(MUS_DP_ROAD_A_N              , "MUS-DP-ROUTE201-NIGHT") \
    X(MUS_DP_ROAD_B_N              , "MUS-DP-ROUTE203-NIGHT") \
    X(MUS_DP_ROAD_C_N              , "MUS-DP-ROUTE205-NIGHT") \
    X(MUS_DP_ROAD_D_N              , "MUS-DP-ROUTE206-NIGHT") \
    X(MUS_DP_ROAD_E_N              , "MUS-DP-ROUTE209-NIGHT") \
    X(MUS_DP_ROAD_F_N              , "MUS-DP-ROUTE210-NIGHT") \
    X(MUS_DP_ROAD_SNOW_N           , "MUS-DP-ROUTE216-NIGHT") \
    X(MUS_DP_ROAD_BZA_N            , "MUS-DP-ROUTE228-NIGHT") \
    X(MUS_DP_TANKOU                , "MUS-DP-UNDERGROUND") \
    X(MUS_DP_HATANIGE              , "MUS-DP-FLAG-CAPTURED") \
    X(MUS_DP_D_01                  , "MUS-DP-VICTORY-ROAD") \
    X(MUS_DP_D_02                  , "MUS-DP-ETERNA-FOREST") \
    X(MUS_DP_D_03                  , "MUS-DP-OLD-CHATEAU") \
    X(MUS_DP_D_RYAYHY              , "MUS-DP-LAKE-CAVERNS") \
    X(MUS_DP_D_KOUEN               , "MUS-DP-AMITY-SQUARE") \
    X(MUS_DP_D_AGITO               , "MUS-DP-GALACTIC-HQ") \
    X(MUS_DP_D_GINLOBBY            , "MUS-DP-GALACTIC-ETERNA-BUILDING") \
    X(MUS_DP_D_SAFARI              , "MUS-DP-GREAT-MARSH") \
    X(MUS_DP_D_LAKE                , "MUS-DP-LAKE") \
    X(MUS_DP_D_MOUNT1              , "MUS-DP-MT-CORONET") \
    X(MUS_DP_D_MOUNT2              , "MUS-DP-SPEAR-PILLAR") \
    X(MUS_DP_D_06                  , "MUS-DP-STARK-MOUNTAIN") \
    X(MUS_DP_D_05                  , "MUS-DP-OREBURGH-GATE") \
    X(MUS_DP_D_04                  , "MUS-DP-OREBURGH-MINE") \
    X(MUS_DP_D_LEAGUE              , "MUS-DP-INSIDE-POKEMON-LEAGUE") \
    X(MUS_DP_BLD_DENDO             , "MUS-DP-HALL-OF-FAME-ROOM") \
    X(MUS_DP_PC_01                 , "MUS-DP-POKE-CENTER-DAY") \
    X(MUS_DP_PC_02                 , "MUS-DP-POKE-CENTER-NIGHT") \
    X(MUS_DP_GYM                   , "MUS-DP-GYM") \
    X(MUS_DP_KENKYUJO              , "MUS-DP-ROWAN-LAB") \
    X(MUS_DP_BLD_CON               , "MUS-DP-CONTEST-LOBBY") \
    X(MUS_DP_FS                    , "MUS-DP-POKE-MART") \
    X(MUS_DP_BLD_GAME              , "MUS-DP-GAME-CORNER") \
    X(MUS_DP_BF_TOWWER             , "MUS-DP-B-TOWER") \
    X(MUS_DP_BLD_TV                , "MUS-DP-TV-STATION") \
    X(MUS_DP_THE_EVENT04           , "MUS-DP-GALACTIC-HQ-BASEMENT") \
    X(MUS_DP_FUE                   , "MUS-DP-AZURE-FLUTE") \
    X(MUS_DP_AUS                   , "MUS-DP-HALL-OF-ORIGIN") \
    X(MUS_DP_BLD_BLD_GTC           , "MUS-DP-GTS") \
    X(MUS_DP_EYE_BOY               , "MUS-DP-ENCOUNTER-BOY") \
    X(MUS_DP_EYE_KID               , "MUS-DP-ENCOUNTER-TWINS") \
    X(MUS_DP_EYE_FIGHT             , "MUS-DP-ENCOUNTER-INTENSE") \
    X(MUS_DP_EYE_GINGA             , "MUS-DP-ENCOUNTER-GALACTIC") \
    X(MUS_DP_EYE_LADY              , "MUS-DP-ENCOUNTER-LADY") \
    X(MUS_DP_EYE_MOUNT             , "MUS-DP-ENCOUNTER-HIKER") \
    X(MUS_DP_EYE_RICH              , "MUS-DP-ENCOUNTER-RICH") \
    X(MUS_DP_EYE_ENKA              , "MUS-DP-ENCOUNTER-SAILOR") \
    X(MUS_DP_EYE_MYS               , "MUS-DP-ENCOUNTER-SUSPICIOUS") \
    X(MUS_DP_EYE_ELITE             , "MUS-DP-ENCOUNTER-ACE-TRAINER") \
    X(MUS_DP_EYE_GIRL              , "MUS-DP-ENCOUNTER-GIRL") \
    X(MUS_DP_EYE_SPORT             , "MUS-DP-ENCOUNTER-CYCLIST") \
    X(MUS_DP_EYE_FUN               , "MUS-DP-ENCOUNTER-ARTIST") \
    X(MUS_DP_EYE_TENNO             , "MUS-DP-ENCOUNTER-ELITE-FOUR") \
    X(MUS_DP_EYE_CHAMP             , "MUS-DP-ENCOUNTER-CHAMPION") \
    X(MUS_DP_BA_POKE               , "MUS-DP-VS-WILD") \
    X(MUS_DP_BA_GYM                , "MUS-DP-VS-GYM-LEADER") \
    X(MUS_DP_BA_DPOKE1             , "MUS-DP-VS-UXIE-MESPRIT-AZELF") \
    X(MUS_DP_BA_TRAIN              , "MUS-DP-VS-TRAINER") \
    X(MUS_DP_BA_AGAKI              , "MUS-DP-VS-GALACTIC-BOSS") \
    X(MUS_DP_BA_DPOKE2             , "MUS-DP-VS-DIALGA-PALKIA") \
    X(MUS_DP_BA_CHANP              , "MUS-DP-VS-CHAMPION") \
    X(MUS_DP_BA_GINGA              , "MUS-DP-VS-GALACTIC") \
    X(MUS_DP_BA_RIVAL              , "MUS-DP-VS-RIVAL") \
    X(MUS_DP_BA_SECRET1            , "MUS-DP-VS-ARCEUS") \
    X(MUS_DP_BA_SECRET2            , "MUS-DP-VS-LEGEND") \
    X(MUS_DP_WINPOKE               , "MUS-DP-VICTORY-WILD") \
    X(MUS_DP_WINTRAIN              , "MUS-DP-VICTORY-TRAINER") \
    X(MUS_DP_WINTGYM               , "MUS-DP-VICTORY-GYM-LEADER") \
    X(MUS_DP_WINCHAMP              , "MUS-DP-VICTORY-CHAMPION") \
    X(MUS_DP_WINGINGA              , "MUS-DP-VICTORY-GALACTIC") \
    X(MUS_DP_WINTENNO              , "MUS-DP-VICTORY-ELITE-FOUR") \
    X(MUS_DP_BA_GINGA3             , "MUS-DP-VS-GALACTIC-COMMANDER") \
    X(MUS_DP_CON_TEST              , "MUS-DP-CONTEST") \
    X(MUS_DP_BA_TENNO              , "MUS-DP-VS-ELITE-FOUR") \
    X(MUS_DP_TSURETEKE             , "MUS-DP-FOLLOW-ME") \
    X(MUS_DP_THE_RIV               , "MUS-DP-RIVAL") \
    X(MUS_DP_THE_EVENT01           , "MUS-DP-LAKE-EVENT") \
    X(MUS_DP_SHINKA                , "MUS-DP-EVOLUTION") \
    X(MUS_DP_THE_BOY               , "MUS-DP-LUCAS") \
    X(MUS_DP_THE_GIRL              , "MUS-DP-DAWN") \
    X(MUS_DP_THE_EVENT02           , "MUS-DP-LEGEND-APPEARS") \
    X(MUS_DP_THE_EVENT03           , "MUS-DP-CATASTROPHE") \
    X(MUS_DP_KUSAGASA              , "MUS-DP-POKE-RADAR") \
    X(MUS_DP_NAMINORI              , "MUS-DP-SURF") \
    X(MUS_DP_BICYCLE               , "MUS-DP-CYCLING") \
    X(MUS_DP_GONIN                 , "MUS-DP-LETS-GO-TOGETHER") \
    X(MUS_DP_TV_END                , "MUS-DP-TV-END") \
    X(MUS_DP_FANFA1                , "MUS-DP-LEVEL-UP") \
    X(MUS_DP_FANFA5                , "MUS-DP-EVOLVED") \
    X(MUS_DP_FANFA3                , "MUS-DP-OBTAIN-KEY-ITEM") \
    X(MUS_DP_FANFA4                , "MUS-DP-OBTAIN-ITEM") \
    X(MUS_DP_FANFA6                , "MUS-DP-CAUGHT-INTRO") \
    X(MUS_DP_FANFA2                , "MUS-DP-DEX-RATING") \
    X(MUS_DP_BADGE                 , "MUS-DP-OBTAIN-BADGE") \
    X(MUS_DP_POCKETCH              , "MUS-DP-POKETCH") \
    X(MUS_DP_WAZA                  , "MUS-DP-OBTAIN-TMHM") \
    X(MUS_DP_ACCE                  , "MUS-DP-OBTAIN-ACCESSORY") \
    X(MUS_DP_WASURE                , "MUS-DP-MOVE-DELETED") \
    X(MUS_DP_ASA                   , "MUS-DP-HEAL") \
    X(MUS_DP_KINOMI                , "MUS-DP-OBTAIN-BERRY") \
    X(MUS_DP_CO_DRESS              , "MUS-DP-CONTEST-DRESS-UP") \
    X(MUS_DP_BLD_EV_DENDO2         , "MUS-DP-HALL-OF-FAME") \
    X(MUS_DP_TITLE00               , "MUS-DP-INTRO") \
    X(MUS_DP_TITLE01               , "MUS-DP-TITLE") \
    X(MUS_DP_PRESENT               , "MUS-DP-MYSTERY-GIFT") \
    X(MUS_DP_WIFILOBBY             , "MUS-DP-WFC") \
    X(MUS_DP_CO_KASHI              , "MUS-DP-DANCE-EASY") \
    X(MUS_DP_CO_TAKUMA             , "MUS-DP-DANCE-DIFFICULT") \
    X(MUS_DP_CO_KEKKA              , "MUS-DP-CONTEST-RESULTS") \
    X(MUS_DP_CO_FANFA              , "MUS-DP-CONTEST-WINNER") \
    X(MUS_DP_KINOMI1               , "MUS-DP-POFFINS") \
    X(MUS_DP_SLOT_ATARI            , "MUS-DP-SLOTS-WIN") \
    X(MUS_DP_SLOT_OOATARI          , "MUS-DP-SLOTS-JACKPOT") \
    X(MUS_DP_BLD_ENDING            , "MUS-DP-CREDITS") \
    X(MUS_DP_SLOT                  , "MUS-DP-SLOTS-UNUSED") \
    X(MUS_PL_CITY11_D              , "MUS-PL-FIGHT-AREA-DAY") \
    X(MUS_PL_TV_HOUSOU             , "MUS-PL-TV-BROADCAST") \
    X(MUS_PL_TV_END                , "MUS-PL-TV-END") \
    X(MUS_PL_TITLE00               , "MUS-PL-INTRO") \
    X(MUS_PL_TITLE01               , "MUS-PL-TITLE") \
    X(MUS_PL_D_GIRATINA            , "MUS-PL-DISTORTION-WORLD") \
    X(MUS_PL_BF_ROULETTE           , "MUS-PL-B-ARCADE") \
    X(MUS_PL_BF_STAGE              , "MUS-PL-B-HALL") \
    X(MUS_PL_BF_CASTLE             , "MUS-PL-B-CASTLE") \
    X(MUS_PL_BF_FACTORY            , "MUS-PL-B-FACTORY") \
    X(MUS_PL_WIFITOWER             , "MUS-PL-GLOBAL-TERMINAL") \
    X(MUS_PL_AUDIO                 , "MUS-PL-LILYCOVE-BOSSA-NOVA") \
    X(MUS_PL_HANDSOME              , "MUS-PL-LOOKER") \
    X(MUS_PL_BA_GIRA               , "MUS-PL-VS-GIRATINA") \
    X(MUS_PL_BA_BRAIN              , "MUS-PL-VS-FRONTIER-BRAIN") \
    X(MUS_PL_WINBRAIN              , "MUS-PL-VICTORY-FRONTIER-BRAIN") \
    X(MUS_PL_BA_REGI               , "MUS-PL-VS-REGI") \
    X(MUS_PL_MTKAKKO               , "MUS-PL-CONTEST-COOL") \
    X(MUS_PL_MTKASHI               , "MUS-PL-CONTEST-SMART") \
    X(MUS_PL_MTKAWA                , "MUS-PL-CONTEST-CUTE") \
    X(MUS_PL_MTTAKMA               , "MUS-PL-CONTEST-TOUGH") \
    X(MUS_PL_MTUTSUK               , "MUS-PL-CONTEST-BEAUTY") \
    X(MUS_PL_GURUGURU              , "MUS-PL-SPIN-TRADE") \
    X(MUS_PL_WIFIGAME              , "MUS-PL-WIFI-MINIGAMES") \
    X(MUS_PL_WIFIUNION             , "MUS-PL-WIFI-PLAZA") \
    X(MUS_PL_WIFIPARADE            , "MUS-PL-WIFI-PARADE") \
    X(MUS_PL_EV_GIRA               , "MUS-PL-GIRATINA-APPEARS-1") \
    X(MUS_PL_EV_GIRA2              , "MUS-PL-GIRATINA-APPEARS-2") \
    X(MUS_PL_PTHAIFU               , "MUS-PL-MYSTERY-GIFT") \
    X(MUS_PL_TOWN02                , "MUS-PL-TWINLEAF-MUSIC-BOX") \
    X(MUS_PL_DON2                  , "MUS-PL-OBTAIN-ARCADE-POINTS") \
    X(MUS_PL_FRO                   , "MUS-PL-OBTAIN-CASTLE-POINTS") \
    X(MUS_PL_POINTGET3             , "MUS-PL-OBTAIN-B-POINTS") \
    X(MUS_PL_WINMINI2              , "MUS-PL-WIN-MINIGAME") \
    X(MUS_HG_TITLE                 , "MUS-HG-INTRO") \
    X(MUS_HG_POKEMON_THEME         , "MUS-HG-TITLE") \
    X(MUS_HG_STARTING              , "MUS-HG-NEW-GAME") \
    X(MUS_HG_SHINKA                , "MUS-HG-EVOLUTION") \
    X(MUS_HG_KOUKAN                , "MUS-HG-EVOLUTION-NO-INTRO") \
    X(MUS_HG_BICYCLE               , "MUS-HG-CYCLING") \
    X(MUS_HG_NAMINORI              , "MUS-HG-SURF") \
    X(MUS_HG_E_DENDOURIRI          , "MUS-HG-HALL-OF-FAME") \
    X(MUS_HG_ENDING                , "MUS-HG-CREDITS") \
    X(MUS_HG_ENDING2               , "MUS-HG-END") \
    X(MUS_HG_T_WAKABA              , "MUS-HG-NEW-BARK") \
    X(MUS_HG_C_YOSHINO             , "MUS-HG-CHERRYGROVE") \
    X(MUS_HG_C_KIKYOU              , "MUS-HG-VIOLET") \
    X(MUS_HG_T_HIWADA              , "MUS-HG-AZALEA") \
    X(MUS_HG_C_KOGANE              , "MUS-HG-GOLDENROD") \
    X(MUS_HG_C_ENJU                , "MUS-HG-ECRUTEAK") \
    X(MUS_HG_C_TANBA               , "MUS-HG-CIANWOOD") \
    X(MUS_HG_R_1_29                , "MUS-HG-ROUTE29") \
    X(MUS_HG_R_1_30                , "MUS-HG-ROUTE30") \
    X(MUS_HG_R_4_34                , "MUS-HG-ROUTE34") \
    X(MUS_HG_R_6_38                , "MUS-HG-ROUTE38") \
    X(MUS_HG_R_7_42                , "MUS-HG-ROUTE42") \
    X(MUS_HG_C_KUCHIBA             , "MUS-HG-VERMILION") \
    X(MUS_HG_C_YAMABUKI            , "MUS-HG-PEWTER") \
    X(MUS_HG_C_HANADA              , "MUS-HG-CERULEAN") \
    X(MUS_HG_T_CHION               , "MUS-HG-LAVENDER") \
    X(MUS_HG_C_TAMAMUSHI           , "MUS-HG-CELADON") \
    X(MUS_HG_T_MASARA              , "MUS-HG-PALLET") \
    X(MUS_HG_T_GUREN               , "MUS-HG-CINNABAR") \
    X(MUS_HG_R_9_01                , "MUS-HG-ROUTE1") \
    X(MUS_HG_R_9_03                , "MUS-HG-ROUTE3") \
    X(MUS_HG_R_10_11               , "MUS-HG-ROUTE11") \
    X(MUS_HG_R_12_24               , "MUS-HG-ROUTE24") \
    X(MUS_HG_R_1_26                , "MUS-HG-ROUTE26") \
    X(MUS_HG_POKESEN               , "MUS-HG-POKE-CENTER") \
    X(MUS_HG_FS                    , "MUS-HG-POKE-MART") \
    X(MUS_HG_GYM                   , "MUS-HG-GYM") \
    X(MUS_HG_UTSUGI_RABO           , "MUS-HG-ELM-LAB") \
    X(MUS_HG_OHKIDO                , "MUS-HG-OAK") \
    X(MUS_HG_KABURENJOU            , "MUS-HG-DANCE-THEATER") \
    X(MUS_HG_GAME                  , "MUS-HG-GAME-CORNER") \
    X(MUS_HG_BATTLETOWER           , "MUS-HG-B-TOWER") \
    X(MUS_HG_BATTLETOWER2          , "MUS-HG-B-TOWER-RECEPTION") \
    X(MUS_HG_TO_MADATSUBOMI1       , "MUS-HG-SPROUT-TOWER") \
    X(MUS_HG_D_CHIKATSUURO         , "MUS-HG-UNION-CAVE") \
    X(MUS_HG_D_UNKNOWN_ISEKI       , "MUS-HG-RUINS-OF-ALPH") \
    X(MUS_HG_D_KOUEN               , "MUS-HG-NATIONAL-PARK") \
    X(MUS_HG_TO_YAKETA             , "MUS-HG-BURNED-TOWER") \
    X(MUS_HG_TO_SUZU               , "MUS-HG-BELL-TOWER") \
    X(MUS_HG_TO_TOUDAI             , "MUS-HG-LIGHTHOUSE") \
    X(MUS_HG_D_AJITO               , "MUS-HG-TEAM-ROCKET-HQ") \
    X(MUS_HG_D_KOORINONUKE         , "MUS-HG-ICE-PATH") \
    X(MUS_HG_RYUUNOANA             , "MUS-HG-DRAGONS-DEN") \
    X(MUS_HG_D_IWAYAMA             , "MUS-HG-ROCK-TUNNEL") \
    X(MUS_HG_D_TOKIWANOMORI3       , "MUS-HG-VIRIDIAN-FOREST") \
    X(MUS_HG_D_CHAMPROAD           , "MUS-HG-VICTORY-ROAD") \
    X(MUS_HG_CHAMPROAD             , "MUS-HG-POKEMON-LEAGUE") \
    X(MUS_HG_E_TSURETEKE1          , "MUS-HG-FOLLOW-ME-1") \
    X(MUS_HG_E_TSURETEKE2          , "MUS-HG-FOLLOW-ME-2") \
    X(MUS_HG_E_RIVAL1              , "MUS-HG-ENCOUNTER-RIVAL") \
    X(MUS_HG_E_RIVAL2              , "MUS-HG-RIVAL-EXIT") \
    X(MUS_HG_TAIKAIMAE             , "MUS-HG-BUG-CONTEST-PREP") \
    X(MUS_HG_TAIKAI                , "MUS-HG-BUG-CATCHING-CONTEST") \
    X(MUS_HG_KAIDENPA              , "MUS-HG-ROCKET-RADIO") \
    X(MUS_HG_SENKYO                , "MUS-HG-ROCKET-TAKEOVER") \
    X(MUS_HG_E_LINEAR              , "MUS-HG-MAGNET-TRAIN") \
    X(MUS_HG_KOUSOKUSEN            , "MUS-HG-SS-AQUA") \
    X(MUS_HG_OTSUKIMI_EVENT        , "MUS-HG-MT-MOON-SQUARE") \
    X(MUS_HG_RADIO_JINGLE          , "MUS-HG-RADIO-JINGLE") \
    X(MUS_HG_RADIO_KOMORIUTA       , "MUS-HG-RADIO-LULLABY") \
    X(MUS_HG_RADIO_MARCH           , "MUS-HG-RADIO-MARCH") \
    X(MUS_HG_RADIO_UNKNOWN         , "MUS-HG-RADIO-UNOWN") \
    X(MUS_HG_HUE                   , "MUS-HG-RADIO-POKE-FLUTE") \
    X(MUS_HG_OHKIDO_RABO           , "MUS-HG-RADIO-OAK") \
    X(MUS_HG_AIKOTOBA              , "MUS-HG-RADIO-BUENA") \
    X(MUS_HG_E_MINAKI              , "MUS-HG-EUSINE") \
    X(MUS_HG_IBUKI                 , "MUS-HG-CLAIR") \
    X(MUS_HG_EYE_J_SHOUJO          , "MUS-HG-ENCOUNTER-GIRL-1") \
    X(MUS_HG_EYE_J_SHOUNEN         , "MUS-HG-ENCOUNTER-BOY-1") \
    X(MUS_HG_EYE_J_AYASHII         , "MUS-HG-ENCOUNTER-SUSPICIOUS-1") \
    X(MUS_HG_EYE_BOUZU             , "MUS-HG-ENCOUNTER-SAGE") \
    X(MUS_HG_EYE_MAIKO             , "MUS-HG-ENCOUNTER-KIMONO-GIRL") \
    X(MUS_HG_EYE_ROCKET            , "MUS-HG-ENCOUNTER-ROCKET") \
    X(MUS_HG_EYE_K_SHOUJO          , "MUS-HG-ENCOUNTER-GIRL-2") \
    X(MUS_HG_EYE_K_SHOUNEN         , "MUS-HG-ENCOUNTER-BOY-2") \
    X(MUS_HG_EYE_K_AYASHII         , "MUS-HG-ENCOUNTER-SUSPICIOUS-2") \
    X(MUS_HG_VS_NORAPOKE           , "MUS-HG-VS-WILD") \
    X(MUS_HG_VS_TRAINER            , "MUS-HG-VS-TRAINER") \
    X(MUS_HG_VS_GYMREADER          , "MUS-HG-VS-GYM-LEADER") \
    ...
    X(MUS_HG_VS_CHAMP              , "MUS-HG-VS-CHAMPION") \
    X(MUS_HG_VS_NORAPOKE_KANTO     , "MUS-HG-VS-WILD-KANTO") \
    X(MUS_HG_VS_TRAINER_KANTO      , "MUS-HG-VS-TRAINER-KANTO") \
    X(MUS_HG_VS_GYMREADER_KANTO    , "MUS-HG-VS-GYM-LEADER-KANTO") \
    X(MUS_HG_WIN1                  , "MUS-HG-VICTORY-TRAINER") \
    X(MUS_HG_WIN2                  , "MUS-HG-VICTORY-WILD") \
    X(MUS_HG_WIN2_NOT_FAN          , "MUS-HG-CAUGHT") \
    X(MUS_HG_WIN3                  , "MUS-HG-VICTORY-GYM-LEADER") \
    X(MUS_HG_VS_HOUOU              , "MUS-HG-VS-HO-OH") \
    X(MUS_HG_VS_LUGIA              , "MUS-HG-VS-LUGIA") \
    X(MUS_HG_PT_ENTR               , "MUS-HG-POKEATHLON-LOBBY") \
    X(MUS_HG_PT_OPEN               , "MUS-HG-POKEATHLON-START") \
    X(MUS_HG_PT_TITLE              , "MUS-HG-POKEATHLON-BEFORE") \
    X(MUS_HG_PT_GAME               , "MUS-HG-POKEATHLON-EVENT") \
    X(MUS_HG_PT_GAMEF              , "MUS-HG-POKEATHLON-FINALS") \
    X(MUS_HG_PT_RESULT             , "MUS-HG-POKEATHLON-RESULTS") \
    X(MUS_HG_PT_END                , "MUS-HG-POKEATHLON-END") \
    X(MUS_HG_PT_VICTORY            , "MUS-HG-POKEATHLON-WINNER") \
    X(MUS_HG_BF_FACTORY            , "MUS-HG-B-FACTORY") \
    X(MUS_HG_BF_STAGE              , "MUS-HG-B-HALL") \
    X(MUS_HG_BF_ROULETTE           , "MUS-HG-B-ARCADE") \
    X(MUS_HG_BF_CASTLE             , "MUS-HG-B-CASTLE") \
    X(MUS_HG_BA_BRAIN              , "MUS-HG-VS-FRONTIER-BRAIN") \
    X(MUS_HG_WINBRAIN              , "MUS-HG-VICTORY-FRONTIER-BRAIN") \
    X(MUS_HG_WIFI_ACCESS           , "MUS-HG-WFC") \
    X(MUS_HG_WIFI_PRESENT          , "MUS-HG-MYSTERY-GIFT") \
    X(MUS_HG_WIFIUNION             , "MUS-HG-WIFI-PLAZA") \
    X(MUS_HG_WIFIGAME              , "MUS-HG-WIFI-MINIGAMES") \
    X(MUS_HG_WIFIPARADE            , "MUS-HG-WIFI-PARADE") \
    X(MUS_HG_WIFITOWER             , "MUS-HG-GLOBAL-TERMINAL") \
    X(MUS_HG_GURUGURU              , "MUS-HG-SPIN-TRADE") \
    X(MUS_HG_BLD_GTC               , "MUS-HG-GTS") \
    X(MUS_HG_SAFARI_ROAD           , "MUS-HG-ROUTE47") \
    X(MUS_HG_SAFARI_HOUSE          , "MUS-HG-SAFARI-ZONE-GATE") \
    X(MUS_HG_SAFARI_FIELD          , "MUS-HG-SAFARI-ZONE") \
    X(MUS_HG_E_SUPPORT_M           , "MUS-HG-ETHAN") \
    X(MUS_HG_E_SUPPORT_F           , "MUS-HG-LYRA") \
    X(MUS_HG_GAMEATARI             , "MUS-HG-GAME-CORNER-WIN") \
    X(MUS_HG_E_MAIKO_MAI           , "MUS-HG-KIMONO-GIRL-DANCE") \
    X(MUS_HG_E_MAIKO_THEME         , "MUS-HG-KIMONO-GIRL") \
    X(MUS_HG_E_HOUOU               , "MUS-HG-HO-OH-APPEARS") \
    X(MUS_HG_E_LUGIA               , "MUS-HG-LUGIA-APPEARS") \
    X(MUS_HG_E_G_PICHU             , "MUS-HG-SPIKY-EARED-PICHU") \
    X(MUS_HG_D_SHINTO              , "MUS-HG-SINJOU-RUINS") \
    X(MUS_HG_RADIO_R_101           , "MUS-HG-RADIO-ROUTE101") \
    X(MUS_HG_RADIO_R_201           , "MUS-HG-RADIO-ROUTE201") \
    X(MUS_HG_RADIO_TRAINER         , "MUS-HG-RADIO-TRAINER") \
    X(MUS_HG_RADIO_VARIETY         , "MUS-HG-RADIO-VARIETY") \
    X(MUS_HG_VS_KODAI              , "MUS-HG-VS-KYOGRE-GROUDON") \
    X(MUS_HG_PHC                   , "MUS-HG-POKEWALKER") \
    X(MUS_HG_E_ARCEUS              , "MUS-HG-VS-ARCEUS") \
    X(MUS_HG_ME_ASA                , "MUS-HG-HEAL") \
    X(MUS_HG_ME_LVUP               , "MUS-HG-LEVEL-UP") \
    X(MUS_HG_ME_ITEM               , "MUS-HG-OBTAIN-ITEM") \
    X(MUS_HG_ME_KEYITEM            , "MUS-HG-OBTAIN-KEY-ITEM") \
    X(MUS_HG_ME_SHINKAOME          , "MUS-HG-EVOLVED") \
    X(MUS_HG_ME_BADGE              , "MUS-HG-OBTAIN-BADGE") \
    X(MUS_HG_ME_WAZA               , "MUS-HG-OBTAIN-TMHM") \
    X(MUS_HG_ME_ACCE               , "MUS-HG-OBTAIN-ACCESSORY") \
    X(MUS_HG_ME_WASURE             , "MUS-HG-MOVE-DELETED") \
    X(MUS_HG_ME_KINOMI             , "MUS-HG-OBTAIN-BERRY") \
    X(MUS_HG_ME_HYOUKA1            , "MUS-HG-DEX-RATING-1") \
    X(MUS_HG_ME_HYOUKA2            , "MUS-HG-DEX-RATING-2") \
    X(MUS_HG_ME_HYOUKA3            , "MUS-HG-DEX-RATING-3") \
    X(MUS_HG_ME_HYOUKA4            , "MUS-HG-DEX-RATING-4") \
    X(MUS_HG_ME_HYOUKA5            , "MUS-HG-DEX-RATING-5") \
    X(MUS_HG_ME_HYOUKA6            , "MUS-HG-DEX-RATING-6") \
    X(MUS_HG_ME_TAMAGO_GET         , "MUS-HG-OBTAIN-EGG") \
    X(MUS_HG_ME_MUSHITORI1         , "MUS-HG-BUG-CONTEST-1ST-PLACE") \
    X(MUS_HG_ME_MUSHITORI2         , "MUS-HG-BUG-CONTEST-2ND-PLACE") \
    X(MUS_HG_ME_MUSHITORI3         , "MUS-HG-BUG-CONTEST-3RD-PLACE") \
    X(MUS_HG_ME_CARDGAME1          , "MUS-HG-CARD-FLIP") \
    X(MUS_HG_ME_CARDGAME2          , "MUS-HG-CARD-FLIP-GAME-OVER") \
    X(MUS_HG_ME_POKEGEAR_REGIST    , "MUS-HG-POKEGEAR-REGISTERED") \
    X(MUS_HG_ME_GONIN              , "MUS-HG-LETS-GO-TOGETHER") \
    X(MUS_HG_ME_PT_NEW             , "MUS-HG-POKEATHLON-READY") \
    X(MUS_HG_ME_PT_RESULTG         , "MUS-HG-POKEATHLON-1ST-PLACE") \
    X(MUS_HG_ME_PT_SPECIAL         , "MUS-HG-RECEIVE-POKEMON") \
    X(MUS_HG_ME_ROULETTE           , "MUS-HG-OBTAIN-ARCADE-POINTS") \
    X(MUS_HG_ME_CASTLE             , "MUS-HG-OBTAIN-CASTLE-POINTS") \
    X(MUS_HG_ME_BPGET              , "MUS-HG-OBTAIN-B-POINTS") \
    X(MUS_HG_ME_MINIGAME           , "MUS-HG-WIN-MINIGAME") \
