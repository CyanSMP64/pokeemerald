...
const u8 gText_ConfirmTossItems2[] = _("Are you SURE you\nwant to toss the\n{STR_VAR_1}(s)?");
const u8 gText_ConfirmTossItems3[] = _("This is your final\nwarning. Toss {STR_VAR_2}\n{STR_VAR_1}(s)?");
...
const u8 gText_ReleaseThisPokemon2[] = _("Are you really sure?");
const u8 gText_ReleaseThisPokemon3[] = _("Final warning. Release?");
