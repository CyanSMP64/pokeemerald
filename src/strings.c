...
const u8 gText_DefaultNameReid[] = _("Dumper");
...
const u8 gText_DefaultNameTiara[] = _("COPIUM");
...
const u8 gText_DefaultNameAubree[] = _("Shirea");
const u8 gText_DefaultNameRuthie[] = _("Isshaku");
...
const u8 gText_DefaultNameLucy[] = _("PEPW");
