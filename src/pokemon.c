...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(CHALKBOARD_1),
    SPECIES_TO_HOENN(CHALKBOARD_2),
    SPECIES_TO_HOENN(CHALKBOARD_3),
    ...
    SPECIES_TO_HOENN(CLEFABLE_MEGA),
    SPECIES_TO_HOENN(VICTREEBEL_MEGA),
    SPECIES_TO_HOENN(STARMIE_MEGA),
    SPECIES_TO_HOENN(DRAGONITE_MEGA),
    SPECIES_TO_HOENN(MEGANIUM_MEGA),
    SPECIES_TO_HOENN(FERALIGATR_MEGA),
    SPECIES_TO_HOENN(SKARMORY_MEGA),
    SPECIES_TO_HOENN(FROSLASS_MEGA),
    SPECIES_TO_HOENN(EMBOAR_MEGA),
    SPECIES_TO_HOENN(EXCADRILL_MEGA),
    SPECIES_TO_HOENN(SCOLIPEDE_MEGA),
    SPECIES_TO_HOENN(SCRAFTY_MEGA),
    SPECIES_TO_HOENN(EELEKTROSS_MEGA),
    SPECIES_TO_HOENN(CHANDELURE_MEGA),
    SPECIES_TO_HOENN(CHESNAUGHT_MEGA),
    SPECIES_TO_HOENN(DELPHOX_MEGA),
    SPECIES_TO_HOENN(GRENINJA_MEGA),
    SPECIES_TO_HOENN(PYROAR_MEGA),
    SPECIES_TO_HOENN(FLOETTE_MEGA),
    SPECIES_TO_HOENN(MALAMAR_MEGA),
    SPECIES_TO_HOENN(BARBARACLE_MEGA),
    SPECIES_TO_HOENN(DRAGALGE_MEGA),
    SPECIES_TO_HOENN(HAWLUCHA_MEGA),
    SPECIES_TO_HOENN(ZYGARDE_MEGA),
    SPECIES_TO_HOENN(DRAMPA_MEGA),
    SPECIES_TO_HOENN(FALINKS_MEGA),
    SPECIES_TO_HOENN(RAICHU_MEGA_X),
    SPECIES_TO_HOENN(RAICHU_MEGA_Y),
    SPECIES_TO_HOENN(CHIMECHO_MEGA),
    SPECIES_TO_HOENN(ABSOL_MEGA_Z),
    SPECIES_TO_HOENN(STARAPTOR_MEGA),
    SPECIES_TO_HOENN(GARCHOMP_MEGA_Z),
    SPECIES_TO_HOENN(LUCARIO_MEGA_Z),
    SPECIES_TO_HOENN(HEATRAN_MEGA),
    SPECIES_TO_HOENN(DARKRAI_MEGA),
    SPECIES_TO_HOENN(GOLURK_MEGA),
    SPECIES_TO_HOENN(MEOWSTIC_MEGA),
    SPECIES_TO_HOENN(CRABOMINABLE_MEGA),
    SPECIES_TO_HOENN(GOLISOPOD_MEGA),
    SPECIES_TO_HOENN(MAGEARNA_MEGA),
    SPECIES_TO_HOENN(ZERAORA_MEGA),
    SPECIES_TO_HOENN(SCOVILLAIN_MEGA),
    SPECIES_TO_HOENN(GLIMMORA_MEGA),
    SPECIES_TO_HOENN(TATSUGIRI_MEGA),
    SPECIES_TO_HOENN(BAXCALIBUR_MEGA),
    SPECIES_TO_HOENN(MEOWSTIC_FEMALE_MEGA),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(CHALKBOARD_1),
    SPECIES_TO_NATIONAL(CHALKBOARD_2),
    SPECIES_TO_NATIONAL(CHALKBOARD_3),
    ...
    SPECIES_TO_NATIONAL(CLEFABLE_MEGA),
    SPECIES_TO_NATIONAL(VICTREEBEL_MEGA),
    SPECIES_TO_NATIONAL(STARMIE_MEGA),
    SPECIES_TO_NATIONAL(DRAGONITE_MEGA),
    SPECIES_TO_NATIONAL(MEGANIUM_MEGA),
    SPECIES_TO_NATIONAL(FERALIGATR_MEGA),
    SPECIES_TO_NATIONAL(SKARMORY_MEGA),
    SPECIES_TO_NATIONAL(FROSLASS_MEGA),
    SPECIES_TO_NATIONAL(EMBOAR_MEGA),
    SPECIES_TO_NATIONAL(EXCADRILL_MEGA),
    SPECIES_TO_NATIONAL(SCOLIPEDE_MEGA),
    SPECIES_TO_NATIONAL(SCRAFTY_MEGA),
    SPECIES_TO_NATIONAL(EELEKTROSS_MEGA),
    SPECIES_TO_NATIONAL(CHANDELURE_MEGA),
    SPECIES_TO_NATIONAL(CHESNAUGHT_MEGA),
    SPECIES_TO_NATIONAL(DELPHOX_MEGA),
    SPECIES_TO_NATIONAL(GRENINJA_MEGA),
    SPECIES_TO_NATIONAL(PYROAR_MEGA),
    SPECIES_TO_NATIONAL(FLOETTE_MEGA),
    SPECIES_TO_NATIONAL(MALAMAR_MEGA),
    SPECIES_TO_NATIONAL(BARBARACLE_MEGA),
    SPECIES_TO_NATIONAL(DRAGALGE_MEGA),
    SPECIES_TO_NATIONAL(HAWLUCHA_MEGA),
    SPECIES_TO_NATIONAL(ZYGARDE_MEGA),
    SPECIES_TO_NATIONAL(DRAMPA_MEGA),
    SPECIES_TO_NATIONAL(FALINKS_MEGA),
    SPECIES_TO_NATIONAL(RAICHU_MEGA_X),
    SPECIES_TO_NATIONAL(RAICHU_MEGA_Y),
    SPECIES_TO_NATIONAL(CHIMECHO_MEGA),
    SPECIES_TO_NATIONAL(ABSOL_MEGA_Z),
    SPECIES_TO_NATIONAL(STARAPTOR_MEGA),
    SPECIES_TO_NATIONAL(GARCHOMP_MEGA_Z),
    SPECIES_TO_NATIONAL(LUCARIO_MEGA_Z),
    SPECIES_TO_NATIONAL(HEATRAN_MEGA),
    SPECIES_TO_NATIONAL(DARKRAI_MEGA),
    SPECIES_TO_NATIONAL(GOLURK_MEGA),
    SPECIES_TO_NATIONAL(MEOWSTIC_MEGA),
    SPECIES_TO_NATIONAL(CRABOMINABLE_MEGA),
    SPECIES_TO_NATIONAL(GOLISOPOD_MEGA),
    SPECIES_TO_NATIONAL(MAGEARNA_MEGA),
    SPECIES_TO_NATIONAL(ZERAORA_MEGA),
    SPECIES_TO_NATIONAL(SCOVILLAIN_MEGA),
    SPECIES_TO_NATIONAL(GLIMMORA_MEGA),
    SPECIES_TO_NATIONAL(TATSUGIRI_MEGA),
    SPECIES_TO_NATIONAL(BAXCALIBUR_MEGA),
    SPECIES_TO_NATIONAL(MEOWSTIC_FEMALE_MEGA),
};
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(CHALKBOARD_1),
    HOENN_TO_NATIONAL(CHALKBOARD_2),
    HOENN_TO_NATIONAL(CHALKBOARD_3),
    ...
    HOENN_TO_NATIONAL(CLEFABLE_MEGA),
    HOENN_TO_NATIONAL(VICTREEBEL_MEGA),
    HOENN_TO_NATIONAL(STARMIE_MEGA),
    HOENN_TO_NATIONAL(DRAGONITE_MEGA),
    HOENN_TO_NATIONAL(MEGANIUM_MEGA),
    HOENN_TO_NATIONAL(FERALIGATR_MEGA),
    HOENN_TO_NATIONAL(SKARMORY_MEGA),
    HOENN_TO_NATIONAL(FROSLASS_MEGA),
    HOENN_TO_NATIONAL(EMBOAR_MEGA),
    HOENN_TO_NATIONAL(EXCADRILL_MEGA),
    HOENN_TO_NATIONAL(SCOLIPEDE_MEGA),
    HOENN_TO_NATIONAL(SCRAFTY_MEGA),
    HOENN_TO_NATIONAL(EELEKTROSS_MEGA),
    HOENN_TO_NATIONAL(CHANDELURE_MEGA),
    HOENN_TO_NATIONAL(CHESNAUGHT_MEGA),
    HOENN_TO_NATIONAL(DELPHOX_MEGA),
    HOENN_TO_NATIONAL(GRENINJA_MEGA),
    HOENN_TO_NATIONAL(PYROAR_MEGA),
    HOENN_TO_NATIONAL(FLOETTE_MEGA),
    HOENN_TO_NATIONAL(MALAMAR_MEGA),
    HOENN_TO_NATIONAL(BARBARACLE_MEGA),
    HOENN_TO_NATIONAL(DRAGALGE_MEGA),
    HOENN_TO_NATIONAL(HAWLUCHA_MEGA),
    HOENN_TO_NATIONAL(ZYGARDE_MEGA),
    HOENN_TO_NATIONAL(DRAMPA_MEGA),
    HOENN_TO_NATIONAL(FALINKS_MEGA),
    HOENN_TO_NATIONAL(RAICHU_MEGA_X),
    HOENN_TO_NATIONAL(RAICHU_MEGA_Y),
    HOENN_TO_NATIONAL(CHIMECHO_MEGA),
    HOENN_TO_NATIONAL(ABSOL_MEGA_Z),
    HOENN_TO_NATIONAL(STARAPTOR_MEGA),
    HOENN_TO_NATIONAL(GARCHOMP_MEGA_Z),
    HOENN_TO_NATIONAL(LUCARIO_MEGA_Z),
    HOENN_TO_NATIONAL(HEATRAN_MEGA),
    HOENN_TO_NATIONAL(DARKRAI_MEGA),
    HOENN_TO_NATIONAL(GOLURK_MEGA),
    HOENN_TO_NATIONAL(MEOWSTIC_MEGA),
    HOENN_TO_NATIONAL(CRABOMINABLE_MEGA),
    HOENN_TO_NATIONAL(GOLISOPOD_MEGA),
    HOENN_TO_NATIONAL(MAGEARNA_MEGA),
    HOENN_TO_NATIONAL(ZERAORA_MEGA),
    HOENN_TO_NATIONAL(SCOVILLAIN_MEGA),
    HOENN_TO_NATIONAL(GLIMMORA_MEGA),
    HOENN_TO_NATIONAL(TATSUGIRI_MEGA),
    HOENN_TO_NATIONAL(BAXCALIBUR_MEGA),
    HOENN_TO_NATIONAL(MEOWSTIC_FEMALE_MEGA),
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TOXAPEX - 1]       = ANIM_V_STRETCH,
    ...
    [SPECIES_SHIINOTIC - 1]     = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_POIPOLE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
...
static const u16 sAllBattleBGM[] =
{
    ...
    MUS_DP_VS_ARCEUS,
    MUS_DP_VS_LEGEND,
    MUS_DP_VS_GALACTIC_ADMIN,
    MUS_DP_VS_ELITE_FOUR,
    MUS_DP_BATTLE_ARCADE,
    MUS_PL_VS_GIRATINA,
    MUS_DP_VS_FRONTIER_BRAIN,
    MUS_HG_VS_WILD_JOHTO,
    MUS_HG_VS_TRAINER_JOHTO,
    MUS_HG_VS_GYM_LEADER_JOHTO,
    MUS_HG_VS_RIVAL,
    MUS_HG_VS_ROCKET,
    MUS_HG_VS_SUICUNE,
    MUS_HG_VS_ENTEI,
    ...
    MUS_BW_VS_WILD_15815,
    MUS_BW_VS_WILD,
    MUS_BW_VS_STRONG_WILD,
    MUS_BW_VS_TRAINER,
    ...
    MUS_B2_VS_WILD,
    MUS_B2_VS_TRAINER,
    MUS_B2_VS_GYM_LEADER,
    MUS_B2_VS_N,
    MUS_B2_VS_REGI,
    MUS_B2_VS_GYM_LEADER_KANTO,
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        case TRAINER_CLASS_PKMN_TRAINER_2:
            ...
            case OPTIONS_BATTLE_BGM_PURE_RANDOM:
                return SelectPureRandomBattleBGM();
            default:
                return MUS_B2_VS_CHAMPION_HOENN;
            }
        ...
        case TRAINER_CLASS_PYRAMID_KING:
            ...
            {
            case OPTIONS_BATTLE_BGM_CONTEXTUAL_RANDOM:
                return SelectContextualRandomBossOrFinalBattleBGM();
            case OPTIONS_BATTLE_BGM_PURE_RANDOM:
                return SelectPureRandomBattleBGM();
            default:
...
bool8 SpeciesHasPersonalityBasedForm(u16 species)
{
    return (species == SPECIES_UNOWN || species == SPECIES_SHELLOS || species == SPECIES_GASTRODON || species == SPECIES_HIPPOPOTAS || species == SPECIES_HIPPOWDON
        ...
        || species == SPECIES_TATSUGIRI_MEGA || species == SPECIES_MAGEARNA_MEGA);
}
...
u16 GetFormSpeciesIdFromPersonality(u16 species, u32 personality, u8 battlerId)
{
    ...
    if (species == SPECIES_UNOWN)
    {
        ...
        if (!letter)
          ...
          || species == SPECIES_SQUAWKABILLY || species == SPECIES_SQUAWKABILLY_YELLOW_PLUMAGE || species == SPECIES_MAGEARNA_MEGA)
    {
        ...
        else
        {
            ...
            else if (species == SPECIES_MAGEARNA_MEGA)
                return SPECIES_MAGEARNA_MEGA_ORIGINAL_COLOR;
    ...
    else if (species == SPECIES_TATSUGIRI || species == SPECIES_TATSUGIRI_MEGA)
    {
        ...
        else
        {
            if (species == SPECIES_TATSUGIRI)
                ...
                return letter + SPECIES_TATSUGIRI_MEGA_DROOPY - 1;
        }
    }
