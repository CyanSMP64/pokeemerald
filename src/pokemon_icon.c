...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ARCEUS_FIGHTING] = gMonIcon_ArceusFighting,
    ...
    [SPECIES_GENESECT_SHOCK] = gMonIcon_Genesect,
    [SPECIES_GENESECT_BURN] = gMonIcon_Genesect,
    [SPECIES_GENESECT_CHILL] = gMonIcon_Genesect,
    [SPECIES_GENESECT_DOUSE] = gMonIcon_Genesect,
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_THREE] = gMonIcon_MausholdThree,
    ...
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = gMonIcon_DudunsparceThreeSegment,
    ...
    [SPECIES_CLEFABLE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_VICTREEBEL_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_STARMIE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_DRAGONITE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MEGANIUM_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_FERALIGATR_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_SKARMORY_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_FROSLASS_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_EMBOAR_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_EXCADRILL_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_SCOLIPEDE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_SCRAFTY_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_EELEKTROSS_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_CHANDELURE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_CHESNAUGHT_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_DELPHOX_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_GRENINJA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_PYROAR_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_FLOETTE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MALAMAR_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_BARBARACLE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_DRAGALGE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_HAWLUCHA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_ZYGARDE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_DRAMPA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_FALINKS_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_RAICHU_MEGA_X] = gMonIcon_QuestionMark,
    [SPECIES_RAICHU_MEGA_Y] = gMonIcon_QuestionMark,
    [SPECIES_CHIMECHO_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_ABSOL_MEGA_Z] = gMonIcon_QuestionMark,
    [SPECIES_STARAPTOR_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_GARCHOMP_MEGA_Z] = gMonIcon_QuestionMark,
    [SPECIES_LUCARIO_MEGA_Z] = gMonIcon_QuestionMark,
    [SPECIES_HEATRAN_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_DARKRAI_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_GOLURK_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MEOWSTIC_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MEOWSTIC_FEMALE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_CRABOMINABLE_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_GOLISOPOD_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MAGEARNA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_MAGEARNA_MEGA_ORIGINAL_COLOR] = gMonIcon_QuestionMark,
    [SPECIES_ZERAORA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_SCOVILLAIN_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_GLIMMORA_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_TATSUGIRI_MEGA] = gMonIcon_QuestionMark,
    [SPECIES_TATSUGIRI_MEGA_DROOPY] = gMonIcon_QuestionMark,
    [SPECIES_TATSUGIRI_MEGA_STRETCHY] = gMonIcon_QuestionMark,
    [SPECIES_BAXCALIBUR_MEGA] = gMonIcon_QuestionMark,
    ...
    [SPECIES_DEOXYS_SPEED] = gMonIcon_DeoxysSpeed2,
    ...
    [SPECIES_ALCREMIE_STRAWBERRY_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_STRAWBERRY_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_STRAWBERRY_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_STRAWBERRY_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_STRAWBERRY_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_STRAWBERRY_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_BERRY_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_BERRY_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_BERRY_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_BERRY_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_BERRY_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_BERRY_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_BERRY_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_BERRY_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_BERRY_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_LOVE_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_LOVE_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_LOVE_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_LOVE_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_LOVE_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_LOVE_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_LOVE_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_LOVE_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_LOVE_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_STAR_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_STAR_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_STAR_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_STAR_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_STAR_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_STAR_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_STAR_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_STAR_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_STAR_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_CLOVER_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_CLOVER_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_CLOVER_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_CLOVER_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_CLOVER_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_CLOVER_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_CLOVER_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_CLOVER_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_CLOVER_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_FLOWER_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_FLOWER_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_FLOWER_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_FLOWER_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_FLOWER_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_FLOWER_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_FLOWER_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_FLOWER_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    [SPECIES_ALCREMIE_RIBBON_VANILLA_CREAM] = gMonIcon_Alcremie,
    [SPECIES_ALCREMIE_RIBBON_RUBY_CREAM] = gMonIcon_AlcremieStrawberryRubyCream,
    [SPECIES_ALCREMIE_RIBBON_MATCHA_CREAM] = gMonIcon_AlcremieStrawberryMatchaCream,
    [SPECIES_ALCREMIE_RIBBON_MINT_CREAM] = gMonIcon_AlcremieStrawberryMintCream,
    [SPECIES_ALCREMIE_RIBBON_LEMON_CREAM] = gMonIcon_AlcremieStrawberryLemonCream,
    [SPECIES_ALCREMIE_RIBBON_SALTED_CREAM] = gMonIcon_AlcremieStrawberrySaltedCream,
    [SPECIES_ALCREMIE_RIBBON_RUBY_SWIRL] = gMonIcon_AlcremieStrawberryRubySwirl,
    [SPECIES_ALCREMIE_RIBBON_CARAMEL_SWIRL] = gMonIcon_AlcremieStrawberryCaramelSwirl,
    [SPECIES_ALCREMIE_RIBBON_RAINBOW_SWIRL] = gMonIcon_AlcremieStrawberryRainbowSwirl,
    ...
    [SPECIES_HIPPOPOTAS_FEMALE] = gMonIcon_Hippopotas,
    [SPECIES_HIPPOWDON_FEMALE] = gMonIcon_Hippowdon,
    [SPECIES_UNFEZANT_FEMALE] = gMonIcon_UnfezantF,
    [SPECIES_FRILLISH_FEMALE] = gMonIcon_FrillishF,
    [SPECIES_JELLICENT_FEMALE] = gMonIcon_JellicentF,
    [SPECIES_PYROAR_FEMALE] = gMonIcon_PyroarF,
    [SPECIES_PIKACHU_CAP] = gMonIcon_PikachuC_M1,
    [SPECIES_PIKACHU_PARTNER] = gMonIcon_PikachuPartner,
    [SPECIES_EEVEE_PARTNER] = gMonIcon_EeveePartner,
    [SPECIES_PICHU_SPIKY_EARED] = gMonIcon_PichuSpiky,
    ...
    [SPECIES_PIKACHU_CAP_2] = gMonIcon_PikachuC_M2,
    [SPECIES_PIKACHU_CAP_3] = gMonIcon_PikachuC_M3,
    [SPECIES_PIKACHU_CAP_4] = gMonIcon_PikachuC_M4,
    [SPECIES_PIKACHU_CAP_5] = gMonIcon_PikachuC_M5,
    [SPECIES_PIKACHU_CAP_6] = gMonIcon_PikachuC_M6,
    [SPECIES_PIKACHU_CAP_7] = gMonIcon_PikachuC_M7,
    [SPECIES_PIKACHU_CAP_8] = gMonIcon_PikachuC_M8,
    [SPECIES_PIKACHU_COSPLAY_1] = gMonIcon_PikachuC_F1,
    [SPECIES_PIKACHU_COSPLAY_2] = gMonIcon_PikachuC_F2,
    [SPECIES_PIKACHU_COSPLAY_3] = gMonIcon_PikachuC_F3,
    [SPECIES_PIKACHU_COSPLAY_4] = gMonIcon_PikachuC_F4,
    [SPECIES_PIKACHU_COSPLAY_5] = gMonIcon_PikachuC_F5,
    [SPECIES_PIKACHU_COSPLAY_6] = gMonIcon_PikachuC_F6,
    [SPECIES_KELDEO_RESOLUTE] = gMonIcon_KeldeoResolute,
    [SPECIES_FURFROU_TRIM_1] = gMonIcon_FurfrouC_1,
    [SPECIES_FURFROU_TRIM_2] = gMonIcon_FurfrouC_2,
    [SPECIES_FURFROU_TRIM_3] = gMonIcon_FurfrouC_3,
    [SPECIES_FURFROU_TRIM_4] = gMonIcon_FurfrouC_4,
    [SPECIES_FURFROU_TRIM_5] = gMonIcon_FurfrouC_5,
    [SPECIES_FURFROU_TRIM_6] = gMonIcon_FurfrouC_6,
    [SPECIES_FURFROU_TRIM_7] = gMonIcon_FurfrouC_7,
    [SPECIES_FURFROU_TRIM_8] = gMonIcon_FurfrouC_8,
    [SPECIES_FURFROU_TRIM_9] = gMonIcon_FurfrouC_9,
    [SPECIES_MAGEARNA_ORIGINAL_COLOR] = gMonIcon_MagearnaOriginal,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_ALCREMIE_BERRY_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_BERRY_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_BERRY_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_BERRY_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_BERRY_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_BERRY_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_BERRY_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_BERRY_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_BERRY_RAINBOW_SWIRL] = 0,
    [SPECIES_ALCREMIE_LOVE_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_LOVE_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_LOVE_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_LOVE_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_LOVE_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_LOVE_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_LOVE_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_LOVE_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_LOVE_RAINBOW_SWIRL] = 0,
    [SPECIES_ALCREMIE_STAR_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_STAR_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_STAR_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_STAR_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_STAR_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_STAR_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_STAR_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_STAR_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_STAR_RAINBOW_SWIRL] = 0,
    [SPECIES_ALCREMIE_CLOVER_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_CLOVER_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_CLOVER_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_CLOVER_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_CLOVER_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_CLOVER_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_CLOVER_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_CLOVER_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_CLOVER_RAINBOW_SWIRL] = 0,
    [SPECIES_ALCREMIE_FLOWER_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_FLOWER_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_FLOWER_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_FLOWER_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_FLOWER_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_FLOWER_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_FLOWER_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_FLOWER_RAINBOW_SWIRL] = 0,
    [SPECIES_ALCREMIE_RIBBON_VANILLA_CREAM] = 0,
    [SPECIES_ALCREMIE_RIBBON_RUBY_CREAM] = 0,
    [SPECIES_ALCREMIE_RIBBON_MATCHA_CREAM] = 1,
    [SPECIES_ALCREMIE_RIBBON_MINT_CREAM] = 0,
    [SPECIES_ALCREMIE_RIBBON_LEMON_CREAM] = 1,
    [SPECIES_ALCREMIE_RIBBON_SALTED_CREAM] = 0,
    [SPECIES_ALCREMIE_RIBBON_RUBY_SWIRL] = 0,
    [SPECIES_ALCREMIE_RIBBON_CARAMEL_SWIRL] = 2,
    [SPECIES_ALCREMIE_RIBBON_RAINBOW_SWIRL] = 0,
    ...
    [SPECIES_HIPPOPOTAS_FEMALE] = 1,
    [SPECIES_HIPPOWDON_FEMALE] = 1,
    ...
    [SPECIES_GIMMIGHOUL_ROAMING] = 2,
    [SPECIES_TERAPAGOS_TERASTAL] = 0,
    [SPECIES_TERAPAGOS_STELLAR] = 0,
    [SPECIES_PIKACHU_CAP_2] = 0,
    [SPECIES_PIKACHU_CAP_3] = 0,
    [SPECIES_PIKACHU_CAP_4] = 0,
    [SPECIES_PIKACHU_CAP_5] = 0,
    [SPECIES_PIKACHU_CAP_6] = 0,
    [SPECIES_PIKACHU_CAP_7] = 0,
    [SPECIES_PIKACHU_CAP_8] = 0,
    [SPECIES_PIKACHU_COSPLAY_1] = 2,
    [SPECIES_PIKACHU_COSPLAY_2] = 1,
    [SPECIES_PIKACHU_COSPLAY_3] = 0,
    [SPECIES_PIKACHU_COSPLAY_4] = 0,
    [SPECIES_PIKACHU_COSPLAY_5] = 1,
    [SPECIES_PIKACHU_COSPLAY_6] = 0,
    [SPECIES_KELDEO_RESOLUTE] = 0,
    [SPECIES_FURFROU_TRIM_1] = 0,
    [SPECIES_FURFROU_TRIM_2] = 0,
    [SPECIES_FURFROU_TRIM_3] = 0,
    [SPECIES_FURFROU_TRIM_4] = 2,
    [SPECIES_FURFROU_TRIM_5] = 2,
    [SPECIES_FURFROU_TRIM_6] = 1,
    [SPECIES_FURFROU_TRIM_7] = 0,
    [SPECIES_FURFROU_TRIM_8] = 0,
    [SPECIES_FURFROU_TRIM_9] = 0,
...
u8 CreateMonIcon(u16 species, void (*callback)(struct Sprite *), s16 x, s16 y, u8 subpriority, u32 personality, bool32 handleDeoxys)
{
    ...
    if (species == SPECIES_DEERLING && (personality >> 8) % 4 == 3)
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_DEERLING_WINTER];
    if (species == SPECIES_VIVILLON && (((personality >> 8) % 20 == 3) || ((personality >> 8) % 20 == 7) || ((personality >> 8) % 20 == 12) || ((personality >> 8) % 20 == 19)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_VIVILLON_CONTINENTAL];
    if (species == SPECIES_VIVILLON && (((personality >> 8) % 20 == 4) || ((personality >> 8) % 20 == 11) || ((personality >> 8) % 20 == 18)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_VIVILLON_GARDEN];
    if (species == SPECIES_FURFROU && (((personality >> 8) % 20 == 14) || ((personality >> 8) % 20 == 15)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_FURFROU_TRIM_4];
    if (species == SPECIES_FURFROU && (((personality >> 8) % 20 == 16)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_FURFROU_TRIM_6];
    if (species == SPECIES_PIKACHU_CAP && (((personality >> 8) % 6 == 0) && ((personality % 0x100) < 0x7f)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_PIKACHU_COSPLAY_1];
    if (species == SPECIES_PIKACHU_CAP && ((((personality >> 8) % 6 == 1) || ((personality >> 8) % 6 == 4)) && ((personality % 100) < 0x7f)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_PIKACHU_COSPLAY_2];
    if ((species == SPECIES_FLABEBE || species == SPECIES_FLOETTE) && (((personality >> 8) % 5 == 2) || ((personality >> 8) % 5 == 3)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_FLABEBE_ORANGE_FLOWER];
    if (species == SPECIES_FLORGES && (personality >> 8) % 5 == 1)
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_FLORGES_YELLOW_FLOWER];
    if (species == SPECIES_MINIOR_CORE_RED && (personality >> 8) % 7 == 3)
    ...
    if (species == SPECIES_ALCREMIE && (((personality >> 8) % 9 == 2) || ((personality >> 8) % 9 == 4)))
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_ALCREMIE_STRAWBERRY_MATCHA_CREAM];
    if (species == SPECIES_ALCREMIE && (personality >> 8) % 9 == 7)
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL];
...
u16 GetIconSpecies(u16 species, u32 personality)
{
    ...
    {
        // Note: battlerId = 0 is used here since GetIconSpecies doesn't have access to battler info for KELDEO form checking
        result = GetFormSpeciesIdFromPersonality(species, personality, 0);
    }
    else
    {
        if (species > NUM_SPECIES && species != SPECIES_KELDEO_RESOLUTE)
