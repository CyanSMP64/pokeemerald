...
static const struct Fanfare sFanfares[] = {
    ...
    [FANFARE_PL_CLEAR_MINIGAME]        = { MUS_PL_WINMINI2,        230 },
    [FANFARE_PL_OBTAIN_ARCADE_POINTS]  = { MUS_PL_DON2,            175 },
    [FANFARE_PL_OBTAIN_CASTLE_POINTS]  = { MUS_PL_FRO,             200 },
    [FANFARE_PL_OBTAIN_B_POINTS]       = { MUS_PL_POINTGET3,       264 },
