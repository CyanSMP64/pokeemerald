...
static const struct Fanfare sFanfares[] = {
    ...
    [FANFARE_DP_OBTAIN_ITEM]           = { MUS_DP_FANFA4,             160 },
    [FANFARE_DP_HEAL]                  = { MUS_DP_ASA,                160 },
    [FANFARE_DP_OBTAIN_KEY_ITEM]       = { MUS_DP_FANFA3,             170 },
    [FANFARE_DP_OBTAIN_TMHM]           = { MUS_DP_WAZA,               220 },
    [FANFARE_DP_OBTAIN_BADGE]          = { MUS_DP_BADGE,              340 },
    [FANFARE_DP_LEVEL_UP]              = { MUS_DP_FANFA1,              80 },
    [FANFARE_DP_OBTAIN_BERRY]          = { MUS_DP_KINOMI,             120 },
    [FANFARE_DP_PARTNER]               = { MUS_DP_GONIN,              180 },
    [FANFARE_DP_EVOLVED]               = { MUS_DP_FANFA5,             252 },
    [FANFARE_DP_POKETCH]               = { MUS_DP_POCKETCH,           120 },
    [FANFARE_DP_MOVE_DELETED]          = { MUS_DP_WASURE,             180 },
    [FANFARE_DP_ACCESSORY]             = { MUS_DP_ACCE,               160 },
    [FANFARE_PL_TV_END]                = { MUS_PL_TV_END,             230 },
    [FANFARE_PL_CLEAR_MINIGAME]        = { MUS_PL_PL_WINMINI2,        230 },
    [FANFARE_PL_OBTAIN_ARCADE_POINTS]  = { MUS_PL_PL_DON2,            175 },
    [FANFARE_PL_OBTAIN_CASTLE_POINTS]  = { MUS_PL_PL_FRO,             200 },
    [FANFARE_PL_OBTAIN_B_POINTS]       = { MUS_PL_PL_POINTGET3,       264 },
    [FANFARE_HG_OBTAIN_KEY_ITEM]       = { MUS_HG_ME_KEYITEM,         170 },
    [FANFARE_HG_LEVEL_UP]              = { MUS_HG_ME_LVUP,             80 },
    [FANFARE_HG_HEAL]                  = { MUS_HG_ME_ASA,             160 },
    [FANFARE_HG_DEX_RATING_1]          = { MUS_HG_ME_HYOUKA1,         200 },
    [FANFARE_HG_DEX_RATING_2]          = { MUS_HG_ME_HYOUKA2,         180 },
    [FANFARE_HG_DEX_RATING_3]          = { MUS_HG_ME_HYOUKA3,         220 },
    [FANFARE_HG_DEX_RATING_4]          = { MUS_HG_ME_HYOUKA4,         210 },
    [FANFARE_HG_DEX_RATING_5]          = { MUS_HG_ME_HYOUKA5,         210 },
    [FANFARE_HG_DEX_RATING_6]          = { MUS_HG_ME_HYOUKA6,         370 },
    [FANFARE_HG_RECEIVE_EGG]           = { MUS_HG_ME_TAMAGO_GET,      155 },
    [FANFARE_HG_OBTAIN_ITEM]           = { MUS_HG_ME_ITEM,            160 },
    [FANFARE_HG_EVOLVED]               = { MUS_HG_ME_SHINKAOME,       240 },
    [FANFARE_HG_OBTAIN_BADGE]          = { MUS_HG_ME_BADGE,           340 },
    [FANFARE_HG_OBTAIN_TMHM]           = { MUS_HG_ME_WAZA,            220 },
    [FANFARE_HG_VOLTORB_FLIP_1]        = { MUS_HG_ME_CARDGAME1,       195 },
    [FANFARE_HG_VOLTORB_FLIP_2]        = { MUS_HG_ME_CARDGAME2,       240 },
    [FANFARE_HG_ACCESSORY]             = { MUS_HG_ME_ACCE,            160 },
    [FANFARE_HG_REGISTER_POKEGEAR]     = { MUS_HG_ME_POKEGEAR_REGIST, 185 },
    [FANFARE_HG_OBTAIN_BERRY]          = { MUS_HG_ME_KINOMI,          120 },
    [FANFARE_HG_RECEIVE_POKEMON]       = { MUS_HG_ME_PT_SPECIAL,      150 },
    [FANFARE_HG_MOVE_DELETED]          = { MUS_HG_ME_WASURE,          180 },
    [FANFARE_HG_THIRD_PLACE]           = { MUS_HG_ME_MUSHITORI3,      130 },
    [FANFARE_HG_SECOND_PLACE]          = { MUS_HG_ME_MUSHITORI2,      225 },
    [FANFARE_HG_FIRST_PLACE]           = { MUS_HG_ME_MUSHITORI1,      250 },
    [FANFARE_HG_POKEATHLON_NEW]        = { MUS_HG_ME_PT_NEW,          110 },
    [FANFARE_HG_WINNING_POKEATHLON]    = { MUS_HG_ME_PT_RESULTG,      144 },
    [FANFARE_HG_OBTAIN_B_POINTS]       = { MUS_HG_ME_BPGET,           264 },
    [FANFARE_HG_OBTAIN_ARCADE_POINTS]  = { MUS_HG_ME_ROULETTE,        175 },
    [FANFARE_HG_OBTAIN_CASTLE_POINTS]  = { MUS_HG_ME_CASTLE,          200 },
    [FANFARE_HG_CLEAR_MINIGAME]        = { MUS_HG_ME_MINIGAME,        230 },
    [FANFARE_HG_PARTNER]               = { MUS_HG_ME_GONIN,           180 },
    [FANFARE_BW_OBTAIN_KEY_ITEM]       = { MUS_BW_ME_KEYITEM,         170 },
    [FANFARE_BW_LEVEL_UP]              = { MUS_BW_ME_LVUP,             80 },
    [FANFARE_BW_HEAL]                  = { MUS_BW_ME_ASA,             160 },
    [FANFARE_BW_DEX_RATING_1]          = { MUS_BW_ME_HYOUKA1,         200 },
    [FANFARE_BW_DEX_RATING_2]          = { MUS_BW_ME_HYOUKA2,         180 },
    [FANFARE_BW_DEX_RATING_3]          = { MUS_BW_ME_HYOUKA3,         220 },
    [FANFARE_BW_DEX_RATING_4]          = { MUS_BW_ME_HYOUKA4,         210 },
    [FANFARE_BW_DEX_RATING_5]          = { MUS_BW_ME_HYOUKA5,         210 },
    [FANFARE_BW_DEX_RATING_6]          = { MUS_BW_ME_HYOUKA6,         370 },
    [FANFARE_BW_XTRANSCEIVER]          = { MUS_BW_ME_CALL,            210 },
    [FANFARE_BW_OBTAIN_ITEM]           = { MUS_BW_ME_ITEM,            160 },
    [FANFARE_BW_EVOLVED]               = { MUS_BW_ME_SHINKAOME,       240 },
    [FANFARE_BW_OBTAIN_BADGE]          = { MUS_BW_ME_BADGE,           340 },
    [FANFARE_BW_OBTAIN_TMHM]           = { MUS_BW_ME_WAZA,            220 },
    [FANFARE_BW_MOVE_DELETED]          = { MUS_BW_ME_WASURE,          180 },
    [FANFARE_BW_LIGHT_DARK_STONE]      = { MUS_BW_ME_ITEM_MYSTERY,    195 },
    [FANFARE_BW_RECEIVE_EGG]           = { MUS_BW_ME_TAMAGO_GET,      155 },
    [FANFARE_BW_OBTAIN_B_POINTS]       = { MUS_BW_ME_BPGET,           250 },
    [FANFARE_BW_ACCESSORY]             = { MUS_BW_ME_ACCE,            160 },
    [FANFARE_BW_FEELING_CHECK_START]   = { MUS_BW_ME_AISHOU_KIDOU,    162 },
    [FANFARE_BW_FEELING_CHECK_3]       = { MUS_BW_ME_AISHOU_H,        244 },
    [FANFARE_BW_FEELING_CHECK_2]       = { MUS_BW_ME_AISHOU_M,        200 },
    [FANFARE_BW_FEELING_CHECK_1]       = { MUS_BW_ME_AISHOU_L,        120 },
    [FANFARE_BW_MISSION_START]         = { MUS_BW_ME_MISSION_START,   280 },
    [FANFARE_BW_MISSION_CLEAR]         = { MUS_BW_ME_MISSION_CLEAR,   270 },
    [FANFARE_BW_MISSION_FAILED]        = { MUS_BW_ME_MISSION_FAILED,  180 },
    [FANFARE_BW_OBTAIN_BERRY]          = { MUS_BW_ME_KINOMI,          120 },
    [FANFARE_B2_IMMORTALIZED]          = { MUS_B2_ME_POKEWOOD,        445 },
