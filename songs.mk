...
$(MID_SUBDIR)/mus_dp_vs_dialga_palkia.s: %.s: %.mid
	$(MID) $< $@ -E -R0 -G191 -V090 -S -A -M

$(MID_SUBDIR)/mus_hg_vs_raikou.s: %.s: %.mid
	$(MID) $< $@ -E -R0 -G192 -V098 -S -A -M
