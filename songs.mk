...
$(MID_SUBDIR)/mus_pmd_test1.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G191 -v127

$(MID_SUBDIR)/mus_pmd_test2.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G191 -v127

$(MID_SUBDIR)/mus_pmd_test3.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G207 -v127

$(MID_SUBDIR)/mus_pmd_test4.s: %.s: %.mid
	$(MID) $< $@ -E -R$(STD_REVERB) -G207 -v127
