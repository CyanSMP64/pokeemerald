...
.PHONY: all rom clean compare tidy tools mostlyclean clean-tools $(TOOLDIRS) libagbsyscall modern tidymodern tidynonmodern ini release
...
tidynonmodern:
	rm -f $(ROM_NAME) $(ELF_NAME) $(MAP_NAME) $(INI_NAME)
	rm -rf $(OBJ_DIR_NAME)
