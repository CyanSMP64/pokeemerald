...
AI_CV_Encore:
	...
	get_last_used_bank_move AI_TARGET
	get_move_effect_from_result
	if_not_in_hwords AI_CV_Encore_EncouragedMovesToEncore, AI_CV_Encore_ScoreDown2
AI_CV_Encore2:
...
AI_CV_ChangeSelfAbility:
	get_ability AI_USER
	if_in_hwords AI_CV_ChangeSelfAbility_AbilitiesToEncourage, AI_CV_ChangeSelfAbility2
	get_ability AI_TARGET
	if_in_hwords AI_CV_ChangeSelfAbility_AbilitiesToEncourage, AI_CV_ChangeSelfAbility3
...
AI_Risky:
	if_target_is_ally AI_Ret
	get_considered_move_effect
	if_not_in_hwords AI_Risky_EffectsToEncourage, AI_Risky_End
...
AI_HPAware:
	...
	get_considered_move_effect
	if_in_hwords AI_HPAware_DiscouragedEffectsWhenLowHP, AI_HPAware_TryToDiscourage
...
AI_HPAware_UserHasMediumHP:
	get_considered_move_effect
	if_in_hwords AI_HPAware_DiscouragedEffectsWhenMediumHP, AI_HPAware_TryToDiscourage
	goto AI_HPAware_ConsiderTarget
...
AI_HPAware_ConsiderTarget:
	...
	get_considered_move_effect
	if_in_hwords AI_HPAware_DiscouragedEffectsWhenTargetLowHP, AI_HPAware_TargetTryToDiscourage
	goto AI_HPAware_End

AI_HPAware_TargetHasHighHP:
	get_considered_move_effect
	if_in_hwords AI_HPAware_DiscouragedEffectsWhenTargetHighHP, AI_HPAware_TargetTryToDiscourage
	goto AI_HPAware_End

AI_HPAware_TargetHasMediumHP:
	get_considered_move_effect
	if_in_hwords AI_HPAware_DiscouragedEffectsWhenTargetMediumHP, AI_HPAware_TargetTryToDiscourage
	goto AI_HPAware_End
